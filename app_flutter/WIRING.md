...
- **batch-5 (4 מסכים · עיצוב):** cfgRadius adoption ב-`finance_hub_sheets`(13)·`worker_app_screen`(11)·`smart_home_screen`(11)·`rewards_hub_screen`(11) = **46 אתרים, commit אחד**. כל אחד import+replace_all, אומת analyze נקי. **radius-slider פעיל כעת על 6 מסכים** (מנהל·ספק·פיננסים·עובד·בית-חכם·מועדון). gate: analyze 0 · config_theme/a11y ירוקים. נותרו: tasks/profile(9)·courier/projects(7)·...
