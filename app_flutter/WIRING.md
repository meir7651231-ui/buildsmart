...
- **הבא:** שלב D (Firestore-REST repos) — הנתונים אחרי-הכניסה. **תלוי-בעלים:** להדליק את ספק Email/Password ב-Firebase Console (אחרת `accounts:signUp` נדחה — הנעילה האמיתית היא בשרת, לא בלקוח).
