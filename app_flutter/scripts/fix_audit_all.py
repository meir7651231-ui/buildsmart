...
TYPOS = {
    ...
    '77772606': ('ושתומים', 'ושסתום'), '77777010': ('מנגית', 'מגניט'),
    # NOTE: 779096F גרפיטי→גרפיני was WRONG (גרפיטי=Graphite is the real finish; nameEn confirms).
    # Reverted — the typo was in `color` (גרפיני), now corrected to גרפיטי to match name+kLipskeyColors.
