...
void main() {
  ...
  final id0 = appStore.add('app_peruk02_ent1', {'לקוח': 'לקוח-1', 'טלפון': 'טלפון-2', 'סכום הפיקדון': '3', 'מה המשכיר אמר הודעה': 'מה המשכיר אמר הודעה-4', 'תאריך מסירת מפתח': '2026-01-01', 'חוזה לפחות סעיפי בטוחה': 'חוזה לפחות סעיפי בטוחה-6', 'תיקונים': 'תיקונים-7', 'יציאה': 'יציאה-8', 'פרוטוקול כניסה יציאה': 'פרוטוקול כניסה יציאה-9', 'תמונות כניסה ויציאה': 'תמונות כניסה ויציאה-10', 'וואטסאפ מלא עם המשכיר': 'וואטסאפ מלא עם המשכיר-11', 'קבלות על תיקונים שהוא': 'קבלות על תיקונים שהוא-12'});
