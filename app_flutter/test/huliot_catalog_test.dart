...
void main() {
  group('Huliot catalog — additive staging (new-only)', () {
    test('789 well-formed new Huliot products', () {
    ...
    test('image path resolves to huliot/products/{sku}.jpeg', () {
      final p = kHuliotProducts.first;
      expect(p.imageAsset, 'assets/huliot/products/${p.sku}.jpeg');
    });
