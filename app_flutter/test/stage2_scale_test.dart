...
void main() {
  ...
  group('remote listens — boundedness conformance (stage-2 rule 4)', () {
    ...
    const exemptFiles = {
      ...
      'lib/data/repositories/app_settings_repository.dart', // self-doc scoped (appSettings/{uid} single doc — the notif_settings shape)
      'lib/data/repositories/catalog_settings_repository.dart', // self-doc scoped (catalogSettings/{uid} single doc — the notif_settings shape)
      'lib/data/repositories/chat_settings_repository.dart', // self-doc scoped (chatSettings/{uid} single doc — the notif_settings shape)
      'lib/data/repositories/store_settings_repository.dart', // self-doc scoped (storeSettings/{uid} single doc — the notif_settings shape)
      ...
      'lib/data/repositories/worker_notifs_repository.dart', // self-doc scoped (workerNotifs/{uid} single doc — the worker's own bell feed; SELF-ONLY, server-trigger writes)
