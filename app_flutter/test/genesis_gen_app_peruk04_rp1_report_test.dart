...
void main() {
  ...
  final id0 = appStore.add('app_peruk04_ent1', {'לקוח': 'לקוח-1', 'טלפון': 'טלפון-2', 'חוזה ישן': 'חוזה ישן-3', 'טיוטה חדשה': 'טיוטה חדשה-4', 'שכ״ד נוכחי': 'שכ״ד נוכחי-5', 'תאריך סיום': '2026-01-01', 'מתי ביקשו תשובה': '2026-01-01', 'ליקויים פתוחים': 'ליקויים פתוחים-8', 'וואטסאפ': 'וואטסאפ-9', 'מה משלמים באזור': 'מה משלמים באזור-10', 'שכ״ד ישן': 'שכ״ד ישן-11', 'שכ״ד חדש': 'שכ״ד חדש-12', 'בטוחות ישנות': 'בטוחות ישנות-13', 'בטוחות חדשות': 'בטוחות חדשות-14', 'הודעת תשובה אחת': 'כן עם תנאים'});
