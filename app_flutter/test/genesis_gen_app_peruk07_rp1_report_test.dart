...
void main() {
  ...
  final id0 = appStore.add('app_peruk07_ent1', {'לקוח': 'לקוח-1', 'טלפון': 'טלפון-2', 'מכתב הדחייה': 'מכתב הדחייה-3', 'סוג הביטוח מה קרה': 'סוג הביטוח מה קרה-4', 'חזק': 'חזק-5', 'פוליסה או תנאים כלליים': 'פוליסה', 'מה כבר הוגש': 'מה כבר הוגש-7', 'קבלות': 'קבלות-8', 'סיווג': 'א חסר מסמך'});
