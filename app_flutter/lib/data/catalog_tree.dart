  ...
  CatalogNode(
    ...
    children: [
      ...
      CatalogNode(
        ...
        emoji: '✂️',
        brandIds: ['huliot'],
        lipskeyCategory: 'חותך צינורות',
      ),
      CatalogNode(
        id: 'sml.joker',
        title: 'מתאם זווית - ג\'וקר',
        emoji: '🃏',
        brandIds: ['huliot'],
        lipskeyCategory: 'מתאם זווית - ג\'וקר',
      ),
      CatalogNode(
        id: 'sml.elbow_oneside',
        title: 'ברכיים צד אחד חלק',
        emoji: '↪️',
        brandIds: ['huliot'],
        lipskeyCategory: 'ברך צד אחד חלק',
      ),
      CatalogNode(
        id: 'sml.elbow',
        title: 'ברכיים',
      ...
      CatalogNode(
        id: 'sml.elbow_reducing',
        title: 'ברך מצרה',
        emoji: '↘️',
        brandIds: ['huliot'],
        lipskeyCategory: 'ברך מצרה',
      ),
      CatalogNode(
        id: 'sml.elbow_telescopic',
        title: 'ברך טלסקופית',
        emoji: '🔭',
        brandIds: ['huliot'],
        lipskeyCategory: 'ברך טלסקופית',
      ),
      CatalogNode(
        id: 'sml.tees',
        title: 'מסעפים',
        emoji: '🔱',
        brandIds: ['huliot'],
        lipskeyCategory: 'מסעף',
      ),
      CatalogNode(
        id: 'sml.double_coupling',
        title: 'מצמד כפול',
        emoji: '🔗',
        brandIds: ['huliot'],
        lipskeyCategory: 'מצמד כפול',
      ),
      CatalogNode(
        id: 'sml.reducer',
        title: 'מצרה',
      ...
      CatalogNode(
        ...
        emoji: '🧩',
        brandIds: ['huliot'],
        lipskeyCategory: 'אביזרים משלימים',
      ),
      CatalogNode(
        id: 'sml.nuts',
        title: 'אום SmartLock',
        emoji: '⚙️',
        brandIds: ['huliot'],
        lipskeyCategory: 'אום SmartLock',
      ),
      CatalogNode(
        id: 'sml.aquaslim',
        title: 'מאסף קווי AQUA SLIM',
        emoji: '〰️',
        brandIds: ['huliot'],
        lipskeyCategory: 'מאסף קווי AQUA SLIM',
      ),
      CatalogNode(
        id: 'sml.covers',
        title: 'מכסים, הגבהות ורשתות',
        emoji: '🟫',
        brandIds: ['huliot'],
        lipskeyCategory: 'מכסים, הגבהות ורשתות',
      ),
      CatalogNode(
        id: 'sml.siphons',
        title: 'סיפונים',
