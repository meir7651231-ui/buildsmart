...
final List<LipskeyCatalogProduct> kPolyrollCatalog = [
  ...
  _ppr('6602340200', 'מתאם PPRCT לריתוך הברגה עגול תבריג פנימי 20x1/2"', 'PPR Adapter 20x1/2"', kPprAdapters, 'PPR Adapters', '🔩', 53, dims: {'R': '21', 'G': '15', 'D': '19.2', 'B2': '27', 'B1': '33', 'A': '35', 'חומר': 'PPRCT', 'מק"ט חוליות': '6602340200', 'יצרן': 'Polyroll'}),
  _ppr('6602340250', 'מתאם PPRCT לריתוך הברגה עגול תבריג פנימי 25x1/2"', 'PPR Adapter 25x1/2"', kPprAdapters, 'PPR Adapters', '🔩', 53, dims: {'R': '21', 'G': '16', 'D': '24.2', 'B2': '33', 'B1': '36', 'A': '35', 'חומר': 'PPRCT', 'מק"ט חוליות': '6602340250', 'יצרן': 'Polyroll'}),
  _ppr('6602340260', 'מתאם PPRCT לריתוך הברגה עגול תבריג פנימי 25x3/4"', 'PPR Adapter 25x3/4"', kPprAdapters, 'PPR Adapters', '🔩', 53, dims: {'R': '21', 'G': '16', 'D': '24.2', 'B2': '33', 'B1': '40', 'A': '39', 'חומר': 'PPRCT', 'מק"ט חוליות': '6602340260', 'יצרן': 'Polyroll'}),
  _ppr('6602340330', 'מתאם PPRCT לריתוך הברגה עגול תבריג פנימי 32x3/4"', 'PPR Adapter 32x3/4"', kPprAdapters, 'PPR Adapters', '🔩', 53, dims: {'R': '26', 'G': '19', 'D': '31.1', 'B2': '43', 'B1': '42', 'A': '41', 'חומר': 'PPRCT', 'מק"ט חוליות': '6602340330', 'יצרן': 'Polyroll'}),
  _ppr('6602340320', 'מתאם PPRCT לריתוך הברגה עגול תבריג פנימי 32x1"', 'PPR Adapter 32x1"', kPprAdapters, 'PPR Adapters', '🔩', 53, dims: {'R': '26', 'G': '19', 'D': '31.1', 'B2': '43', 'B1': '53', 'A': '47', 'חומר': 'PPRCT', 'מק"ט חוליות': '6602340320', 'יצרן': 'Polyroll'}),
  _ppr('6602340400', 'מתאם PPR לריתוך הברגה עגול תבריג פנימי 40x1¼"', 'PPR Adapter 1/4"', kPprAdapters, 'PPR Adapters', '🔩', 53, dims: {'R': '21', 'G': '48', 'F': '48', 'E': '39.0', 'D': '54', 'B2': '68', 'B1': '57', 'מק"ט חוליות': '6602340400', 'יצרן': 'Polyroll'}),
  _ppr('6602340500', 'מתאם PPR לריתוך הברגה עגול תבריג פנימי 50x1½"', 'PPR Adapter 1/2"', kPprAdapters, 'PPR Adapters', '🔩', 53, dims: {'R': '24', 'G': '54', 'F': '53', 'E': '48.9', 'D': '66', 'B2': '80', 'B1': '62', 'מק"ט חוליות': '6602340500', 'יצרן': 'Polyroll'}),
  _ppr('6602340630', 'מתאם PPR לריתוך הברגה עגול תבריג פנימי 63x2"', 'PPR Adapter 63x2"', kPprAdapters, 'PPR Adapters', '🔩', 53, dims: {'R': '32', 'G': '28', 'F': '65', 'E': '60', 'D': '61.9', 'B2': '84', 'B1': '94', 'A': '76', 'מק"ט חוליות': '6602340630', 'יצרן': 'Polyroll'}),
  ...
  _ppr('6702340320', 'מתאם PPRCT ריתוך/הברגה עם רקורד 32x1"', 'PPR Adapter 32x1”', kPprAdapters, 'PPR Adapters', '🔩', 55, dims: {'R1': '26', 'G': '19', 'F': '51', 'E': '16', 'D2': '47', 'D1': '31.1', 'B2': '43', 'B1': '53', 'A': '81', 'חומר': 'PPRCT', 'מק"ט חוליות': '6702340320', 'יצרן': 'Polyroll'}),
  _ppr('6702340330', 'מתאם PPRCT ריתוך/הברגה עם רקורד 32x1¼"', 'PPR Adapter 1/4”', kPprAdapters, 'PPR Adapters', '🔩', 55, dims: {'R2': '26', 'R1': '19', 'G': '51', 'F': '17', 'E': '41', 'D2': '31.1', 'D1': '43', 'B2': '42', 'B1': '81', 'חומר': 'PPRCT', 'מק"ט חוליות': '6702340330', 'יצרן': 'Polyroll'}),
  _ppr('6702340400', 'מתאם PPR ריתוך/הברגה עם רקורד 40x1½"', 'PPR Adapter 1/2”', kPprAdapters, 'PPR Adapters', '🔩', 55, dims: {'R2': '28', 'R1': '21', 'G': '58', 'F': '18', 'E': '57', 'D2': '39', 'D1': '54', 'B2': '68', 'B1': '94', 'מק"ט חוליות': '6702340400', 'יצרן': 'Polyroll'}),
  _ppr('6702340500', 'מתאם PPR ריתוך/הברגה עם רקורד 50x2"', 'PPR Adapter 50x2”', kPprAdapters, 'PPR Adapters', '🔩', 55, dims: {'R1': '32', 'G': '24', 'F': '71', 'E': '22', 'D2': '62', 'D1': '48.9', 'B2': '66', 'B1': '80', 'A': '107', 'מק"ט חוליות': '6702340500', 'יצרן': 'Polyroll'}),
  _ppr('6702340630', 'מתאם PPR ריתוך/הברגה עם רקורד 63x2½"', 'PPR Adapter 1/2”', kPprAdapters, 'PPR Adapters', '🔩', 55, dims: {'R2': '32', 'R1': '28', 'G': '89', 'F': '26', 'E': '76', 'D2': '61.9', 'D1': '84', 'B2': '94', 'B1': '123', 'מק"ט חוליות': '6702340630', 'יצרן': 'Polyroll'}),
  _ppr('6702340750', 'מתאם PPR ריתוך/הברגה עם רקורד 75x3"', 'PPR Adapter 75x3”', kPprAdapters, 'PPR Adapters', '🔩', 55, dims: {'R1': '32', 'G': '31', 'F': '101', 'E': '28', 'D2': '85', 'D1': '73.7', 'B2': '100', 'B1': '114', 'A': '135', 'מק"ט חוליות': '6702340750', 'יצרן': 'Polyroll'}),
