...
// 🧬 שם: 🗂️ הצעה
// 🧬 בקשה: הירו 🗂️ הצעה | ישות מורכבת — טופס + טבלה · אטום BreadcrumbTrail הצעה: טיוטה / נשלחה / במשא ומתן / אושרה / נדחתה · כותרת טופס הצעה · אטום NumberStepper מספר · אטום FieldRow לקוח · אטום FieldRow פרויקט · אטום NumberStepper מחיר · אטום FieldRow מס · אטום FieldRow תוקף · אטום AnimatedToggle סטטוס · אטום FabMenu שמירה · אטום NeonButton קדם לנשלחה · כותרת רשומות הצעה · אטום DataGrid הצעה · כותרת 🔗 מנוע-חוקים חי · 1 חוקים מהמדף · חישוב מספר סידורי של (excelSerialToIso) · באנר ישות הצעה: 7 שדות · 5-שלבי workflow · 1 חוקים חיים · מהמדף
