...
class _GenAppEnt7ScreenState extends State<GenAppEnt7Screen> {
  ...
  void _save() {
    ...
    appStore.add(gen_app_ent7_c7, <String, String>{gen_app_ent7_c8: _v[0] ?? '', gen_app_ent7_c10: _v[1] ?? '', gen_app_ent7_c11: _v[2] ?? '', gen_app_ent7_c12: _v[3] ?? '', gen_app_ent7_c13: _v[4] ?? '', gen_app_ent7_c14: _v[5] ?? '', gen_app_ent7_c15: _v[6] ?? ''});
    setState(() => _v.clear());
  }
    ...
    return DsScaffold(
      ...
      children: [
        ...
        DsSection(title: gen_app_ent7_c4, children: [
          ...
          if ((_v[6] ?? '').trim().isNotEmpty) _live(gen_app_ent7_c16, advanceStatus((_v[6] ?? ''))),
        ]),
          ...
          AnimatedBuilder(
            ...
            builder: (context, _) {
              ...
              return Column(children: [
                for (final r in rs)
                  DsRecordCard(labels: const [gen_app_ent7_c8, gen_app_ent7_c10, gen_app_ent7_c11, gen_app_ent7_c12, gen_app_ent7_c13, gen_app_ent7_c14, gen_app_ent7_c15], values: [r[gen_app_ent7_c8] ?? '', r[gen_app_ent7_c10] ?? '', r[gen_app_ent7_c11] ?? '', r[gen_app_ent7_c12] ?? '', r[gen_app_ent7_c13] ?? '', r[gen_app_ent7_c14] ?? '', r[gen_app_ent7_c15] ?? '']),
              ]);
            },
          ),
        ]),
