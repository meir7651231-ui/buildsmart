...
import 'gen_app_peruk20_behavior.dart';
...
class _GenAppPeruk20HubScreenState extends State<GenAppPeruk20HubScreen> {
  ...
  List<Widget> _tiles(BuildContext context) => [
        ...
        DsNavTile(glyph: gen_app_peruk20_hub_c23, title: gen_app_peruk20_hub_c24, sub: gen_app_peruk20_hub_c25, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const GenAppPeruk20BehaviorScreen()))),
  ];
