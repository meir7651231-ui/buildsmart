...
// 🧬 בקשה: רכיבים חיים - קלט מתקדם: · הירו 🔢 קלט מתקדם | קוד טווח וצבעים ממשפט · כותרת קלט · קוד 48 6 קוד אימות · טווח 30 25 75 טווח מחירים · צבעים 40 6 בחר צבע · תיוג 34 תיוג: עברית / עיצוב / פלאטר · באנר כל קלט כאן חי - נבחר ממילה בעברית
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          DualRange(height: 30, radius: 12, accentColor: BsTokens.brand, baseColor: BsTokens.inkLight, fillColor: BsTokens.cardLight, low: 25, high: 75),
