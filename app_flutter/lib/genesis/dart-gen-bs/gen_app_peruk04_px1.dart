...
class GenAppPeruk04Px1Screen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => DsScaffold(title: gen_app_peruk04_px1_c95, subtitle: gen_app_peruk04_px1_c96, icon: gen_app_peruk04_px1_c97, header: false, children: [ForgeCenteredPageHeader(fields: ['', gen_app_peruk04_px1_c95, gen_app_peruk04_px1_c96]), ...[
    ...
    Padding(padding: const EdgeInsets.only(bottom: 10), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [ToastCard(message: gen_app_peruk04_px1_c30, tone: 0), ToastCard(message: gen_app_peruk04_px1_c33, tone: 0), ToastCard(message: gen_app_peruk04_px1_c36, tone: 0), ToastCard(message: gen_app_peruk04_px1_c39, tone: 0), ToastCard(message: gen_app_peruk04_px1_c42, tone: 0), ToastCard(message: gen_app_peruk04_px1_c45, tone: 0)])),
    Padding(padding: const EdgeInsets.only(bottom: 10), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [ToastCard(message: gen_app_peruk04_px1_c49, tone: 0), ToastCard(message: gen_app_peruk04_px1_c52, tone: 0), ToastCard(message: gen_app_peruk04_px1_c55, tone: 0), ToastCard(message: gen_app_peruk04_px1_c58, tone: 0), ToastCard(message: gen_app_peruk04_px1_c61, tone: 0), ToastCard(message: gen_app_peruk04_px1_c64, tone: 0), ToastCard(message: gen_app_peruk04_px1_c67, tone: 0), ToastCard(message: gen_app_peruk04_px1_c70, tone: 0), ToastCard(message: gen_app_peruk04_px1_c73, tone: 0), ToastCard(message: gen_app_peruk04_px1_c76, tone: 0), ToastCard(message: gen_app_peruk04_px1_c79, tone: 0)])),
    Padding(padding: const EdgeInsets.only(bottom: 10), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [ToastCard(message: gen_app_peruk04_px1_c83, tone: 0), ToastCard(message: gen_app_peruk04_px1_c86, tone: 0), ToastCard(message: gen_app_peruk04_px1_c89, tone: 0), ToastCard(message: gen_app_peruk04_px1_c92, tone: 0)])),
  ]]);
}
