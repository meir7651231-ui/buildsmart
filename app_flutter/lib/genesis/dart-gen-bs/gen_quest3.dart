    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          if (_v1) Row(children: [RStat(value: hebMonthHeWired(DateTime.now()), label: gen_quest3_stat_label)]),
