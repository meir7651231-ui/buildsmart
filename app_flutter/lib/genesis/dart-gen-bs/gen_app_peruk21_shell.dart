...
class _RootTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    return DsScaffold(title: gen_app_peruk21_shell_c11, subtitle: rs.length.toString() + ' ' + gen_app_peruk21_shell_c12, icon: gen_app_peruk21_shell_c13, children: [
      ...
      for (final r in rs) DsNavTile(glyph: gen_app_peruk21_shell_c14, title: (r[gen_app_peruk21_shell_c9] ?? ''), sub: (r[gen_app_peruk21_shell_c10] ?? ''), onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk21RootScreen(id: r[AppStore.idKey] ?? '')))),
    ]);
  });
}
