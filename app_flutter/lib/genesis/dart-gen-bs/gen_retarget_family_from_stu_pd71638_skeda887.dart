...
//   עור-forge (G12c/e): BareStat⇒ForgeStatPlain ×0 (ב-Wrap) · ×11 (ב-Row, Expanded) · פנימיים: button×26 statusChip×16 banner×7 emptyState×9 mediaRow×4 · StatHero⇒ForgeStatPlain ×0 · KpiTile⇒— · DsNavTile⇒— — fields לפי תפקידי-חריצים; צבעי-מצב-DS לא מועברים
//   תפר-עובדות (G9b): FamilyFacts · count=families.length (seed-db) · מדדים 0 · hero=count · שורות-מדד (G10a) ∅ · תפר-כניסה initialPanelId · תפר-סינון-מדד ∅ · תפר-הזרקה db (families/members · 5 עמודות-שמורות)
...
// G17c · מטרה (צעד 1, אדם): לדעת מי שלח, לאיזו עיר, ולשלוח לו את הפלט בוואטסאפ · פעולות-יסוד (צעד 2, אדם): איתור · קשר-הורה ⇒ חלקיקים (המנוע): stu.locate · stu.contact
...
class _FamilyScreenState extends State<FamilyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return DsScaffold(title: 'FamilyScreen', subtitle: 'FamilyScreen · מודול-משנה מחולל · 1 בונים מחווטים-לשקעי-הזהב', icon: '🧬', header: false, children: [ForgeCenteredPageHeader(fields: ['', 'FamilyScreen', 'FamilyScreen · מודול-משנה מחולל · 1 בונים מחווטים-לשקעי-הזהב']), ...[
      _gap(10),
