...
import '../dart-data-bs/auto/gen_app_peruk28_main_content.dart';
import '../dart-ui-bs/ds/ds_pure.dart';
import '../dart-ui-bs/ds/ds_seam.dart';
import 'gen_app_peruk28_shell.dart';
import 'package:flutter/material.dart';

void main() => runApp(const GenAppPeruk28MainScreen());

class GenAppPeruk28MainScreen extends StatelessWidget {
  const GenAppPeruk28MainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_peruk28_main_c0,
        ...
        home: const GenAppPeruk28ShellScreen(),
      );
}
