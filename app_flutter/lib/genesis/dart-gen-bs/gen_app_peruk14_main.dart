...
import '../dart-data-bs/auto/gen_app_peruk14_main_content.dart';
import '../dart-ui-bs/ds/ds_pure.dart';
import '../dart-ui-bs/ds/ds_seam.dart';
import 'gen_app_peruk14_shell.dart';
import 'package:flutter/material.dart';

void main() => runApp(const GenAppPeruk14MainScreen());

class GenAppPeruk14MainScreen extends StatelessWidget {
  const GenAppPeruk14MainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_peruk14_main_c0,
        ...
        home: const GenAppPeruk14ShellScreen(),
      );
}
