...
import '../dart-data-bs/auto/gen_app_peruk27_main_content.dart';
import '../dart-ui-bs/ds/ds_pure.dart';
import '../dart-ui-bs/ds/ds_seam.dart';
import 'gen_app_peruk27_shell.dart';
import 'package:flutter/material.dart';

void main() => runApp(const GenAppPeruk27MainScreen());

class GenAppPeruk27MainScreen extends StatelessWidget {
  const GenAppPeruk27MainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_peruk27_main_c0,
        ...
        home: const GenAppPeruk27ShellScreen(),
      );
}
