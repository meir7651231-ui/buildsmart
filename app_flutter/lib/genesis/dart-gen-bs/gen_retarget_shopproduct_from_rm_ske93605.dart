    ...
    return [
      ...
      if (_ShopProductData.roleName(_role) == 'admin') ...[
        ForgeTitledSection(fields: ['📊 ניצולת-שבועית להנהלה · ממוצע ${_ShopProductData.utilAvgPct}%', '', '', ''], child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [...[
          ForgeWaveformBars(fields: ['', ''], values: (() { final _vs = [for (final r in _ShopProductData.utilRanked) _ShopProductData.utilPct(r).toDouble()]; final _m = _vs.fold<double>(0.0, (a, b) => a > b ? a : b); return [for (final v in _vs) _m == 0 ? 0.0 : v / _m]; })()),
          _gap(6),
          Row(children: [
