...
class _GenAppEnt19ScreenState extends State<GenAppEnt19Screen> {
  ...
  void _save() {
    ...
    appStore.add(gen_app_ent19_c7, <String, String>{gen_app_ent19_c8: _v[0] ?? '', gen_app_ent19_c9: _v[1] ?? '', gen_app_ent19_c10: _v[2] ?? '', gen_app_ent19_c11: _v[3] ?? '', gen_app_ent19_c12: _v[4] ?? '', gen_app_ent19_c14: _v[5] ?? '', gen_app_ent19_c15: _v[6] ?? ''});
    setState(() => _v.clear());
  }
  ...
  Widget build(BuildContext context) {
    return DsScaffold(
      ...
      children: [
        DsWorkflow(steps: const [gen_app_ent19_c17, gen_app_ent19_c18, gen_app_ent19_c19, gen_app_ent19_c20, gen_app_ent19_c21], current: 2),
        DsSection(title: gen_app_ent19_c4, children: [
          ...
          if ((_v[4] ?? '').trim().isNotEmpty) _live(gen_app_ent19_c13, fmtDate((_v[4] ?? ''))),
          ...
          if ((_v[6] ?? '').trim().isNotEmpty) _live(gen_app_ent19_c16, advanceStatus((_v[6] ?? ''))),
        ]),
          ...
          AnimatedBuilder(
            ...
            builder: (context, _) {
              ...
              return Column(children: [
                for (final r in rs)
                  DsRecordCard(labels: const [gen_app_ent19_c8, gen_app_ent19_c9, gen_app_ent19_c10, gen_app_ent19_c11, gen_app_ent19_c12, gen_app_ent19_c14, gen_app_ent19_c15], values: [r[gen_app_ent19_c8] ?? '', r[gen_app_ent19_c9] ?? '', r[gen_app_ent19_c10] ?? '', r[gen_app_ent19_c11] ?? '', r[gen_app_ent19_c12] ?? '', r[gen_app_ent19_c14] ?? '', r[gen_app_ent19_c15] ?? '']),
              ]);
            },
          ),
        ]),
