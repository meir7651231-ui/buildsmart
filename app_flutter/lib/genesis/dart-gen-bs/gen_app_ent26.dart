    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          InlineTextRow(label: gen_app_ent26_textfield_label, hint: gen_app_ent26_textfield_hint, value: _t1, onChanged: (v) => setState(() => _t1 = v)),
          GlowField(hint: gen_app_ent26_glowfield_hint, height: 16, radius: 12, accentColor: BsTokens.brand, baseColor: BsTokens.inkLight, fillColor: BsTokens.cardLight),
          DatePills(height: 16, days: 0, radius: 12, accentColor: BsTokens.brand, baseColor: BsTokens.inkLight, fillColor: BsTokens.cardLight),
          InlineTextRow(label: gen_app_ent26_textfield_label2, hint: gen_app_ent26_textfield_hint2, value: _t2, onChanged: (v) => setState(() => _t2 = v)),
