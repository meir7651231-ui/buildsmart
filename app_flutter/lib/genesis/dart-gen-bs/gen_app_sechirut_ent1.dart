...
class GenAppSechirutEnt1Screen extends StatefulWidget {
  const GenAppSechirutEnt1Screen({this.scopeField, this.scopeId, this.initial, this.editId, super.key});
...
class _GenAppSechirutEnt1ScreenState extends State<GenAppSechirutEnt1Screen> {
  ...
  @override
  void initState() { super.initState(); _prefill(); if (widget.editId != null) { final r = appStore.byId('app_sechirut_ent1', widget.editId!); if (r != null) WidgetsBinding.instance.addPostFrameCallback((_) { if (mounted) _edit(r); }); } }
