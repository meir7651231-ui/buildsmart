...
class _GenAppSechirutEnt1ScreenState extends State<GenAppSechirutEnt1Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return DsScaffold(
      ...
      bottomBar: GestureDetector(behavior: HitTestBehavior.opaque, onTap: _save, child: ForgeToneButton(items: [[_editId == null ? gen_app_sechirut_ent1_c3 : gen_app_sechirut_ent1_c4]])),
      children: [
        AnimatedBuilder(animation: appStore, builder: (context, _) => Padding(padding: const EdgeInsets.only(bottom: 12), child: Row(children: [Expanded(child: DsStat(label: gen_app_sechirut_ent1_c0, value: appStore.count('app_sechirut_ent1').toString(), sub: gen_app_sechirut_ent1_c45, glyph: gen_app_sechirut_ent1_c46))]))),
