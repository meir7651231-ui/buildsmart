...
// 🧬 שם: המחולל
// 🧬 בקשה: המחולל: · הירו 🧬 המחולל של המחצב | משפט בעברית נהיה מסך עובד · כותרת מה יש במפעל · נתון ⚛️ 381 אטומים ויזואליים על המדף · נתון 🧠 996 אטומי לוגיקה מומרים ומוכנים · נתון 🏭 79 מסכים הורכבו מחדש מהלבנים · כותרת גשר הלוגיקה פועם · חישוב החודש העברי כרגע לפי מנוע מאור · חישוב קוד הזמנה דטרמיניסטי "genesis" · כותרת הצורות שהמחולל מבין · תגיות צורות: מתג / שדה / מספר / בורר / תגיות / כרטיס / כותרת / כפתור · באנר המסך הזה נוצר על ידי המחולל עצמו — מאטומים קיימים בלבד · כפתור ✨ צרו מסך חדש
// 🧬 אטומים שנבחרו: HeroCard · CaSubTitle · RStat · RStat · RStat · CaSubTitle · RStat · RStat · CaSubTitle · ChipWrap · CoinBanner · ActionRow
