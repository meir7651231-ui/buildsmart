...
// 🧬 שם: המחולל
// 🧬 בקשה: המחולל: · הירו 🧬 המחולל של המחצב | דיוקן עצמי חי - את כל ההדגמות כאן בחרתי בעצמי · כותרת המפעל במספרים - עדכון חי מהאטלס · נתון ⚛️ 381 לבנים ויזואליות על המדף · נתון 🧠 445 אטומי לוגיקה פעילים · נתון 🖼️ 79 מסכים הורכבו מחדש · כותרת גשר הלוגיקה - פונקציה שבחרתי מהמדף · חישוב קופסה חיווט לוח עברי מלבנים עיוורות דאטה כרעת טוהר · כותרת יכולת מורכבת - שדה מזין חישוב חי · שדה הקלידו ערך עבור דין אדר · חישוב דין אדר · כותרת חיבור אטום לאטום - הבחירה מחליפה את המוצג · בחירה מתג או שדה או נתון: מתג / שדה / נתון · מתג מתג · שדה שדה · נתון נתון · כותרת חיבור בין מסכים - המסכים שיצרתי מבקשות · ניווט business פרופיל עסק | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט capautodream הזמנה-עצמית - יכולת שחלמתי היום והוכחתי לבד - מסיר את איבר ואז זהות עובד קנונית | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט capclockcalendar מסע-בזמן של השעון - שעת-יממה נהפכת לתאריך-תצוגה כשכל דקה מחצות נספרת כיום שלם בלוח | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט capmailphone שחזור מספר טלפון לתצוגה ישראלית תקנית מתוך שורה שהגיעה עטופה בקידוד-מייל ישן | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט captimegematria חתימת-אותיות עברית לשעה על השעון - כמה דקות עברו מחצות הלילה כתוב בגימטריה | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט improv יכולת מאולתרת - שרשרת חמישה | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט mission חדר בקרה - משימה לירח | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט quest1 עולם משחק שלם - חדר 1 | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט quest2 עולם משחק שלם - חדר 2 | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט shipping הגדרות משלוחים | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט showcase ראווה - כרטיס-הביקור החי של המחולל | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט team ניהול צוות | נוצר מבקשה בעברית - הקישו לפתיחה · כותרת אוצר-דאטה חי - אטום-דאטה שחולץ בטיהור והפך חומר-בנייה · דאטה DOW_HE DOW_HE · תגיות הצורות שאני מבין: מתג / שדה / מספר / כפתור / באנר / בחירה / תגיות / כרטיס / כותרת / שורה / נתון / חישוב · באנר את המסך הזה כתבתי והרכבתי לבד מהידע החי שלי - מאטומים קיימים בלבד · כפתור ✨ צרו מסך חדש
// 🧬 אטומים שנבחרו: HeroCard · CaSubTitle · RStat · RStat · RStat · CaSubTitle · RStat · CaSubTitle · InlineTextRow · CaSubTitle · UnitSegmentToggle · CaSubTitle · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · CaSubTitle · ChipWrap · ChipWrap · CoinBanner · ActionRow · RStat · SwitchRow · InlineTextRow · RStat
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          HeroCard(glyph: gen_entry_card_glyph11, title: gen_entry_card_title11, sub: gen_entry_card_sub11, onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const GenShippingScreen())), cardColor: BsTokens.cardLight, inkColor: BsTokens.inkLight, mutedColor: BsTokens.mutedLight, borderColor: BsTokens.divider, radius: 12),
          HeroCard(glyph: gen_entry_card_glyph12, title: gen_entry_card_title12, sub: gen_entry_card_sub12, onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const GenShowcaseScreen())), cardColor: BsTokens.cardLight, inkColor: BsTokens.inkLight, mutedColor: BsTokens.mutedLight, borderColor: BsTokens.divider, radius: 12),
          HeroCard(glyph: gen_entry_card_glyph13, title: gen_entry_card_title13, sub: gen_entry_card_sub13, onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const GenTeamScreen())), cardColor: BsTokens.cardLight, inkColor: BsTokens.inkLight, mutedColor: BsTokens.mutedLight, borderColor: BsTokens.divider, radius: 12),
