...
// 🧬 שם: המחולל
// 🧬 בקשה: המחולל: · הירו 🧬 המחולל של המחצב | דיוקן עצמי חי - את כל ההדגמות כאן בחרתי בעצמי · כותרת המפעל במספרים - עדכון חי מהאטלס · נתון ⚛️ 381 לבנים ויזואליות על המדף · נתון 🧠 438 אטומי לוגיקה פעילים · נתון 🖼️ 79 מסכים הורכבו מחדש · כותרת גשר הלוגיקה - פונקציה שבחרתי מהמדף · חישוב שם חודש עברי · כותרת יכולת מורכבת - שדה מזין חישוב חי · שדה הקלידו ערך עבור דין אדר · חישוב דין אדר · כותרת חיבור אטום לאטום - הבחירה מחליפה את המוצג · בחירה מתג או שדה או נתון: מתג / שדה / נתון · מתג מתג · שדה שדה · נתון נתון · כותרת חיבור בין מסכים - המסכים שיצרתי מבקשות · ניווט business פרופיל עסק | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט improv יכולת מאולתרת - שרשרת חמישה | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט mission חדר בקרה - משימה לירח | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט shipping הגדרות משלוחים | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט team ניהול צוות | נוצר מבקשה בעברית - הקישו לפתיחה · תגיות הצורות שאני מבין: מתג / שדה / מספר / כפתור / באנר / בחירה / תגיות / כרטיס / כותרת / שורה / נתון / חישוב · באנר את המסך הזה כתבתי והרכבתי לבד מהידע החי שלי - מאטומים קיימים בלבד · כפתור ✨ צרו מסך חדש
// 🧬 אטומים שנבחרו: HeroCard · CaSubTitle · RStat · RStat · RStat · CaSubTitle · RStat · CaSubTitle · InlineTextRow · CaSubTitle · UnitSegmentToggle · CaSubTitle · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · ChipWrap · CoinBanner · ActionRow · RStat · SwitchRow · InlineTextRow · RStat
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          HeroCard(glyph: gen_entry_card_glyph5, title: gen_entry_card_title5, sub: gen_entry_card_sub5, onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const GenShippingScreen())), cardColor: BsTokens.cardLight, inkColor: BsTokens.inkLight, mutedColor: BsTokens.mutedLight, borderColor: BsTokens.divider, radius: 12),
          HeroCard(glyph: gen_entry_card_glyph6, title: gen_entry_card_title6, sub: gen_entry_card_sub6, onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const GenTeamScreen())), cardColor: BsTokens.cardLight, inkColor: BsTokens.inkLight, mutedColor: BsTokens.mutedLight, borderColor: BsTokens.divider, radius: 12),
