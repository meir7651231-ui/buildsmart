...
// 🧬 שם: המחולל
// 🧬 בקשה: המחולל: · הירו 🧬 המחולל של המחצב | דיוקן עצמי חי - את כל ההדגמות כאן בחרתי בעצמי · כותרת המפעל במספרים - עדכון חי מהאטלס · נתון ⚛️ 381 לבנים ויזואליות על המדף · נתון 🧠 445 אטומי לוגיקה פעילים · נתון 🖼️ 79 מסכים הורכבו מחדש · כותרת גשר הלוגיקה - פונקציה שבחרתי מהמדף · חישוב קופסה חיווט לוח עברי מלבנים עיוורות דאטה כרעת טוהר · כותרת יכולת מורכבת - שדה מזין חישוב חי · שדה הקלידו ערך עבור דין אדר · חישוב דין אדר · כותרת חיבור אטום לאטום - הבחירה מחליפה את המוצג · בחירה מתג או שדה או נתון: מתג / שדה / נתון · מתג מתג · שדה שדה · נתון נתון · כותרת חיבור בין מסכים - המסכים שיצרתי מבקשות · ניווט business פרופיל עסק | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט improv יכולת מאולתרת - שרשרת חמישה | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט mission חדר בקרה - משימה לירח | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט quest1 עולם משחק שלם - חדר 1 | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט quest2 עולם משחק שלם - חדר 2 | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט shipping הגדרות משלוחים | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט team ניהול צוות | נוצר מבקשה בעברית - הקישו לפתיחה · כותרת אוצר-דאטה חי - אטום-דאטה שחולץ בטיהור והפך חומר-בנייה · דאטה DOW_HE DOW_HE · תגיות הצורות שאני מבין: מתג / שדה / מספר / כפתור / באנר / בחירה / תגיות / כרטיס / כותרת / שורה / נתון / חישוב · באנר את המסך הזה כתבתי והרכבתי לבד מהידע החי שלי - מאטומים קיימים בלבד · כפתור ✨ צרו מסך חדש
// 🧬 אטומים שנבחרו: HeroCard · CaSubTitle · RStat · RStat · RStat · CaSubTitle · RStat · CaSubTitle · InlineTextRow · CaSubTitle · UnitSegmentToggle · CaSubTitle · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · CaSubTitle · HierarchyChipPill · ChipWrap · CoinBanner · ActionRow · RStat · SwitchRow · InlineTextRow · RStat
...
import '../dart-ui-bs/auto/hierarchy_chip_pill.dart';
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          HierarchyChipPill(word: gen_entry_chip_word, onTap: () => _toast(gen_entry_chip_toast)),
