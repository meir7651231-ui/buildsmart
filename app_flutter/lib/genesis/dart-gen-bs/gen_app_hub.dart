...
// 🧬 בקשה: הירו 🏗️ האפליקציה שלי | נבנתה מאפיון-חופשי · ניווט app_ent1 🗂️ פרויקט · ניווט app_ent2 🗂️ ליד · ניווט app_ent3 🗂️ לקוח · ניווט app_ent4 🗂️ משימה · ניווט app_ent5 🗂️ חשבונית · ניווט app_scr6 📊 דשבורד הנהלה עם פרויקטים · ניווט app_scr7 📊 לוח זמנים גאנט עם משימות · ניווט app_scr8 📊 דוח יומי עם מזג אוויר · באנר 8 מסכים · המחולל הרכיב אפליקציה שלמה מהמדף
// 🧬 אטומים שנבחרו: HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · CoinBanner
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          HeroCard(glyph: gen_app_hub_card_glyph7, title: gen_app_hub_card_title7, sub: gen_app_hub_card_sub7, onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const GenAppScr7Screen())), cardColor: BsTokens.cardLight, inkColor: BsTokens.inkLight, mutedColor: BsTokens.mutedLight, borderColor: BsTokens.divider, radius: 12),
          HeroCard(glyph: gen_app_hub_card_glyph8, title: gen_app_hub_card_title8, sub: gen_app_hub_card_sub8, onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const GenAppScr8Screen())), cardColor: BsTokens.cardLight, inkColor: BsTokens.inkLight, mutedColor: BsTokens.mutedLight, borderColor: BsTokens.divider, radius: 12),
          CoinBanner(coins: 8, sub: gen_app_hub_banner_sub),
          ],
        ),
      ),
    );
