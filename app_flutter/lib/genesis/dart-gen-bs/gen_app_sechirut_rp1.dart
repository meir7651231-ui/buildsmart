...
class _GenAppSechirutRp1ScreenState extends State<GenAppSechirutRp1Screen> {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, __) {
    ...
    if (rs.isEmpty) return DsScaffold(title: gen_app_sechirut_rp1_c214, subtitle: gen_app_sechirut_rp1_c215, icon: gen_app_sechirut_rp1_c217, children: [EmptyState(label: gen_app_sechirut_rp1_c3)]);
    ...
    return DsScaffold(title: gen_app_sechirut_rp1_c214, subtitle: gen_app_sechirut_rp1_c215, icon: gen_app_sechirut_rp1_c218, children: [
