...
import '../dart-data-bs/auto/gen_app_peruk02_main_content.dart';
import '../dart-ui-bs/ds/ds_pure.dart';
import '../dart-ui-bs/ds/ds_seam.dart';
import 'gen_app_peruk02_relations.dart';
import '../dart-ui-bs/ds/ds_store.dart';
import 'gen_app_peruk02_shell.dart';
import 'package:flutter/material.dart';

void main() { registerAppRelations(appStore); runApp(const GenAppPeruk02MainScreen()); }

class GenAppPeruk02MainScreen extends StatelessWidget {
  const GenAppPeruk02MainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_peruk02_main_c0,
        ...
        home: const GenAppPeruk02ShellScreen(),
      );
}
