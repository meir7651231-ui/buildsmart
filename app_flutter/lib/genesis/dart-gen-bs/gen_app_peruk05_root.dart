...
class GenAppPeruk05RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk05_root_c51, subtitle: gen_app_peruk05_root_c52, icon: gen_app_peruk05_root_c53, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk05_ent1', id), subtitle: const [gen_app_peruk05_root_c46, gen_app_peruk05_root_c47, gen_app_peruk05_root_c48, gen_app_peruk05_root_c49, gen_app_peruk05_root_c50][appStore.stageOf('app_peruk05_ent1', id).clamp(0, 4)], icon: gen_app_peruk05_root_c54, children: [
      Padding(padding: const EdgeInsets.only(bottom: 12), child: DsSection(title: gen_app_peruk05_root_c42 + ' · ' + appStore.referencing('app_peruk05_ent2', gen_app_peruk05_root_c35, id).length.toString(), children: [for (final r in appStore.referencing('app_peruk05_ent2', gen_app_peruk05_root_c35, id)) DsNavTile(glyph: gen_app_peruk05_root_c41, title: (r[gen_app_peruk05_root_c36] ?? ''), sub: (r[gen_app_peruk05_root_c37] ?? ''), onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk05Ent2Screen(scopeField: gen_app_peruk05_root_c38, scopeId: id)))), GestureDetector(behavior: HitTestBehavior.opaque, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk05Ent2Screen(scopeField: gen_app_peruk05_root_c38, scopeId: id))), child: ForgeToneButton(items: [[gen_app_peruk05_root_c39]]))], tone: 0)),
      Padding(padding: const EdgeInsets.only(bottom: 12), child: GestureDetector(behavior: HitTestBehavior.opaque, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk05Rp1Screen(initialId: id))), child: ForgeToneButton(items: [[gen_app_peruk05_root_c43]]))),
