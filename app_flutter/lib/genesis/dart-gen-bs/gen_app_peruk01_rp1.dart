...
class _GenAppPeruk01Rp1ScreenState extends State<GenAppPeruk01Rp1Screen> {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, __) {
    ...
    if (rs.isEmpty) return DsScaffold(title: gen_app_peruk01_rp1_c160, subtitle: gen_app_peruk01_rp1_c161, icon: gen_app_peruk01_rp1_c163, children: [EmptyState(label: gen_app_peruk01_rp1_c3)]);
    ...
    return DsScaffold(title: gen_app_peruk01_rp1_c160, subtitle: gen_app_peruk01_rp1_c161, icon: gen_app_peruk01_rp1_c164, children: [
