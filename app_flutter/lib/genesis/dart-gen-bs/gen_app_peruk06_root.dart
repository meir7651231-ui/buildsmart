...
class GenAppPeruk06RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk06_root_c61, subtitle: gen_app_peruk06_root_c62, icon: gen_app_peruk06_root_c63, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk06_ent1', id), subtitle: const [gen_app_peruk06_root_c56, gen_app_peruk06_root_c57, gen_app_peruk06_root_c58, gen_app_peruk06_root_c59, gen_app_peruk06_root_c60][appStore.stageOf('app_peruk06_ent1', id).clamp(0, 4)], icon: gen_app_peruk06_root_c64, children: [
      Padding(padding: const EdgeInsets.only(bottom: 12), child: DsSection(title: gen_app_peruk06_root_c52 + ' · ' + appStore.referencing('app_peruk06_ent2', gen_app_peruk06_root_c45, id).length.toString(), children: [for (final r in appStore.referencing('app_peruk06_ent2', gen_app_peruk06_root_c45, id)) DsNavTile(glyph: gen_app_peruk06_root_c51, title: (r[gen_app_peruk06_root_c46] ?? ''), sub: (r[gen_app_peruk06_root_c47] ?? ''), onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk06Ent2Screen(scopeField: gen_app_peruk06_root_c48, scopeId: id)))), GestureDetector(behavior: HitTestBehavior.opaque, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk06Ent2Screen(scopeField: gen_app_peruk06_root_c48, scopeId: id))), child: ForgeToneButton(items: [[gen_app_peruk06_root_c49]]))], tone: 0)),
      Padding(padding: const EdgeInsets.only(bottom: 12), child: GestureDetector(behavior: HitTestBehavior.opaque, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk06Rp1Screen(initialId: id))), child: ForgeToneButton(items: [[gen_app_peruk06_root_c53]]))),
