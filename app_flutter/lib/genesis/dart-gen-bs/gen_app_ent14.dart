...
// 🧬 שם: 🗂️ הזמנת רכש
// 🧬 בקשה: הירו 🗂️ הזמנת רכש | ישות מורכבת — טופס + טבלה · אטום BreadcrumbTrail הזמנת רכש: בקשה / אושר / הוזמן / נמסר · כותרת טופס הזמנת רכש · אטום NumberStepper מספר · אטום FieldRow ספק · אטום FieldRow פרויקט · אטום NumberStepper כמות · אטום NumberStepper מחיר · אטום FieldRow תאריך אספקה · אטום AnimatedToggle סטטוס · אטום FabMenu שמירה · אטום NeonButton קדם לאושר · כותרת רשומות הזמנת רכש · אטום DataGrid הזמנת רכש · באנר ישות הזמנת רכש: 7 שדות · 4-שלבי workflow · מהמדף
// 🧬 אטומים שנבחרו: BreadcrumbTrail · CaSubTitle · NumberStepper · FieldRow · FieldRow · NumberStepper · NumberStepper · FieldRow · AnimatedToggle · FabMenu · NeonButton · CaSubTitle · DataGrid · CoinBanner
