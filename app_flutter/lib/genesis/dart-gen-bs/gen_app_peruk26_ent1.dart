...
class GenAppPeruk26Ent1Screen extends StatefulWidget {
  const GenAppPeruk26Ent1Screen({this.scopeField, this.scopeId, this.initial, this.editId, super.key});
...
class _GenAppPeruk26Ent1ScreenState extends State<GenAppPeruk26Ent1Screen> {
  ...
  @override
  void initState() { super.initState(); _prefill(); if (widget.editId != null) { final r = appStore.byId('app_peruk26_ent1', widget.editId!); if (r != null) WidgetsBinding.instance.addPostFrameCallback((_) { if (mounted) _edit(r); }); } }
