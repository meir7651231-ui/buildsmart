...
// 🧬 בקשה: הירו 🗂️ חשבונית | ישות מורכבת — טופס + טבלה · אטום BreadcrumbTrail חשבונית: טיוטה / הופקה / נשלחה / שולמה · כותרת טופס חשבונית · אטום NumberStepper מספר · אטום InlineTextRow לקוח · אטום GlowField פרויקט · אטום QtyStepper סכום · אטום InlineTextRow מס · אטום DatePills תאריך · אטום AnimatedToggle סטטוס · אטום FabMenu שמירה · אטום NeonButton קדם להופקה · כותרת חוקים פר-שדה · חישוב מספר סידורי של (excelSerialToIso) · חישוב עיטוף סכום שקלים לתצוגה (shekel) · חישוב תאריך לתצוגה (fmtDate) · כותרת רשומות חשבונית · אטום DataGrid חשבונית · באנר ישות חשבונית: 7 שדות · 4-שלבי workflow · 3 חוקים · מהמדף
// 🧬 אטומים שנבחרו: BreadcrumbTrail · CaSubTitle · NumberStepper · InlineTextRow · GlowField · QtyStepper · InlineTextRow · DatePills · AnimatedToggle · FabMenu · NeonButton · CaSubTitle · RStat · RStat · RStat · CaSubTitle · DataGrid · CoinBanner
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          InlineTextRow(label: gen_app_ent28_textfield_label, hint: gen_app_ent28_textfield_hint, value: _t1, onChanged: (v) => setState(() => _t1 = v)),
          GlowField(hint: gen_app_ent28_glowfield_hint, height: 16, radius: 12, accentColor: BsTokens.brand, baseColor: BsTokens.inkLight, fillColor: BsTokens.cardLight),
          QtyStepper(qty: _n2, onChanged: (v) => setState(() => _n2 = v)),
          InlineTextRow(label: gen_app_ent28_textfield_label2, hint: gen_app_ent28_textfield_hint2, value: _t3, onChanged: (v) => setState(() => _t3 = v)),
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 12), child: Row(children: [RStat(value: excelSerialToIso(null), label: gen_app_ent28_stat_label), RStat(value: shekel(null), label: gen_app_ent28_stat_label2), RStat(value: fmtDate(null), label: gen_app_ent28_stat_label3)])),
          CaSubTitle(gen_app_ent28_header_text3),
