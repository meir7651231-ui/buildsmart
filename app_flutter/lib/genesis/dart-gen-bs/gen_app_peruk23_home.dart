...
class GenAppPeruk23HomeScreenToday {
  ...
  static String _dayLabel(DateTime d, DateTime today) { final p = bhDayLabelParts(_iso(d), _iso(today)); switch (p[0]) { case 'today': return gen_app_peruk23_home_c15; case 'tomorrow': return gen_app_peruk23_home_c16; case 'yesterday': return gen_app_peruk23_home_c17; case 'weekday': return gen_app_peruk23_home_c18.replaceAll('{day}', gen_app_peruk23_home_c19.split(',')[int.parse(p[1])]) + ' ' + p[2]; default: return p[2]; } }   // G34ב · שכבת-ההרכבה מחזירה חלקים; כאן רק מונחים
