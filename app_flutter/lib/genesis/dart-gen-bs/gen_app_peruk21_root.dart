...
class GenAppPeruk21RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk21_root_c38, subtitle: gen_app_peruk21_root_c39, icon: gen_app_peruk21_root_c40, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk21_ent1', id), subtitle: const [gen_app_peruk21_root_c33, gen_app_peruk21_root_c34, gen_app_peruk21_root_c35, gen_app_peruk21_root_c36, gen_app_peruk21_root_c37][appStore.stageOf('app_peruk21_ent1', id).clamp(0, 4)], icon: gen_app_peruk21_root_c41, children: [
      Padding(padding: const EdgeInsets.only(bottom: 12), child: GestureDetector(behavior: HitTestBehavior.opaque, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk21Rp1Screen(initialId: id))), child: ForgeToneButton(items: [[gen_app_peruk21_root_c30]]))),
