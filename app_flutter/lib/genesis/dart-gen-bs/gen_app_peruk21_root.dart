...
class GenAppPeruk21RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk21_root_c50, subtitle: gen_app_peruk21_root_c51, icon: gen_app_peruk21_root_c52, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk21_ent1', id), subtitle: const [gen_app_peruk21_root_c45, gen_app_peruk21_root_c46, gen_app_peruk21_root_c47, gen_app_peruk21_root_c48, gen_app_peruk21_root_c49][appStore.stageOf('app_peruk21_ent1', id).clamp(0, 4)], icon: gen_app_peruk21_root_c53, children: [
