...
import '../dart-data-bs/auto/gen_app_calendar_main_content.dart';
import '../dart-ui-bs/ds/ds_pure.dart';
import '../dart-ui-bs/ds/ds_seam.dart';
import 'gen_app_calendar_shell.dart';
import 'package:flutter/material.dart';

void main() => runApp(const GenAppCalendarMainScreen());

class GenAppCalendarMainScreen extends StatelessWidget {
  const GenAppCalendarMainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_calendar_main_c0,
        ...
        home: const GenAppCalendarShellScreen(),
      );
}
