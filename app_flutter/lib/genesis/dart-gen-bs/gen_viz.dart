...
// 🧬 בקשה: רכיבים חיים - ויזואליזציה מתקדמת: · הירו 🗺️ ויזואליזציה מתקדמת | לוח גאנט ומכ"ם ממשפט · כותרת נתונים ולוח · לוח 150 17 3 8 12 21 26 לוח חודשי · גאנט 22 5 תרשים גאנט · רדאר 170 6 מכ"ם ביצועים · פסקול 90 24 גל אודיו · באנר כל תרשים כאן חי - נבחר ממילה בעברית
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          MiniCalendar(height: 150, radius: 12, accentColor: BsTokens.brand, baseColor: BsTokens.inkLight, fillColor: BsTokens.cardLight, today: 17, marked: const <int>{3, 8, 12, 21, 26}),
