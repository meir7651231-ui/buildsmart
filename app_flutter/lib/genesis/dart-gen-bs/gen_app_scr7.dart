...
class GenAppScr7Screen extends StatefulWidget {
  const GenAppScr7Screen({super.key});

  @override
  State<GenAppScr7Screen> createState() => _GenAppScr7ScreenState();
}

class _GenAppScr7ScreenState extends State<GenAppScr7Screen> {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: Text(gen_app_scr7_app_bar_title)),
        body: ListView(
          ...
          CaSubTitle(gen_app_scr7_header_text),
          Padding(padding: const EdgeInsets.symmetric(horizontal: 12), child: Row(children: [RStat(value: hebMonthHeWired(DateTime.now()), label: gen_app_scr7_stat_label)])),
          CoinBanner(coins: 0, sub: gen_app_scr7_banner_sub),
          ],
        ),
      ),
    );
