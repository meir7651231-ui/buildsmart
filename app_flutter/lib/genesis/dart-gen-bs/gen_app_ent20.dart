...
class _GenAppEnt20ScreenState extends State<GenAppEnt20Screen> {
  ...
  void _save() {
    ...
    appStore.add(gen_app_ent20_c7, <String, String>{gen_app_ent20_c8: _v[0] ?? '', gen_app_ent20_c10: _v[1] ?? '', gen_app_ent20_c11: _v[2] ?? '', gen_app_ent20_c12: _v[3] ?? '', gen_app_ent20_c13: _v[4] ?? '', gen_app_ent20_c15: _v[5] ?? '', gen_app_ent20_c16: _v[6] ?? ''});
    setState(() => _v.clear());
  }
          ...
          AnimatedBuilder(
            ...
            builder: (context, _) {
              ...
              return Column(children: [
                for (final r in rs)
                  DsRecordCard(labels: const [gen_app_ent20_c8, gen_app_ent20_c10, gen_app_ent20_c11, gen_app_ent20_c12, gen_app_ent20_c13, gen_app_ent20_c15, gen_app_ent20_c16], values: [r[gen_app_ent20_c8] ?? '', r[gen_app_ent20_c10] ?? '', r[gen_app_ent20_c11] ?? '', r[gen_app_ent20_c12] ?? '', r[gen_app_ent20_c13] ?? '', r[gen_app_ent20_c15] ?? '', r[gen_app_ent20_c16] ?? '']),
              ]);
            },
          ),
        ]),
