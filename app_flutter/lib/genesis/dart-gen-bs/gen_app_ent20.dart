...
// 🧬 שם: 🗂️ שינוי עבודה
// 🧬 בקשה: הירו 🗂️ שינוי עבודה | ישות מורכבת — טופס + טבלה · אטום BreadcrumbTrail שינוי עבודה: בקשה / תומחר / אושר פנימי / אושר לקוח / בוצע · כותרת טופס שינוי עבודה · אטום NumberStepper מספר · אטום FieldRow פרויקט · אטום FieldRow סיבה · אטום NumberStepper מחיר ללקוח · אטום FieldRow השפעה על זמן · אטום FieldRow מאשר · אטום AnimatedToggle סטטוס · אטום FabMenu שמירה · אטום NeonButton קדם לתומחר · כותרת רשומות שינוי עבודה · אטום DataGrid שינוי עבודה · באנר ישות שינוי עבודה: 7 שדות · 5-שלבי workflow · מהמדף
