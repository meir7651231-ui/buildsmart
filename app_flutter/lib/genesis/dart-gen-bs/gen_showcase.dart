    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          ManagerDashboardCreditBar(label: gen_showcase_other_label5, pct: 61, color: BsTokens.brand),
          ManagerDashboardCreditBar(label: gen_showcase_other_label6, pct: 100, color: BsTokens.brand),
