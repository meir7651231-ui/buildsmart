    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          ManagerDashboardCreditBar(label: gen_showcase_other_label5, pct: 59, color: BsTokens.brand),
          ManagerDashboardCreditBar(label: gen_showcase_other_label6, pct: 97, color: BsTokens.brand),
