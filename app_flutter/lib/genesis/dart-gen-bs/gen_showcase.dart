...
// 🧬 בקשה: ראווה - כרטיס-הביקור החי של המחולל: · הירו 🧬 המחולל של המחצב | מפעל-האטומים החי - כל מספר כאן נמדד מהאטלס ברגע-החילול · כותרת המספרים החיים - מהאטלס ברגע-החילול · אטום KpiBox 381 לבנים ויזואליות | מדף-התצוגה החי · אטום KpiBox 471 אטומי לוגיקה פעילים | מדף-המנועים · אטום KpiBox 1096 אטומי דאטה | אוצר-הידע שחולץ בטיהור · כותרת צינור-הייצור - מהמחצבה אל המסך · אטום PipeLink 0.9 פירוק - זיקוק - הרכבה - חיווט | הזרימה חיה - כל ריצה של המנוע-האחד עוברת כאן · כותרת מנוע-הסינתזה - יכולות שהוזמנו והורכבו לבד · אטום StatsCard 4 0 0 4 הזמנות-יכולת | הוכחו על התאומים החיים - דוגמה-בדוגמה: הוכחו / בבדיקה / נדחו · אטום ManagerDashboardCreditBar 100 הזמנות שהוכחו מתוך שהוזמנו · כותרת מבצע-המאה - צירי-הכיסוי נמדדים חיים בכל משטרה · אטום ManagerDashboardCreditBar 100 לבנים ברות-מילוי במחולל · אטום ManagerDashboardCreditBar 68 מנועים ברי-הרצה ברתמת-התאומים · אטום ManagerDashboardCreditBar 96 מנועים עם מהות-עברית · אטום ManagerDashboardCreditBar 100 אטומי-דאטה עם תאום-Dart · כותרת היכולות בפעולה - הקישו לפתיחה · ניווט capmailphone שחזור מספר טלפון לתצוגה ישראלית תקנית מתוך שורה שהגיעה עטופה בקידוד-מייל ישן | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט captimegematria חתימת-אותיות עברית לשעה על השעון - כמה דקות עברו מחצות הלילה כתוב בגימטריה | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט capclockcalendar מסע-בזמן של השעון - שעת-יממה נהפכת לתאריך-תצוגה כשכל דקה מחצות נספרת כיום שלם בלוח | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט capautodream הזמנה-עצמית - יכולת שחלמתי היום והוכחתי לבד - מיון חוטי תמיכה ואז אבחון תקינות מספר | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט improv יכולת מאולתרת - שרשרת חמישה | נוצר מבקשה בעברית - הקישו לפתיחה · ניווט quest1 עולם משחק שלם - חדר 1 | נוצר מבקשה בעברית - הקישו לפתיחה · באנר 13 שערי-המשטרה ירוקים על כל commit - את הראווה הזו מדדתי והרכבתי לבד מהאטלס החי
// 🧬 אטומים שנבחרו: HeroCard · CaSubTitle · KpiBox · KpiBox · KpiBox · CaSubTitle · PipeLink · CaSubTitle · StatsCard · ManagerDashboardCreditBar · CaSubTitle · ManagerDashboardCreditBar · ManagerDashboardCreditBar · ManagerDashboardCreditBar · ManagerDashboardCreditBar · CaSubTitle · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · HeroCard · CoinBanner
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          ManagerDashboardCreditBar(label: gen_showcase_other_label4, pct: 100, color: BsTokens.brand),
          ManagerDashboardCreditBar(label: gen_showcase_other_label5, pct: 68, color: BsTokens.brand),
          ManagerDashboardCreditBar(label: gen_showcase_other_label6, pct: 96, color: BsTokens.brand),
          ManagerDashboardCreditBar(label: gen_showcase_other_label7, pct: 100, color: BsTokens.brand),
          CaSubTitle(gen_showcase_header_text5),
          ...
          CoinBanner(coins: 13, sub: gen_showcase_banner_sub),
          ],
        ),
      ),
    );
