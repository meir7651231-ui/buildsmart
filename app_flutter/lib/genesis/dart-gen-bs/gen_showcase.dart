    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          ManagerDashboardCreditBar(label: gen_showcase_other_label5, pct: 52, color: BsTokens.brand),
          ...
          CoinBanner(coins: 12, sub: gen_showcase_banner_sub),
          ],
        ),
      ),
    );
