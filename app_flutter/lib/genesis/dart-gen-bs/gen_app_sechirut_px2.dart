...
class GenAppSechirutPx2Screen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => DsScaffold(title: gen_app_sechirut_px2_c10, subtitle: gen_app_sechirut_px2_c11, icon: gen_app_sechirut_px2_c12, header: false, children: [ForgeCenteredPageHeader(fields: ['', gen_app_sechirut_px2_c10, gen_app_sechirut_px2_c11]), ...[
    ...
    Padding(padding: const EdgeInsets.only(bottom: 10), child: AnimatedBuilder(animation: appStore, builder: (context, _) => ForgeStatPlain(fields: [gen_app_sechirut_px2_c5, appStore.records('app_sechirut_ent2').where((r) => (r[gen_app_sechirut_px2_c6] ?? '') == gen_app_sechirut_px2_c7).length.toDouble().toStringAsFixed(0)]))),
  ]]);
}
