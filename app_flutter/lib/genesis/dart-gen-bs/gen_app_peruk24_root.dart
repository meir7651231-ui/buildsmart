...
class GenAppPeruk24RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk24_root_c43, subtitle: gen_app_peruk24_root_c44, icon: gen_app_peruk24_root_c45, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk24_ent1', id), subtitle: const [gen_app_peruk24_root_c38, gen_app_peruk24_root_c39, gen_app_peruk24_root_c40, gen_app_peruk24_root_c41, gen_app_peruk24_root_c42][appStore.stageOf('app_peruk24_ent1', id).clamp(0, 4)], icon: gen_app_peruk24_root_c46, children: [
      Padding(padding: const EdgeInsets.only(bottom: 12), child: GestureDetector(behavior: HitTestBehavior.opaque, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk24Rp1Screen(initialId: id))), child: ForgeToneButton(items: [[gen_app_peruk24_root_c35]]))),
