...
class GenAppPeruk24RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk24_root_c55, subtitle: gen_app_peruk24_root_c56, icon: gen_app_peruk24_root_c57, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk24_ent1', id), subtitle: const [gen_app_peruk24_root_c50, gen_app_peruk24_root_c51, gen_app_peruk24_root_c52, gen_app_peruk24_root_c53, gen_app_peruk24_root_c54][appStore.stageOf('app_peruk24_ent1', id).clamp(0, 4)], icon: gen_app_peruk24_root_c58, children: [
