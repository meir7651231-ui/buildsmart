...
// 🧬 אטומים שנבחרו: SwitchRow · InlineTextRow · SwitchRow · SettingsNumberRow · ActionRow
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: Text(gen_shipping_t8)),
        body: ListView(
          padding: const EdgeInsets.symmetric(vertical: 12),
          children: [
          SwitchRow(label: gen_shipping_t1, value: _v1, onChanged: (v) => setState(() => _v1 = v)),
          InlineTextRow(label: gen_shipping_t2, hint: gen_shipping_t3, value: _t2, onChanged: (v) => setState(() => _t2 = v)),
          SwitchRow(label: gen_shipping_t4, value: _v3, onChanged: (v) => setState(() => _v3 = v)),
          SettingsNumberRow(label: gen_shipping_t5, value: _n4, onChanged: (v) => setState(() => _n4 = v), inkColor: BsTokens.inkLight, mutedColor: BsTokens.mutedLight, cursorColor: BsTokens.brand, fillColor: BsTokens.cardLight),
          ActionRow(label: gen_shipping_t6, onTap: () => _toast(gen_shipping_t7)),
          ],
        ),
      ),
    );
