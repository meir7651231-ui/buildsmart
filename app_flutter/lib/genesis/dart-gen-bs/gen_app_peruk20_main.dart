...
import '../dart-data-bs/auto/gen_app_peruk20_main_content.dart';
import '../dart-ui-bs/ds/ds_pure.dart';
import '../dart-ui-bs/ds/ds_seam.dart';
import 'gen_app_peruk20_shell.dart';
import 'package:flutter/material.dart';

void main() => runApp(const GenAppPeruk20MainScreen());

class GenAppPeruk20MainScreen extends StatelessWidget {
  const GenAppPeruk20MainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_peruk20_main_c0,
        ...
        home: const GenAppPeruk20ShellScreen(),
      );
}
