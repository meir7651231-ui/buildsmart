...
String reportTextGenAppPeruk05Rp1Screen(Map<String, String> r0, String id0) {
  final b = <String>[
    ...
    [for (final r in [r0]) gen_app_peruk05_rp1_c77 + (r[gen_app_peruk05_rp1_c78] ?? '') + gen_app_peruk05_rp1_c79 + appStore.referencing('app_peruk05_ent2', gen_app_peruk05_rp1_c80, (r[AppStore.idKey] ?? '')).map((c) => c[gen_app_peruk05_rp1_c81] ?? '').where((x) => x.trim().isNotEmpty).join(', ') + gen_app_peruk05_rp1_c82].join('\n'),
    gen_app_peruk05_rp1_c86,
    [for (final r in [r0].where((r) => (r[gen_app_peruk05_rp1_c97] ?? '').toString().trim().isNotEmpty)) gen_app_peruk05_rp1_c95 + ': ' + (r[gen_app_peruk05_rp1_c96] ?? '')].join('\n'),
    gen_app_peruk05_rp1_c101,
    gen_app_peruk05_rp1_c107,
  ];
...
class _GenAppPeruk05Rp1ScreenState extends State<GenAppPeruk05Rp1Screen> {
  ...
  Future<void> _send(BuildContext context, Map<String, String> r0, String id0) async {
    ...
    final dynamic url = waLink((r0[gen_app_peruk05_rp1_c113] ?? ''), text, waDigits);
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, __) {
    ...
    if (rs.isEmpty) return DsScaffold(title: gen_app_peruk05_rp1_c114, subtitle: gen_app_peruk05_rp1_c115, icon: gen_app_peruk05_rp1_c117, children: [EmptyState(label: gen_app_peruk05_rp1_c3)]);
    ...
    return DsScaffold(title: gen_app_peruk05_rp1_c114, subtitle: gen_app_peruk05_rp1_c115, icon: gen_app_peruk05_rp1_c118, children: [
