...
//   תפר-עובדות (G9b): TzCoordinatorFacts · count=families.length (static-const) · מדדים 0 · hero=count · שורות-מדד (G10a) ∅ · תפר-כניסה initialPanelId · תפר-סינון-מדד ∅ · תפר-הזרקה ∅
...
// ═══════════════════════════════════════════════════════════════════════════════════════
// 🧮 _TzCoordinatorData — לוגיקה-טהורה + חוזה-דאטה (אפס-DOM). מקורות-אמת (§20-ג · אפס-זיוף):
...
class _TzCoordinatorData {
  ...
  static const families = <Map<String, dynamic>>[
    {
      'id': 'f1', 'name': 'משפחת כהן', 'notes': 'דוד כהן', 'phone': '050-1111111', 'email': 'cohen@family', 'idNum': '012345678',
      'scoreLog': [{'first': 'נועה', 'grade': 'י\'-3'}, {'first': 'איתי', 'grade': 'ח\'-1'}],
      'charges': [
      ...
      'payments': [
        {'famId': 'p1', 'date': '2026-08-05', 'amount': 700, 'method': 'הו״ק'},
        {'famId': 'p2', 'date': '2026-09-03', 'amount': 700, 'method': 'הו״ק'},
      ],
      'hok': {'amount': 700, 'cur': '₪', 'day': 5, 'method': 'bank', 'active': true, 'startDate': '2025-09-05'},
      'criteria': ['sib2'],
      'calls': <Map<String, dynamic>>[],
      'carryBalance': 0,
    },
    {
      'id': 'f2', 'name': 'משפחת לוי', 'notes': 'רחל לוי', 'phone': '052-2222222', 'email': 'levi@family', 'idNum': '023456789',
      'scoreLog': [{'first': 'יונתן', 'grade': 'ט\'-2'}],
      'charges': [
      ...
      'payments': [
        {'famId': 'p3', 'date': '2026-05-20', 'amount': 1000, 'method': 'אשראי'},
      ],
      'hok': {'amount': 350, 'cur': '₪', 'day': 10, 'method': 'card', 'active': true, 'startDate': '2026-01-10', 'kevaId': 'kv-77'},
      'hist': [
    ...
    {
      'id': 'f3', 'name': 'משפחת מזרחי', 'notes': 'יוסי מזרחי', 'phone': '054-3333333', 'email': 'mizrahi@family', 'idNum': '034567890',
      'scoreLog': [{'first': 'שירה', 'grade': 'יא\'-1'}, {'first': 'עומר', 'grade': 'ט\'-1'}, {'first': 'טל', 'grade': 'ז\'-2'}],
      'charges': [
      ...
      'payments': [
        {'famId': 'p4', 'date': '2026-08-22', 'amount': 3000, 'method': 'העברה'},
      ],
      'criteria': ['sib3'],
      'calls': <Map<String, dynamic>>[],
      'carryBalance': 0,
    ...
    {
      'id': 'f4', 'name': 'משפחת אברהם', 'notes': 'מרים אברהם', 'phone': '053-4444444', 'email': 'avraham@family', 'idNum': '045678901',
      'scoreLog': [{'first': 'אליה', 'grade': 'י\'-1'}],
      'charges': [
    ...
    {
      'id': 'f5', 'name': 'משפחת פרץ', 'notes': 'אבי פרץ', 'phone': '058-5555555', 'email': 'peretz@family', 'idNum': '056789012',
      'scoreLog': [{'first': 'ליאור', 'grade': 'ח\'-2'}],
      'charges': [
    ...
    {
      'id': 'f6', 'name': 'משפחת שמעוני', 'notes': 'גלית שמעוני', 'phone': '050-6666666', 'email': 'shimoni@family', 'idNum': '067890123',
      'scoreLog': [{'first': 'רון', 'grade': 'י\'-1'}],
      'charges': [
      ...
      'payments': [
        {'famId': 'p5', 'date': '2026-08-21', 'amount': 4200, 'method': 'אשראי'},
        {'famId': 'p6', 'date': '2026-09-02', 'amount': 350, 'method': 'אשראי'},
      ],
      'criteria': <String>[],
      'calls': <Map<String, dynamic>>[],
      'carryBalance': 0,
    ...
    {
      'id': 'f7', 'name': 'משפחת ביטון', 'notes': 'שלומי ביטון', 'phone': '052-7777777', 'email': 'biton@family', 'idNum': '078901234',
      'scoreLog': [{'first': 'מאיה', 'grade': 'י\'-2'}, {'first': 'עידו', 'grade': 'ז\'-1'}],
      'charges': [
      ...
      'payments': [
        {'famId': 'p7', 'date': '2026-08-25', 'amount': 5000, 'method': 'העברה'},
      ],
      'hok': {'amount': 600, 'cur': '₪', 'day': 15, 'method': 'bank', 'active': true, 'startDate': '2026-09-01'},
      'criteria': ['sib2', 'socio'],
      'calls': <Map<String, dynamic>>[],
      'carryBalance': 0,
    },
    {
      'id': 'f8', 'name': 'משפחת נחום', 'notes': 'הדס נחום', 'phone': '054-8888888', 'email': 'nahum@family', 'idNum': '089012345',
      'scoreLog': [{'first': 'הדר', 'grade': 'ח\'-2'}],
  ...
  static int studentsN(Map<String, dynamic> f) => (f['scoreLog'] as List).length;
  static String gradesOf(Map<String, dynamic> f) => (f['scoreLog'] as List).map((m) => (m as Map)['grade']).join(' · ');
  static String studentsOf(Map<String, dynamic> f) => (f['scoreLog'] as List).map((m) => (m as Map)['first']).join(', ');
  ...
  static void addPayment(Map<String, dynamic> f, String role, {required int amount, required String method, required String date, String note = ''}) {
    if (amount <= 0) return;
    (extraPayments[f['id']] ??= []).add({'famId': _nid('p'), 'date': date, 'amount': amount, 'method': method, if (note.isNotEmpty) 'note': note});
  ...
  static void refund(Map<String, dynamic> f, String role) { // 💸 החזר-זכות: תשלום-שלילי (הפחתת-שולם) בגובה-הזכות
    final c = credit(f);
    if (c <= 0) return;
    (extraPayments[f['id']] ??= []).add({'famId': _nid('r'), 'date': today, 'amount': -c, 'method': 'החזר', 'note': 'החזר-זכות'});
  ...
  static String? payLinkOf(Map<String, dynamic> f) => payLink(payUrl, balance(f), f['notes'] as String, _safeHttps);
  ...
  static List<String> _termsOf(Map<String, dynamic> f) =>
      ['${f['name']}', '${f['notes']}', '${f['phone']}', ...(f['scoreLog'] as List).map((m) => '${(m as Map)['first']}'), gradesOf(f)];
  ...
  static String axisValue(Map<dynamic, dynamic> db, dynamic x, dynamic axis) {
    ...
    switch ('$axis') {
      ...
      case 'grade': return (f['scoreLog'] as List).any((m) => '${(m as Map)['grade']}'.startsWith('${db['grade']}')) ? '1' : '0';
  ...
  static List<String> grades(List<Map<String, dynamic>> fs) =>
      {for (final f in fs) for (final m in f['scoreLog'] as List) '${(m as Map)['grade']}'.split('-').first}.toList()..sort();
  ...
  static List<List<Object?>> csvRows(List<Map<String, dynamic>> fs) => [
        csvHeader,
        for (final f in fs)
          [f['name'], studentsN(f), gradesOf(f), charged(f), paid(f), balance(f), agingDays(f), lastPaymentDate(f), lastMethod(f), hokFlag(f) ? (hokActive(f) ? 'פעילה' : 'נכשלה') : '', discountLabel(f), remindersSent(f).length, riskLabel(risk(f)), statusOf(f), f['notes'], f['phone']],
      ];
  ...
  static final List<Map<String, Object?>> columnDefs = <Map<String, Object?>>[
    // ═══ חוזה-העמודות של TzCoordinator (G5h · חוק-7): 1 שדות-סכמה בלי מקור בזרע — עמודות-מקום-שמור, לא מזויפות ולא מושמטות ═══
    {'key': 'score', 'label': 'score'}, // G5h · מקום-שמור: שדה-TzCoordinator מהסכמה (number) — מאיר כשהנתון מוזרם
    ...
    {'label': 'הורה-משלם', 'get': (Map<String, dynamic> f) => '${f['notes']} · ${f['phone']}'},
...
class TzCoordinatorScreen extends StatefulWidget {
  ...
  @override
  State<TzCoordinatorScreen> createState() => _TzCoordinatorScreenState();
}
...
class _TzCoordinatorScreenState extends State<TzCoordinatorScreen> {
  ...
  String get _roleName => _TzCoordinatorData.roleName(_role);
  bool get _amounts => _TzCoordinatorData.amounts(_role);
  ...
  Widget build(BuildContext context) {
    final all = _TzCoordinatorData.visibleFor(_role);
    // דירוג: סיכון-יורד ⇒ ותק-יורד ⇒ יתרה-יורדת (המפרט: חוב · ותק-חוב · סיכון)
    final ranked = [...all]..sort((a, b) {
        final r = _TzCoordinatorData.risk(b).compareTo(_TzCoordinatorData.risk(a));
        if (r != 0) return r;
        final ag = _TzCoordinatorData.agingDays(b).compareTo(_TzCoordinatorData.agingDays(a));
        return ag != 0 ? ag : _TzCoordinatorData.balance(b).compareTo(_TzCoordinatorData.balance(a));
      });
    final visible = _TzCoordinatorData.filter(_TzCoordinatorData.search(ranked, _q), _locks,
        {'grade': _grade, 'type': _type, 'course': _course, 'method': _method, 'year': _year});
    // KPI-10 על כל-המשפחות-הנראות-לתפקיד (הורה ⇒ משפחתו בלבד)
    final kCharged = _TzCoordinatorData.kCharged(all), kPaid = _TzCoordinatorData.kPaid(all), kOpen = _TzCoordinatorData.kOpen(all), kPct = _TzCoordinatorData.kPct(all);
    final inDebt = _TzCoordinatorData.kInDebt(all), oldN = all.where(_TzCoordinatorData.oldDebt).length, kOld = _TzCoordinatorData.kOld(all);
    final kExp = _TzCoordinatorData.kExpected(all), kHok = _TzCoordinatorData.kHokActive(all), kSch = _TzCoordinatorData.kScholar(all), kRem = _TzCoordinatorData.kReminders(all);
    final failed = all.where(_TzCoordinatorData.hokFailed).toList();
    final late = all.where(_TzCoordinatorData.arrangementLate).toList();
    final dups = [for (final f in all) if (_TzCoordinatorData.duplicateCharges(f).isNotEmpty) f];
    final hokDue = _TzCoordinatorData.hokDueList(all);
    final follow = _TzCoordinatorData.followUps(all);
    final tripDebt = all.where((f) => _TzCoordinatorData.balance(f) > 0 && _TzCoordinatorData.liveCharges(f).any((c) => c['cat'] == 'טיול')).toList();
    final buckets = <int, List<Map<String, dynamic>>>{2: [], 1: [], 0: [], -1: []};
    for (final f in visible) {
      // דגל-בלבד (מחנך): שני דליים — דגל/תקין; אין דירוג-סיכון גלוי
      buckets[_TzCoordinatorData.balance(f) <= 0 ? -1 : _amounts ? _TzCoordinatorData.risk(f) : 0]!.add(f);
    }
    final secTitle = {2: '🔴 סיכון-גבוה / חוב-ותיק', 1: '🟠 בפיגור / בינוני', 0: _amounts ? '🟢 חוב-טרי' : '🚩 דגל-חוב', -1: '✅ ללא-חוב'};
    const secTone = {2: 2, 1: 3, 0: 0, -1: 1};
    final trend = _TzCoordinatorData.collectionTrend(all);
    final thisMonth = _TzCoordinatorData.collectedInMonth(all, monthKey(_TzCoordinatorData.today));

    return DsScaffold(
      title: 'גבייה ותשלומים', subtitle: '${all.length} משפחות · ${_TzCoordinatorData.year} · $_roleName', icon: '💰',
      children: [
        // בורר-תפקיד (חוק-6 · זהות-מוזרקת) — מדגים גידור-הרשאות (roleOf⊕canGrantedAction)
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: SegmentedSwitch(items: [for (final r in _TzCoordinatorData.roleDefs) r['label'] as String], selected: _role, onSelect: (i) => setState(() { _role = i; _hokArmed = false; })),
        ),
        _gap(10),
        if (!_amounts) ...[
        ...
        Wrap(spacing: 8, runSpacing: 6, children: [
          ...
          if (_amounts) ...[
          _fchip(2, '⏰ ותק>${_TzCoordinatorData.oldDebtDays} · $oldN'),
          _fchip(3, '💳 הו״ק · ${all.where(_TzCoordinatorData.hokFlag).length}'),
          _fchip(4, '🎓 מלגה/הנחה · ${all.where((f) => _TzCoordinatorData.discountPct(f) > 0).length}'),
          _fchip(5, '🔕 ללא-תזכורת · ${all.where((f) => _TzCoordinatorData.balance(f) > 0 && _TzCoordinatorData.remindersSent(f).isEmpty).length}'),
          _fchip(6, '🔔 תזכורת>2 · ${all.where((f) => _TzCoordinatorData.remindersSent(f).length > 2).length}'),
          _fchip(7, '📆 הסדר · ${all.where(_TzCoordinatorData.hasArrangement).length}'),
          _fchip(8, '⚠️ בסיכון · ${all.where((f) => _TzCoordinatorData.risk(f) >= 1).length}'),
          FilterChipPill(
        ...
        if (_filtersOpen) ...[
          ...
          Wrap(spacing: 10, runSpacing: 6, children: [
            _enum('כיתה', ['', ..._TzCoordinatorData.grades(all)], _grade, (v) => setState(() => _grade = v)),
            _enum('חוג', ['', ..._TzCoordinatorData.courses(all)], _course, (v) => setState(() => _course = v)),
            _enum('סוג-חיוב', ['', ..._TzCoordinatorData.chargeTypes, _TzCoordinatorData.arrangementType], _type, (v) => setState(() => _type = v)),
            _enum('אמצעי', ['', ..._TzCoordinatorData.payMethodsSchool], _method, (v) => setState(() => _method = v)),
            _enum('שנה', ['', ..._TzCoordinatorData.years(all)], _year, (v) => setState(() => _year = v)),
        ...
        GradientCard(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              BareStat(value: _m(kOld), label: '⏰ חוב-ותיק >${_TzCoordinatorData.oldDebtDays}י׳ · $oldN', inkColor: kOld > 0 ? _danger : _ok, mutedColor: _muted),
        ...
        if (dups.isNotEmpty && _amounts) ...[
          AlertBanner(glyph: '👯', tone: 3, message: 'חיוב-כפול-חשוד (אותו סוג·סכום·תאריך·תלמיד): ${dups.map((f) => '${f['name']} (${_TzCoordinatorData.duplicateCharges(f).map((c) => c['cat']).join(',')})').join(' · ')}'),
          _gap(8),
        ],
        ...
        if (follow.isNotEmpty && _TzCoordinatorData.can(_role, 'fees.remind')) ...[
          AlertBanner(glyph: '📞', tone: 0, message: 'מעקב שעבר-מועד: ${follow.map((t) => t['title']).join(' · ')}'),
          _gap(8),
        ],
        if (hokDue.isNotEmpty && _TzCoordinatorData.can(_role, 'fees.hok')) ...[
          AlertBanner(glyph: '💳', tone: 0, message: '${hokDue.length} הו״ק לרישום החודש (${_m(_TzCoordinatorData.hokExpected(all))}) — ראה מבט הו״ק'),
          _gap(8),
        ],
  ...
  Widget _table(List<Map<String, dynamic>> rows) {
    final cols = [for (final c in _TzCoordinatorData.columnDefs) if (_TzCoordinatorData.colShown(c, rows)) c];
  ...
  Widget _row(Map<String, dynamic> f) {
    final charged = _TzCoordinatorData.charged(f), paid = _TzCoordinatorData.paid(f), bal = _TzCoordinatorData.balance(f);
    final band = _TzCoordinatorData.agingBand(f);
    final act = _TzCoordinatorData.rightAction(f);
    ...
    return Padding(
      ...
      child: GradientCard(
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          Row(children: [
            Expanded(child: MediaRow(glyph: '👨‍👩‍👧', title: f['name'] as String, subtitle: '${_TzCoordinatorData.studentsOf(f)} · ${_TzCoordinatorData.gradesOf(f)}')),
          ...
          if (_amounts) ...[
            ...
            Row(children: [
              ...
              BareStat(value: shekel(bal), label: bal > 0 ? '= יתרה · ${_TzCoordinatorData.agingDays(f)} י׳' : '= יתרה', inkColor: balColor, mutedColor: _muted),
            ]),
          ] else
            Row(children: [
  ...
  List<Widget> _facts(Map<String, dynamic> f) {
    final r = _TzCoordinatorData.risk(f);
    return [
      StatusChip(label: _TzCoordinatorData.statusOf(f), tone: _TzCoordinatorData.statusOf(f) == 'תקין' || _TzCoordinatorData.statusOf(f) == 'מלגה-מלאה' ? 1 : _TzCoordinatorData.statusOf(f).contains('פיגור') ? 2 : 3),
      if (_TzCoordinatorData.hasHok(f)) StatusChip(label: _TzCoordinatorData.hokFlag(f) ? (_TzCoordinatorData.hokActive(f) ? '💳 הו״ק ${_amounts ? shekel((f['hok'] as Map)['amount'] as num) : ''} · יום ${(f['hok'] as Map)['day']}' : '⚠️ הו״ק נכשלה') : '⏸ הו״ק מופסקת', tone: _TzCoordinatorData.hokFailed(f) ? 2 : _TzCoordinatorData.hokFlag(f) ? 1 : 0),
      if (_TzCoordinatorData.discountLabel(f).isNotEmpty) StatusChip(label: '🎓 ${_TzCoordinatorData.discountLabel(f)}', tone: 0),
      if (_TzCoordinatorData.remindersSent(f).isNotEmpty) StatusChip(label: '🔔 ${_TzCoordinatorData.remindersSent(f).length} תזכורות', tone: _TzCoordinatorData.remindersSent(f).length > 2 ? 3 : 0),
      if (_TzCoordinatorData.balance(f) > 0) StatusChip(label: 'סיכון ${_TzCoordinatorData.riskLabel(r)} · ${_TzCoordinatorData.tierLabel(f)}', tone: r == 2 ? 2 : r == 1 ? 3 : 1),
      if (_TzCoordinatorData.lastMethod(f).isNotEmpty) StatusChip(label: '${_TzCoordinatorData.lastMethod(f)} · ${fmtDate(_TzCoordinatorData.lastPaymentDate(f))}', tone: 0),
  ...
  Widget _hokView(List<Map<String, dynamic>> all, List<Map<String, dynamic>> due) {
    final withHok = all.where(_TzCoordinatorData.hasHok).toList();
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      DsSection(title: '💳 הו״ק לרישום החודש · ${due.length} · ${_m(_TzCoordinatorData.hokExpected(all))}', tone: 0, children: [
        if (due.isEmpty)
          const EmptyState(glyph: '✅', message: 'כל ההו״ק הפעילות נרשמו החודש')
        else ...[
          for (final f in due)
            TimelineItem(title: '${f['name']} · יום ${(f['hok'] as Map)['day']}', time: _TzCoordinatorData.hokMethod(f), body: '${_m((f['hok'] as Map)['amount'] as num)} — טרם נרשם החודש'),
          if (_TzCoordinatorData.can(_role, 'fees.hok')) ...[
            _gap(8),
            ...
            if (!_hokArmed)
              ...
              AlertBanner(glyph: '⚠️', tone: 3, message: 'שלב 2/2: יירשמו ${due.length} תשלומי-הו״ק בסך ${_m(_TzCoordinatorData.hokExpected(all))} (${due.map((f) => f['name']).join(' · ')}). לאשר?'),
              _wrap([
                SoftButton(label: '✅ אשר ורשום ${due.length}', tone: 2, onTap: () => setState(() { _TzCoordinatorData.runHokBatch(all, _roleName); _hokArmed = false; })),
      ...
      DsSection(title: '📇 כל הוראות-הקבע · ${withHok.length}', children: [
        for (final f in withHok)
          Padding(
            ...
            child: Row(children: [
              StatusDot(tone: _TzCoordinatorData.hokFailed(f) ? 2 : _TzCoordinatorData.hokFlag(f) ? 1 : 3),
              const SizedBox(width: 10),
              Expanded(child: MediaRow(glyph: '💳', title: f['name'] as String, subtitle: '${_m((f['hok'] as Map)['amount'] as num)} · יום ${(f['hok'] as Map)['day']} · ${_TzCoordinatorData.hokMethod(f)} · מ-${fmtDate((f['hok'] as Map)['startDate'] as String?)}')),
              StatusChip(label: _TzCoordinatorData.hokFailed(f) ? 'נכשלה' : _TzCoordinatorData.hokFlag(f) ? (_TzCoordinatorData.hokRecorded(f) ? 'נרשמה החודש' : 'ממתינה') : 'מופסקת', tone: _TzCoordinatorData.hokFailed(f) ? 2 : _TzCoordinatorData.hokFlag(f) ? 1 : 0),
              if (_TzCoordinatorData.can(_role, 'fees.hok')) ...[
                const SizedBox(width: 8),
                SoftButton(label: _TzCoordinatorData.hokFlag(f) ? '⏸ הפסק' : '▶ הפעל', tone: _TzCoordinatorData.hokFlag(f) ? 2 : 1, onTap: () => setState(() => _TzCoordinatorData.toggleHok(f, _roleName))),
              ],
            ]),
          ),
  ...
  Widget _remindersView(List<Map<String, dynamic>> fs) {
    final due = fs.where((f) => _TzCoordinatorData.nextReminder(f) != null).toList();
    final sentAll = [for (final f in fs) for (final c in _TzCoordinatorData.remindersSent(f)) {'f': f, 'c': c}]..sort((a, b) => '${(b['c'] as Map)['at']}'.compareTo('${(a['c'] as Map)['at']}'));
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
  ...
  Widget _reminderCard(Map<String, dynamic> f) {
    final nr = _TzCoordinatorData.nextReminder(f)!;
    final grade = nr['grade'] as String;
    final plan = _TzCoordinatorData.reminderPlan(f);
    return Padding(
      padding: const EdgeInsets.only(bottom: 10),
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        MediaRow(glyph: '🔔', title: '${f['name']} · דרגה: $grade', subtitle: 'יתרה ${_m(_TzCoordinatorData.balance(f))} · ותק ${_TzCoordinatorData.agingDays(f)} י׳ · נשלחו ${_TzCoordinatorData.remindersSent(f).length}'),
        ...
        if (_amounts) ...[
          ...
          Container(
            ...
            child: SelectableText(_TzCoordinatorData.reminderText(f, grade), style: const TextStyle(color: _ink, fontSize: 12.5, height: 1.5)),
          ),
        ],
        if (_TzCoordinatorData.can(_role, 'fees.remind'))
          _wrap([SoftButton(label: '📨 שלח תזכורת $grade (פרטי)', tone: 3, onTap: () => setState(() => _TzCoordinatorData.sendReminder(f, _roleName, grade)))], top: 8),
      ]),
    );
  }
  ...
  Widget _reportsView(List<Map<String, dynamic>> all, Map<String, dynamic> trend, int thisMonth) {
    final counts = _TzCoordinatorData.statusCounts(all);
    final t = DateTime.parse('${_TzCoordinatorData.today}T12:00:00');
    final wa = DateTime(t.year, t.month, t.day - 7); // חשבון-תאריך אמיתי (חוצה-חודש) — לא clamp בתוך החודש
    final weekAgo = '${_TzCoordinatorData.ymOf(wa)}-${wa.day.toString().padLeft(2, '0')}';
    final weekPaid = grandTotal([for (final f in all) for (final p in _TzCoordinatorData.paymentsOf(f)) if (dateInRange(p['date'] as String, weekAgo, _TzCoordinatorData.today)) p['amount']], (x) => x as num).toInt();
    final weekRem = grandTotal([for (final f in all) for (final c in _TzCoordinatorData.remindersSent(f)) if (dateInRange(c['at'] as String, weekAgo, _TzCoordinatorData.today)) 1], (x) => x as num).toInt();
    final byType = <String, int>{};
    for (final f in all) {
      _TzCoordinatorData.byType(f).forEach((k, v) => byType[k] = (byType[k] ?? 0) + v);
    }
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      Row(children: [
      ...
      _gap(10),
      DsSection(title: '🗓 דוח-גזבר שבועי · מ-${fmtDate(weekAgo)} עד ${fmtDate(_TzCoordinatorData.today)}', children: [
        Row(children: [
          ...
          BareStat(value: '${all.where(_TzCoordinatorData.hokFailed).length}', label: 'הו״ק נכשלו', inkColor: all.any(_TzCoordinatorData.hokFailed) ? _danger : _ok, mutedColor: _muted),
          BareStat(value: '${all.where(_TzCoordinatorData.oldDebt).length}', label: 'חוב-ותיק', inkColor: all.any(_TzCoordinatorData.oldDebt) ? _danger : _ok, mutedColor: _muted),
        ]),
      ]),
      DsSection(title: '🏁 סוף-שנה · סגירת-חשבונות', children: [
        Row(children: [
          BareStat(value: '${all.where((f) => _TzCoordinatorData.balance(f) <= 0).length}/${all.length}', label: 'משפחות סגורות', inkColor: _ink, mutedColor: _muted),
          BareStat(value: _m(_TzCoordinatorData.kOpen(all)), label: 'יתרה להעברה (carryBalance)', inkColor: _TzCoordinatorData.kOpen(all) > 0 ? _warning : _ok, mutedColor: _muted),
          BareStat(value: _m(grandTotal(all, (f) => _TzCoordinatorData.credit(f as Map<String, dynamic>))), label: 'זכויות להחזר', inkColor: _acc, mutedColor: _muted),
        ]),
      ...
      DsSection(title: '🔗 התאמת-תשלומים-נכנסים לחיוב (שער-חיצוני · מקום-שמור)', children: [
        for (final inc in _TzCoordinatorData.incoming)
          () {
            final m = _TzCoordinatorData.matchIncoming(inc, all);
  ...
  Widget _auditView() => DsSection(title: '🧾 יומן-אודיט · ${_TzCoordinatorData.audit.length}', children: [
        if (_TzCoordinatorData.audit.isEmpty)
          const EmptyState(glyph: '🧾', message: 'אין פעולות עדיין — כל חיוב/תשלום/ביטול/הנחה/תזכורת יירשם כאן')
        else
          for (final a in _TzCoordinatorData.audit)
            TimelineItem(title: '${a['role']} · ${a['family'] == '*' ? 'כלל-המערכת' : _TzCoordinatorData.families.firstWhere((f) => f['id'] == a['family'], orElse: () => const {'name': '?'})['name']}', time: fmtDate(a['date'] as String?), body: a['what'] as String),
      ]);
  ...
  void _openPanel(Map<String, dynamic> f) {
        ...
        builder: (ctx) => Padding(
          ...
          child: GlassCard(
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
              MediaRow(glyph: '👨‍👩‍👧', title: f['name'] as String, subtitle: '${_TzCoordinatorData.studentsOf(f)} · ${_TzCoordinatorData.gradesOf(f)}'),
              _gap(10),
              AlertBanner(glyph: _TzCoordinatorData.balance(f) > 0 ? '🚩' : '✅', tone: _TzCoordinatorData.balance(f) > 0 ? 3 : 1, message: _TzCoordinatorData.balance(f) > 0 ? 'דגל-חוב — פרטים וסכומים בגזברות בלבד. לא לפנות לתלמיד/ה (מגן-כבוד).' : 'תקין — אין דגל-חוב'),
            ]),
          ),
        ),
      );
    ...
    showModalBottomSheet<void>(
      ...
      builder: (ctx) => StatefulBuilder(builder: (ctx, setSheet) {
        ...
        final charged = _TzCoordinatorData.charged(f), paid = _TzCoordinatorData.paid(f), bal = _TzCoordinatorData.balance(f), band = _TzCoordinatorData.agingBand(f);
        final balColor = band == 3 ? _danger : band == 2 ? _warning : band == 1 ? _acc : _ok;
        final actn = _TzCoordinatorData.rightAction(f);
          ...
          builder: (ctx, scroll) => Padding(
            ...
            child: GlassCard(
              child: ListView(controller: scroll, padding: const EdgeInsets.all(6), children: [
                MediaRow(glyph: '👨‍👩‍👧', title: f['name'] as String, subtitle: '${f['notes']} · ${f['phone']} · ${_TzCoordinatorData.studentsOf(f)} (${_TzCoordinatorData.gradesOf(f)})'),
                _gap(10),
                Row(children: [
                  BareStat(value: _m(bal), label: bal > 0 ? 'יתרה · ותק ${_TzCoordinatorData.agingDays(f)} י׳' : 'יתרה', inkColor: balColor, mutedColor: _muted),
                  ...
                  if (_TzCoordinatorData.credit(f) > 0) BareStat(value: _m(_TzCoordinatorData.credit(f)), label: 'זכות', inkColor: _acc, mutedColor: _muted),
                ]),
                _gap(8),
                ...
                Builder(builder: (_) {
                  final acts = <Widget>[
                    if (_TzCoordinatorData.can(_role, 'fees.charge')) SoftButton(label: '➕ חיוב', tone: 0, onTap: () => _openChargeForm(f, [f], onDone: () => setSheet(() {}))),
                    if (_TzCoordinatorData.can(_role, 'fees.pay')) SoftButton(label: '💳 רשום תשלום', tone: 1, onTap: () => _openPaymentForm(f, [f], onDone: () => setSheet(() {}))),
                    if (_TzCoordinatorData.can(_role, 'fees.pay') && bal > 0) SoftButton(label: '➗ תשלום-חלקי (½)', tone: 1, onTap: () => act(() => _TzCoordinatorData.addPayment(f, _roleName, amount: (bal / 2).ceil(), method: 'מזומן', date: _TzCoordinatorData.today, note: 'תשלום-חלקי'))),
                    if (_TzCoordinatorData.can(_role, 'fees.remind') && _TzCoordinatorData.nextReminder(f) != null) SoftButton(label: '📨 תזכורת ${_TzCoordinatorData.nextReminder(f)!['grade']}', tone: 3, onTap: () => act(() => _TzCoordinatorData.sendReminder(f, _roleName, _TzCoordinatorData.nextReminder(f)!['grade'] as String))),
                    if (_TzCoordinatorData.can(_role, 'fees.arrangement') && bal > 0 && !_TzCoordinatorData.hasArrangement(f)) SoftButton(label: '📆 הסדר 3 תשלומים', tone: 0, onTap: () => act(() => _TzCoordinatorData.setArrangement(f, _roleName, 3))),
                    if (_TzCoordinatorData.can(_role, 'fees.hok') && _TzCoordinatorData.hasHok(f)) SoftButton(label: _TzCoordinatorData.hokFlag(f) ? '⏸ הפסק הו״ק' : '▶ הפעל הו״ק', tone: _TzCoordinatorData.hokFlag(f) ? 2 : 1, onTap: () => act(() => _TzCoordinatorData.toggleHok(f, _roleName))),
                    if (_TzCoordinatorData.can(_role, 'fees.writeoff') && bal > 0 && _TzCoordinatorData.oldDebt(f)) SoftButton(label: '🗂 סמן חוב-אבוד', tone: 2, onTap: () => act(() => _TzCoordinatorData.writeOff(f, _roleName))),
                    if (_TzCoordinatorData.can(_role, 'fees.refund') && _TzCoordinatorData.credit(f) > 0) SoftButton(label: '💸 החזר-זכות ${_m(_TzCoordinatorData.credit(f))}', tone: 1, onTap: () => act(() => _TzCoordinatorData.refund(f, _roleName))),
                    if ((_TzCoordinatorData.can(_role, 'fees.pay') || _TzCoordinatorData.can(_role, 'fees.self')) && bal > 0)
                      // שער-חיצוני (מקום-שמור): payLink מחזיר null כש-payUrl ריק ⇒ הכפתור שמור, לא מזייף קישור
                      SoftButton(label: _TzCoordinatorData.payLinkOf(f) == null ? '🔗 קישור-תשלום (שער לא-מוגדר)' : '🔗 שלח קישור-תשלום', tone: 0, onTap: _TzCoordinatorData.payLinkOf(f) == null ? null : () {}),
  ...
  List<Widget> _tabOverview(Map<String, dynamic> f, int charged, int paid, int bal) => [
        if (_amounts) ...[
          NeonBars(labels: const ['חיובים', 'שולם', 'יתרה'], values: [charged.toDouble(), paid.toDouble(), bal.toDouble()], tone: bal > 0 ? (_TzCoordinatorData.agingBand(f) == 3 ? 2 : 3) : 1),
          _gap(8),
          StatRow(label: 'שולם מתוך חיובים', value: '${shekel(paid)} / ${shekel(charged)}', fraction: charged == 0 ? 0 : paid / charged),
          _gap(8),
          if (_TzCoordinatorData.byType(f).isNotEmpty) DsBars(title: 'פירוק-חיובים לפי-סוג', labels: _TzCoordinatorData.byType(f).keys.toList(), values: [for (final v in _TzCoordinatorData.byType(f).values) v.toDouble()]),
        ],
        _wrap([for (final m in f['scoreLog'] as List) StatusChip(label: '🎓 ${(m as Map)['first']} · ${m['grade']}', tone: 0)]),
        _wrap(_facts(f)),
        _gap(8),
        Row(children: [
          BareStat(value: '${_TzCoordinatorData.rfm(f)}', label: 'דפוס-תשלום (RFM) · ${_TzCoordinatorData.tierLabel(f)}', inkColor: _TzCoordinatorData.tierKey(f) == 'red' ? _danger : _ink, mutedColor: _muted),
          BareStat(value: '${_TzCoordinatorData.trend(f)['dir'] == 'up' ? '↑' : _TzCoordinatorData.trend(f)['dir'] == 'down' ? '↓' : '→'} ${_TzCoordinatorData.trend(f)['pct']}%', label: 'מגמת-תשלומים (6 חודשים)', inkColor: _TzCoordinatorData.trend(f)['dir'] == 'down' ? _danger : _ok, mutedColor: _muted),
          BareStat(value: _TzCoordinatorData.riskLabel(_TzCoordinatorData.risk(f)), label: 'סיכון-גבייה (ותק · דפוס · מגמה)', inkColor: _TzCoordinatorData.risk(f) == 2 ? _danger : _TzCoordinatorData.risk(f) == 1 ? _warning : _ok, mutedColor: _muted),
        ]),
      ];
  ...
  List<Widget> _tabCharges(Map<String, dynamic> f, void Function(void Function()) act) {
    final cs = _TzCoordinatorData.chargesOf(f);
    final dups = _TzCoordinatorData.duplicateCharges(f).map((c) => c['id']).toSet();
    return [
      if (cs.isEmpty) const EmptyState(glyph: '📭', message: 'אין חיובים למשפחה — לרשום חיוב-שנה'),
      for (final c in cs)
        () {
          final cancelled = c['cancelledAt'] != null || _TzCoordinatorData.cancelledIds.contains(c['id']);
          final net = _TzCoordinatorData.netOf(f, c), gross = _TzCoordinatorData.grossOf(f, c);
          return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            TimelineItem(
              title: '${cancelled ? '🚫 ' : dups.contains(c['id']) ? '👯 ' : ''}${c['cat']} · ${c['memberId']}${c['installmentOf'] != null ? ' · הסדר' : ''}',
              time: fmtDate(c['date'] as String?),
              body: '${cancelled ? 'בוטל: ${_TzCoordinatorData.cancelReason[c['id']] ?? c['note'] ?? ''}' : _amounts ? (net != gross ? '${shekel(net)} (ברוטו ${shekel(gross)}, הנחה)' : shekel(net)) : '🔒'}${c['note'] != null && !cancelled ? ' · ${c['note']}' : ''}',
            ),
            if (!cancelled && _TzCoordinatorData.can(_role, 'fees.writeoff'))
              _wrap([SoftButton(label: '✖ בטל חיוב', tone: 2, onTap: () => act(() => _TzCoordinatorData.cancelCharge(f, _roleName, c, dups.contains(c['id']) ? 'חיוב-כפול' : 'ביטול-ידני')))], top: 2),
          ]);
        }(),
    ];
  }
  ...
  List<Widget> _tabPayments(Map<String, dynamic> f) {
    final ps = [..._TzCoordinatorData.paymentsOf(f)]..sort((a, b) => '${b['date']}'.compareTo('${a['date']}'));
    return [
      ...
      for (final p in ps)
        TimelineItem(
          ...
          body: '${_m(p['amount'] as num)}${[for (final m in _TzCoordinatorData.paymentMeta) if (p[m['key']] != null) ' · ${m['prefix']}${p[m['key']]}${m['suffix']}'].join()}',
        ),
  ...
  List<Widget> _tabHok(Map<String, dynamic> f, void Function(void Function()) act) {
    if (!_TzCoordinatorData.hasHok(f)) return [const EmptyState(glyph: '💳', message: 'אין הוראת-קבע למשפחה (מקום-שמור: תוגדר בשער-הסליקה)')];
    final h = f['hok'] as Map;
    ...
    return [
      Row(children: [
        StatusDot(tone: _TzCoordinatorData.hokFailed(f) ? 2 : _TzCoordinatorData.hokFlag(f) ? 1 : 3),
        const SizedBox(width: 10),
        Expanded(child: MediaRow(glyph: '💳', title: '${_m(h['amount'] as num)} · יום ${h['day']} בחודש', subtitle: '${_TzCoordinatorData.hokMethod(f)} · מ-${fmtDate(h['startDate'] as String?)}${h['kevaId'] != null ? ' · סליקה ${h['kevaId']}' : ' · ידנית'}')),
      ]),
      _wrap([
        StatusChip(label: _TzCoordinatorData.hokFlag(f) ? 'מסומנת פעילה' : 'מופסקת', tone: _TzCoordinatorData.hokFlag(f) ? 1 : 0),
        StatusChip(label: _TzCoordinatorData.hokActive(f) ? 'סליקה חיה' : 'סליקה פסקה >2 חודשים', tone: _TzCoordinatorData.hokActive(f) ? 1 : 2),
        StatusChip(label: _TzCoordinatorData.hokRecorded(f) ? 'נרשמה החודש ✅' : 'טרם נרשמה החודש', tone: _TzCoordinatorData.hokRecorded(f) ? 1 : 3),
      ]),
      if (_TzCoordinatorData.hokFailed(f)) ...[
        _gap(6),
  ...
  List<Widget> _tabReminders(Map<String, dynamic> f, void Function(void Function()) act) {
    final plan = _TzCoordinatorData.reminderPlan(f), sent = _TzCoordinatorData.remindersSent(f), nr = _TzCoordinatorData.nextReminder(f);
    return [
      if (_TzCoordinatorData.fullScholarship(f)) const AlertBanner(glyph: '🎓', tone: 1, message: 'מלגה מלאה — אפס-תזכורות (מגן-כבוד)') else if (plan.isEmpty) const EmptyState(glyph: '🕊', message: 'אין חוב פתוח — אין לוח-תזכורות') else ...[
        Text('לוח מדורג (מהחיוב-הפתוח-הוותיק ${fmtDate(_TzCoordinatorData.oldestOpenDate(f))})', style: const TextStyle(color: _muted, fontSize: 13, fontWeight: FontWeight.w800)),
        _wrap([for (var i = 0; i < plan.length; i++) StatusChip(label: '${i < sent.length ? '✅' : '${plan[i]['date']}'.compareTo(_TzCoordinatorData.today) <= 0 ? '⏰' : '⏳'} ${plan[i]['grade']} · ${fmtDate(plan[i]['date'] as String?)}', tone: i < sent.length ? 1 : nr != null && nr['grade'] == plan[i]['grade'] ? 3 : 0)]),
        if (nr != null && _TzCoordinatorData.can(_role, 'fees.remind')) _wrap([SoftButton(label: '📨 שלח תזכורת ${nr['grade']} (פרטי)', tone: 3, onTap: () => act(() => _TzCoordinatorData.sendReminder(f, _roleName, nr['grade'] as String)))], top: 8),
      ],
      _gap(8),
  ...
  List<Widget> _tabDiscounts(Map<String, dynamic> f, void Function(void Function()) act) {
    final ids = _TzCoordinatorData.effectiveCriteria(f);
    return [
      Row(children: [
        BareStat(value: '${_TzCoordinatorData.discountPct(f)}%', label: 'הנחה אפקטיבית (הגבוהה מנצחת)', inkColor: _acc, mutedColor: _muted),
        BareStat(value: _m(_TzCoordinatorData.scholarshipOf(f)), label: 'שווי-ההנחה השנה', inkColor: _ink, mutedColor: _muted),
        BareStat(value: '${_TzCoordinatorData.studentsN(f)}', label: 'אחים (הנחת-אחים אוטו)', inkColor: _ink, mutedColor: _muted),
      ]),
      _wrap([for (final c in _TzCoordinatorData.criteria) StatusChip(label: '${ids.contains(c['id']) ? '✅ ' : ''}${c['label']} ${c['discountPct']}%', tone: ids.contains(c['id']) ? 1 : 0)]),
      if (_TzCoordinatorData.can(_role, 'fees.scholarship'))
        _wrap([for (final c in _TzCoordinatorData.criteria) if (!ids.contains(c['id'])) SoftButton(label: '🎓 הענק ${c['label']}', tone: 0, onTap: () => act(() => _TzCoordinatorData.grantDiscount(f, _roleName, c['id'] as String)))], top: 8)
      else
  ...
  List<Widget> _tabArrangement(Map<String, dynamic> f, void Function(void Function()) act) {
    final ins = _TzCoordinatorData.installments(f);
    return [
      if (ins.isEmpty) ...[
        const EmptyState(glyph: '📆', message: 'אין הסדר-תשלומים'),
        if (_TzCoordinatorData.can(_role, 'fees.arrangement') && _TzCoordinatorData.balance(f) > 0)
          _wrap([for (final n in const [2, 3, 6]) SoftButton(label: '📆 פריסה ל-$n', tone: 0, onTap: () => act(() => _TzCoordinatorData.setArrangement(f, _roleName, n)))], top: 4),
      ] else ...[
        if (_TzCoordinatorData.arrangementLate(f)) const AlertBanner(glyph: '📆', tone: 3, message: 'הסדר בפיגור — תשלום שמועדו עבר לא כוסה'),
        for (final c in ins)
          TimelineItem(title: '${c['note'] ?? 'תשלום-הסדר'}', time: fmtDate(c['date'] as String?), body: '${_m(_TzCoordinatorData.netOf(f, c))} · ${'${c['date']}'.compareTo(_TzCoordinatorData.today) <= 0 ? (_TzCoordinatorData.oldestOpenDate(f) != null && '${c['date']}'.compareTo(_TzCoordinatorData.oldestOpenDate(f)!) >= 0 ? 'פתוח' : 'כוסה') : 'עתידי'}'),
      ],
    ];
  }
  ...
  List<Widget> _tabStatement(Map<String, dynamic> f) {
    final lines = <String>[
      'מצב-חשבון · ${f['name']} · ${_TzCoordinatorData.orgName} · ${fmtDate(_TzCoordinatorData.today)}',
      'הורה-משלם: ${f['notes']} · ${f['phone']}',
      'תלמידים: ${_TzCoordinatorData.studentsOf(f)} (${_TzCoordinatorData.gradesOf(f)})',
      '',
      'חיובים:',
      for (final c in _TzCoordinatorData.liveCharges(f)) '  ${fmtDate(c['date'] as String?)}  ${c['cat']}  ${c['memberId']}  ${shekel(_TzCoordinatorData.netOf(f, c))}',
      'תשלומים:',
      for (final p in _TzCoordinatorData.paymentsOf(f)) '  ${fmtDate(p['date'] as String?)}  ${p['method']}  ${shekel(p['amount'] as num)}',
      '',
      'סך-חיובים ${shekel(_TzCoordinatorData.charged(f))} · שולם ${shekel(_TzCoordinatorData.paid(f))} · יתרה ${shekel(_TzCoordinatorData.balance(f))}',
    ];
    return [
  ...
  List<Widget> _tabAudit(Map<String, dynamic> f) {
    final rows = _TzCoordinatorData.audit.where((a) => a['family'] == f['id']).toList();
    return [
  ...
  void _openChargeForm(Map<String, dynamic>? fixed, List<Map<String, dynamic>> pool, {VoidCallback? onDone}) {
    ...
    var cat = _TzCoordinatorData.chargeTypes.first, amount = '', date = _TzCoordinatorData.today, note = '', member = '', bulk = '';
    showModalBottomSheet<void>(
      context: context, backgroundColor: Colors.transparent, isScrollControlled: true,
      builder: (ctx) => StatefulBuilder(builder: (ctx, setSheet) {
        final f = _TzCoordinatorData.families.firstWhere((x) => x['id'] == fam, orElse: () => _TzCoordinatorData.families.first);
        final members = [for (final m in f['scoreLog'] as List) '${(m as Map)['first']}'];
        if (!members.contains(member)) member = members.first;
        final grades = _TzCoordinatorData.grades(_TzCoordinatorData.families);
        return Padding(
            ...
            builder: (ctx, scroll) => Padding(
              ...
              child: GlassCard(
                child: ListView(controller: scroll, padding: const EdgeInsets.all(6), children: [
                  ...
                  _gap(8),
                  DsEnumField(label: 'משפחה', options: [for (final x in _TzCoordinatorData.families) '${x['name']}'], value: '${f['name']}', onChanged: (v) => setSheet(() => fam = _TzCoordinatorData.families.firstWhere((x) => x['name'] == v)['id'] as String)),
                  DsEnumField(label: 'עבור-מי', options: members, value: member, onChanged: (v) => setSheet(() => member = v)),
                  DsEnumField(label: 'סוג-חיוב', options: _TzCoordinatorData.chargeTypes, value: cat, onChanged: (v) => setSheet(() => cat = v)),
                  ...
                  DsPrimaryButton(label: bulk.isEmpty ? 'שמור חיוב' : 'חיוב-מרוכז לכל $bulk', onTap: () {
                    ...
                    if (a <= 0) return;
                    if (bulk.isEmpty) {
                      _TzCoordinatorData.addCharge(f, _roleName, cat: cat, amount: a, date: date, memberId: member, note: note);
                    } else {
                      for (final x in _TzCoordinatorData.families) {
                        for (final m in x['scoreLog'] as List) {
                          if ('${(m as Map)['grade']}'.startsWith(bulk)) _TzCoordinatorData.addCharge(x, _roleName, cat: cat, amount: a, date: date, memberId: '${m['first']}', note: note.isEmpty ? 'חיוב-מרוכז $bulk' : note);
                        }
                      }
                    }
  ...
  void _openPaymentForm(Map<String, dynamic>? fixed, List<Map<String, dynamic>> pool, {VoidCallback? onDone}) {
    var fam = fixed?['id'] as String? ?? (pool.isNotEmpty ? pool.first['id'] as String : '');
    var method = 'אשראי', amount = '', date = _TzCoordinatorData.today, note = '';
    showModalBottomSheet<void>(
      context: context, backgroundColor: Colors.transparent, isScrollControlled: true,
      builder: (ctx) => StatefulBuilder(builder: (ctx, setSheet) {
        final f = _TzCoordinatorData.families.firstWhere((x) => x['id'] == fam, orElse: () => _TzCoordinatorData.families.first);
        final bal = _TzCoordinatorData.balance(f);
        return Padding(
          padding: EdgeInsets.only(bottom: MediaQuery.of(ctx).viewInsets.bottom),
          child: DraggableScrollableSheet(
            ...
            builder: (ctx, scroll) => Padding(
              ...
              child: GlassCard(
                child: ListView(controller: scroll, padding: const EdgeInsets.all(6), children: [
                  ...
                  _gap(8),
                  DsEnumField(label: 'משפחה', options: [for (final x in _TzCoordinatorData.families) '${x['name']}'], value: '${f['name']}', onChanged: (v) => setSheet(() => fam = _TzCoordinatorData.families.firstWhere((x) => x['name'] == v)['id'] as String)),
                  DsEnumField(label: 'אמצעי', options: _TzCoordinatorData.payMethodsSchool, value: method, onChanged: (v) => setSheet(() => method = v)),
                  ...
                  DsPrimaryButton(label: 'רשום תשלום', onTap: () {
                    ...
                    if (a <= 0) return;
                    _TzCoordinatorData.addPayment(f, _roleName, amount: a, method: method, date: date, note: note);
                    Navigator.of(ctx).pop();
                    setState(() {});
                    onDone?.call();
                  }),
  ...
  void _openExport(List<Map<String, dynamic>> fs) {
    final csv = _TzCoordinatorData.csvOf(fs);
    showModalBottomSheet<void>(
      context: context, backgroundColor: Colors.transparent, isScrollControlled: true,
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx, scroll) => Padding(
          ...
          child: GlassCard(
            child: ListView(controller: scroll, padding: const EdgeInsets.all(6), children: [
              MediaRow(glyph: '⬇', title: 'ייצוא CSV', subtitle: '${fs.length} משפחות · ${_TzCoordinatorData.csvHeader.length} עמודות (PDF = שער-חיצוני, מקום-שמור)'),
              _gap(10),
              Container(
                padding: const EdgeInsets.all(10),
                decoration: BoxDecoration(color: const Color(0xFF0C0D1E), borderRadius: BorderRadius.circular(10)),
...
// ═══ תפר-עובדות ציבורי (G9b · לרכזת-האפליקציה): TzCoordinatorFacts — נגזרות-אמת של דאטה-המודול; כל ערך = ביטוי חי על הזרע/המנועים (§20-ג), אפס ליטרל-מומצא. מחולל: retarget.mjs ═══
class TzCoordinatorFacts {
  static const String entity = 'TzCoordinator';
  static const String label = 'רכז'; // מונח-הישות מ-entity-terms (דאטה)
  static int get count => _TzCoordinatorData.families.length; // רשומות הזרע-הראשי "families" (static-const)
