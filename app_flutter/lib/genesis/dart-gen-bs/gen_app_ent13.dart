...
// 🧬 שם: הירו 🗂️ קבלן משנה | ישות מורכבת — טופס + טבלה
// 🧬 בקשה: הירו 🗂️ קבלן משנה | ישות מורכבת — טופס + טבלה · אטום BreadcrumbTrail קבלן משנה: מועמד / נבדק / אושר / פעיל · כותרת טופס קבלן משנה · אטום InlineTextRow שם · אטום GlowField חברה · אטום InlineTextRow תחום · אטום InlineTextRow רישיון · אטום DatePills תוקף ביטוח · אטום InlineTextRow דירוג · אטום AnimatedToggle סטטוס · אטום FabMenu שמירה · אטום NeonButton קדם לנבדק · כותרת חוקים פר-שדה · חישוב אין שקעים שם פרטי (kForType) · כותרת רשומות קבלן משנה · אטום DataGrid קבלן משנה · באנר ישות קבלן משנה: 7 שדות · 4-שלבי workflow · 1 חוקים · מהמדף
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          InlineTextRow(label: gen_app_ent13_textfield_label, hint: gen_app_ent13_textfield_hint, value: _t1, onChanged: (v) => setState(() => _t1 = v)),
          GlowField(hint: gen_app_ent13_glowfield_hint, height: 16, radius: 12, accentColor: BsTokens.brand, baseColor: BsTokens.inkLight, fillColor: BsTokens.cardLight),
          InlineTextRow(label: gen_app_ent13_textfield_label2, hint: gen_app_ent13_textfield_hint2, value: _t2, onChanged: (v) => setState(() => _t2 = v)),
          InlineTextRow(label: gen_app_ent13_textfield_label3, hint: gen_app_ent13_textfield_hint3, value: _t3, onChanged: (v) => setState(() => _t3 = v)),
          DatePills(height: 16, days: 0, radius: 12, accentColor: BsTokens.brand, baseColor: BsTokens.inkLight, fillColor: BsTokens.cardLight),
          InlineTextRow(label: gen_app_ent13_textfield_label4, hint: gen_app_ent13_textfield_hint4, value: _t4, onChanged: (v) => setState(() => _t4 = v)),
