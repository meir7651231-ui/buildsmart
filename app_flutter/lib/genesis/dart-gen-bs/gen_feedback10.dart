...
// 🧬 שם: רכיבים חיים - משוב
// 🧬 בקשה: רכיבים חיים - משוב: · הירו 🔔 משוב | התראות התקדמות וסטטוס ממשפט · כותרת התראות · התראה 52 הפעולה הושלמה בהצלחה · סרגל 44 62 מד התקדמות · סטטוס 44 מחובר עכשיו · תג 32 חדש · באנר כל חיווי כאן חי - נבחר ממילה בעברית
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          LinearProgress(height: 44, radius: 12, accentColor: BsTokens.brand, baseColor: BsTokens.inkLight, fillColor: BsTokens.cardLight, pct: 62),
