...
class GenAppSechirutEnt3Screen extends StatefulWidget {
  const GenAppSechirutEnt3Screen({this.scopeField, this.scopeId, this.initial, this.editId, super.key});
...
class _GenAppSechirutEnt3ScreenState extends State<GenAppSechirutEnt3Screen> {
  ...
  @override
  void initState() { super.initState(); _prefill(); if (widget.editId != null) { final r = appStore.byId('app_sechirut_ent3', widget.editId!); if (r != null) WidgetsBinding.instance.addPostFrameCallback((_) { if (mounted) _edit(r); }); } }
