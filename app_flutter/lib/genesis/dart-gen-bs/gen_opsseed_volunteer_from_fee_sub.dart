...
class _FeesScreenState extends State<FeesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return DsScaffold(title: 'FeesScreen', subtitle: 'FeesScreen · מודול-משנה מחולל · 5 בונים מחווטים-לשקעי-הזהב', icon: '🧬', children: [
      _hokView(all, hokDue),
      _remindersView(visible),
      _reportsView(all, trend, thisMonth),
      _auditView(),
      _gap(10),
      // בונים-פנימיים (מורכבים דרך הקורא שלהם, לא ברמת-המסך): _reminderCard, _wrap
      // מקום-שמור (חוק-7): בונים בלי שקע-פתיר במודול-המשנה — _tabCharges, _tabPayments, _tabHok, _tabReminders, _tabArrangement, _tabStatement, _tabAudit
    ]);
  }
}
