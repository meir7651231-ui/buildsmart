...
import '../dart-data-bs/auto/gen_app_sechirut_main_content.dart';
...
class GenAppSechirutMainScreen extends StatelessWidget {
  const GenAppSechirutMainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_sechirut_main_c0,
