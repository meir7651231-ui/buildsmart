...
class GenAppPeruk10RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk10_root_c60, subtitle: gen_app_peruk10_root_c61, icon: gen_app_peruk10_root_c62, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk10_ent1', id), subtitle: const [gen_app_peruk10_root_c55, gen_app_peruk10_root_c56, gen_app_peruk10_root_c57, gen_app_peruk10_root_c58, gen_app_peruk10_root_c59][appStore.stageOf('app_peruk10_ent1', id).clamp(0, 4)], icon: gen_app_peruk10_root_c63, children: [
