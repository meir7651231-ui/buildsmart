...
class GenAppPeruk10RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk10_root_c48, subtitle: gen_app_peruk10_root_c49, icon: gen_app_peruk10_root_c50, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk10_ent1', id), subtitle: const [gen_app_peruk10_root_c43, gen_app_peruk10_root_c44, gen_app_peruk10_root_c45, gen_app_peruk10_root_c46, gen_app_peruk10_root_c47][appStore.stageOf('app_peruk10_ent1', id).clamp(0, 4)], icon: gen_app_peruk10_root_c51, children: [
      Padding(padding: const EdgeInsets.only(bottom: 12), child: GestureDetector(behavior: HitTestBehavior.opaque, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk10Rp1Screen(initialId: id))), child: ForgeToneButton(items: [[gen_app_peruk10_root_c40]]))),
