    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          IndexedStack(index: _n1, children: [Row(children: [RStat(value: isoLocal(DateTime.now()), label: gen_quest2_stat_label)]), Row(children: [RStat(value: hebMonthHeWired(DateTime.now()), label: gen_quest2_stat_label2)]), Row(children: [RStat(value: hebMonthHe(DateTime.now()), label: gen_quest2_stat_label3)])]),
          SwitchRow(label: gen_quest2_switch_label, value: _v2, onChanged: (v) => setState(() => _v2 = v)),
          if (_v2) Row(children: [RStat(value: daysBetweenDst(DateTime.now(), DateTime.now()).toString(), label: gen_quest2_stat_label4)]),
