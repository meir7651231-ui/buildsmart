...
class GenAppPeruk05Px1Screen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => DsScaffold(title: gen_app_peruk05_px1_c101, subtitle: gen_app_peruk05_px1_c102, icon: gen_app_peruk05_px1_c103, children: [
    ...
    Padding(padding: const EdgeInsets.only(bottom: 10), child: GestureDetector(behavior: HitTestBehavior.opaque, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const GenAppPeruk05Ent1Screen())), child: ForgeToneButton(items: [[gen_app_peruk05_px1_c16]]))),
