...
class _GenAppEnt4ScreenState extends State<GenAppEnt4Screen> {
  ...
  void _save() {
    ...
    appStore.add(gen_app_ent4_c7, <String, String>{gen_app_ent4_c8: _v[0] ?? '', gen_app_ent4_c10: _v[1] ?? '', gen_app_ent4_c11: _v[2] ?? '', gen_app_ent4_c12: _v[3] ?? '', gen_app_ent4_c13: _v[4] ?? '', gen_app_ent4_c15: _v[5] ?? '', gen_app_ent4_c17: _v[6] ?? '', gen_app_ent4_c18: _v[7] ?? '', gen_app_ent4_c19: _v[8] ?? '', gen_app_ent4_c20: _v[9] ?? ''});
    setState(() => _v.clear());
  }
    ...
    return DsScaffold(
      ...
      children: [
        DsSection(title: gen_app_ent4_c4, children: [
          ...
          DsField(label: gen_app_ent4_c11, hint: '', value: _v[2] ?? '', onChanged: (v) => setState(() => _v[2] = v)),
          ...
          if ((_v[4] ?? '').trim().isNotEmpty) _live(gen_app_ent4_c14, fmtDate((_v[4] ?? ''))),
          DsField(label: gen_app_ent4_c15, hint: '', value: _v[5] ?? '', onChanged: (v) => setState(() => _v[5] = v)),
          if ((_v[5] ?? '').trim().isNotEmpty) _live(gen_app_ent4_c16, fmtDate((_v[5] ?? ''))),
          ...
          DsField(label: gen_app_ent4_c20, hint: '', value: _v[9] ?? '', onChanged: (v) => setState(() => _v[9] = v)),
        ]),
          ...
          AnimatedBuilder(
            ...
            builder: (context, _) {
              ...
              return Column(children: [
                for (final r in rs)
                  DsRecordCard(labels: const [gen_app_ent4_c8, gen_app_ent4_c10, gen_app_ent4_c11, gen_app_ent4_c12, gen_app_ent4_c13, gen_app_ent4_c15, gen_app_ent4_c17, gen_app_ent4_c18, gen_app_ent4_c19, gen_app_ent4_c20], values: [r[gen_app_ent4_c8] ?? '', r[gen_app_ent4_c10] ?? '', r[gen_app_ent4_c11] ?? '', r[gen_app_ent4_c12] ?? '', r[gen_app_ent4_c13] ?? '', r[gen_app_ent4_c15] ?? '', r[gen_app_ent4_c17] ?? '', r[gen_app_ent4_c18] ?? '', r[gen_app_ent4_c19] ?? '', r[gen_app_ent4_c20] ?? '']),
              ]);
            },
          ),
        ]),
