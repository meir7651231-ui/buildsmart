...
class _GenAppEnt25ScreenState extends State<GenAppEnt25Screen> {
  ...
  void _save() {
    ...
    appStore.add(gen_app_ent25_c7, <String, String>{gen_app_ent25_c8: _v[0] ?? '', gen_app_ent25_c9: _v[1] ?? '', gen_app_ent25_c10: _v[2] ?? '', gen_app_ent25_c11: _v[3] ?? '', gen_app_ent25_c12: _v[4] ?? '', gen_app_ent25_c13: _v[5] ?? ''});
    setState(() => _v.clear());
  }
  ...
  Widget build(BuildContext context) {
    return DsScaffold(
      ...
      children: [
        DsWorkflow(steps: const [gen_app_ent25_c15, gen_app_ent25_c16, gen_app_ent25_c17, gen_app_ent25_c18, gen_app_ent25_c19], current: 2),
        DsSection(title: gen_app_ent25_c4, children: [
          DsField(label: gen_app_ent25_c8, hint: '', value: _v[0] ?? '', onChanged: (v) => setState(() => _v[0] = v)),
          DsField(label: gen_app_ent25_c9, hint: '', value: _v[1] ?? '', onChanged: (v) => setState(() => _v[1] = v)),
          ...
          if ((_v[5] ?? '').trim().isNotEmpty) _live(gen_app_ent25_c14, advanceStatus((_v[5] ?? ''))),
        ]),
          ...
          AnimatedBuilder(
            ...
            builder: (context, _) {
              ...
              return Column(children: [
                for (final r in rs)
                  DsRecordCard(labels: const [gen_app_ent25_c8, gen_app_ent25_c9, gen_app_ent25_c10, gen_app_ent25_c11, gen_app_ent25_c12, gen_app_ent25_c13], values: [r[gen_app_ent25_c8] ?? '', r[gen_app_ent25_c9] ?? '', r[gen_app_ent25_c10] ?? '', r[gen_app_ent25_c11] ?? '', r[gen_app_ent25_c12] ?? '', r[gen_app_ent25_c13] ?? '']),
              ]);
            },
          ),
        ]),
