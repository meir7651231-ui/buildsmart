...
//   החלטה = החלטה ⇒ partition ⇒ [group, alert] ⇒ DsSection + ToastCard
//   אסור בפלט = [תוכן אסור] ⇒ content ⇒ [alert] ⇒ ToastCard
...
class GenAppSechirutPx1Screen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => DsScaffold(title: gen_app_sechirut_px1_c69, subtitle: gen_app_sechirut_px1_c70, icon: gen_app_sechirut_px1_c71, header: false, children: [ForgeCenteredPageHeader(fields: ['', gen_app_sechirut_px1_c69, gen_app_sechirut_px1_c70]), ...[
    ...
    Padding(padding: const EdgeInsets.only(bottom: 10), child: AnimatedBuilder(animation: appStore, builder: (context, _) => Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [ForgeTitledSection(fields: [gen_app_sechirut_px1_c40 + ' · ' + appStore.records('app_sechirut_ent1').where((r) => (r[gen_app_sechirut_px1_c38] ?? '') == gen_app_sechirut_px1_c39).toList().length.toString(), '', '', ''], child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [...[for (final r in appStore.records('app_sechirut_ent1').where((r) => (r[gen_app_sechirut_px1_c38] ?? '') == gen_app_sechirut_px1_c39).toList()) ToastCard(message: (r[gen_app_sechirut_px1_c35] ?? ''), tone: 0)]])), ForgeTitledSection(fields: [gen_app_sechirut_px1_c45 + ' · ' + appStore.records('app_sechirut_ent1').where((r) => (r[gen_app_sechirut_px1_c43] ?? '') == gen_app_sechirut_px1_c44).toList().length.toString(), '', '', ''], child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [...[for (final r in appStore.records('app_sechirut_ent1').where((r) => (r[gen_app_sechirut_px1_c43] ?? '') == gen_app_sechirut_px1_c44).toList()) ToastCard(message: (r[gen_app_sechirut_px1_c35] ?? ''), tone: 0)]])), ForgeTitledSection(fields: [gen_app_sechirut_px1_c50 + ' · ' + appStore.records('app_sechirut_ent1').where((r) => (r[gen_app_sechirut_px1_c48] ?? '') == gen_app_sechirut_px1_c49).toList().length.toString(), '', '', ''], child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [...[for (final r in appStore.records('app_sechirut_ent1').where((r) => (r[gen_app_sechirut_px1_c48] ?? '') == gen_app_sechirut_px1_c49).toList()) ToastCard(message: (r[gen_app_sechirut_px1_c35] ?? ''), tone: 0)]]))]))),
    Padding(padding: const EdgeInsets.only(bottom: 10), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [ToastCard(message: gen_app_sechirut_px1_c54, tone: 0), ToastCard(message: gen_app_sechirut_px1_c57, tone: 0), ToastCard(message: gen_app_sechirut_px1_c60, tone: 0), ToastCard(message: gen_app_sechirut_px1_c63, tone: 0), ToastCard(message: gen_app_sechirut_px1_c66, tone: 0)])),
  ]]);
}
