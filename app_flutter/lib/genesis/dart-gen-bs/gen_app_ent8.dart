...
// 🧬 שם: 🗂️ חוזה
// 🧬 בקשה: הירו 🗂️ חוזה | ישות מורכבת — טופס + טבלה · אטום BreadcrumbTrail חוזה: טיוטה / נחתם / פעיל / הושלם · כותרת טופס חוזה · אטום NumberStepper מספר · אטום FieldRow סוג · אטום FieldRow פרויקט · אטום NumberStepper סכום · אטום FieldRow תאריך חתימה · אטום FieldRow התחלה · אטום FieldRow סיום · אטום FieldRow עיכבון · אטום AnimatedToggle סטטוס · אטום FabMenu שמירה · אטום NeonButton קדם לנחתם · כותרת רשומות חוזה · אטום DataGrid חוזה · באנר ישות חוזה: 9 שדות · 4-שלבי workflow · מהמדף
// 🧬 אטומים שנבחרו: BreadcrumbTrail · CaSubTitle · NumberStepper · FieldRow · FieldRow · NumberStepper · FieldRow · FieldRow · FieldRow · FieldRow · AnimatedToggle · FabMenu · NeonButton · CaSubTitle · DataGrid · CoinBanner
