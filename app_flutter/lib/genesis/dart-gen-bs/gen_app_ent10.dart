...
class _GenAppEnt10ScreenState extends State<GenAppEnt10Screen> {
  ...
  void _save() {
    ...
    appStore.add(gen_app_ent10_c7, <String, String>{gen_app_ent10_c8: _v[0] ?? '', gen_app_ent10_c10: _v[1] ?? '', gen_app_ent10_c11: _v[2] ?? '', gen_app_ent10_c12: _v[3] ?? '', gen_app_ent10_c14: _v[4] ?? '', gen_app_ent10_c15: _v[5] ?? '', gen_app_ent10_c16: _v[6] ?? ''});
    setState(() => _v.clear());
  }
    ...
    return DsScaffold(
      ...
      children: [
        ...
        DsSection(title: gen_app_ent10_c4, children: [
          ...
          if ((_v[3] ?? '').trim().isNotEmpty) _live(gen_app_ent10_c13, fmtDate((_v[3] ?? ''))),
          DsField(label: gen_app_ent10_c14, hint: '', value: _v[4] ?? '', onChanged: (v) => setState(() => _v[4] = v)),
          ...
          if ((_v[6] ?? '').trim().isNotEmpty) _live(gen_app_ent10_c17, advanceStatus((_v[6] ?? ''))),
        ]),
        DsSection(title: gen_app_ent10_c5, children: [
          AnimatedBuilder(
            animation: appStore,
            builder: (context, _) {
              final rs = appStore.records(gen_app_ent10_c7);
              if (rs.isEmpty) return const DsEmpty(label: gen_app_ent10_c6);
              return Column(children: [
                for (final r in rs)
                  DsRecordCard(labels: const [gen_app_ent10_c8, gen_app_ent10_c10, gen_app_ent10_c11, gen_app_ent10_c12, gen_app_ent10_c14, gen_app_ent10_c15, gen_app_ent10_c16], values: [r[gen_app_ent10_c8] ?? '', r[gen_app_ent10_c10] ?? '', r[gen_app_ent10_c11] ?? '', r[gen_app_ent10_c12] ?? '', r[gen_app_ent10_c14] ?? '', r[gen_app_ent10_c15] ?? '', r[gen_app_ent10_c16] ?? '']),
              ]);
            },
          ),
        ]),
