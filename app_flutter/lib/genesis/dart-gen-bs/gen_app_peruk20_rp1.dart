...
class _GenAppPeruk20Rp1ScreenState extends State<GenAppPeruk20Rp1Screen> {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, __) {
    ...
    if (rs.isEmpty) return DsScaffold(title: gen_app_peruk20_rp1_c68, subtitle: gen_app_peruk20_rp1_c69, icon: gen_app_peruk20_rp1_c71, children: [EmptyState(label: gen_app_peruk20_rp1_c3)]);
    ...
    return DsScaffold(title: gen_app_peruk20_rp1_c68, subtitle: gen_app_peruk20_rp1_c69, icon: gen_app_peruk20_rp1_c72, children: [
