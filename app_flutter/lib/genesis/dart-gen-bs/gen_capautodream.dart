    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          Row(children: [RStat(value: phoneIssue((sortSupportThreads(_t1).toString())) ?? '', label: gen_capautodream_stat_label2)]),
          ...
          Row(children: [RStat(value: phoneIssue((sortSupportThreads(_t2).toString())) ?? '', label: gen_capautodream_stat_label4)]),
