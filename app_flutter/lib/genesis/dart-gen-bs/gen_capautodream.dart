...
// 🧬 שם: הזמנה-עצמית - יכולת שחלמתי היום והוכחתי לבד - מפתח חודש ואז מסיר את איבר
// 🧬 בקשה: הזמנה-עצמית - יכולת שחלמתי היום והוכחתי לבד - מפתח חודש ואז מסיר את איבר: · הירו 🧪 הזמנה-עצמית - יכולת שחלמתי היום והוכחתי לבד - מפתח חודש ואז מסיר את איבר | יכולת שהוזמנה ולא היתה קיימת - הרכבתי אותה לבד מ-2 אטומים והוכחתי על 2 דוגמאות · כותרת תחנת ההוכחה - הדוגמאות שהוזמנו מדליקות את השרשרת · אטום ChipWrap הזמנה-עצמית - יכולת שחלמתי היום והוכחתי לבד - מפתח חודש ואז מסיר את איבר: שבע מאות / שני · חישוב מפתח חודש (monthKey) · חישוב מסיר את איבר תו אחרון (popCall) · כותרת תחנת הקלט החופשי - הקלידו כל ערך והשרשרת רצה חיה · שדה הקלידו ערך עבור הזמנה-עצמית - יכולת · חישוב מפתח חודש (monthKey) · חישוב מסיר את איבר תו אחרון (popCall) · באנר ההרכבה שמצאתי - monthKey ⟵ popCall - כל הדוגמאות עברו
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          Row(children: [RStat(value: monthKey(_t1), label: gen_capautodream_stat_label)]),
          Row(children: [RStat(value: popCall((monthKey(_t1))).toString(), label: gen_capautodream_stat_label2)]),
          ...
          Row(children: [RStat(value: monthKey(_t2), label: gen_capautodream_stat_label3)]),
          Row(children: [RStat(value: popCall((monthKey(_t2))).toString(), label: gen_capautodream_stat_label4)]),
