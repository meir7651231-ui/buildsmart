...
//   החלפות: stat×0 · hero×1 · chipRow×1 · chip×3 · statRow×21 · button×34 · statusChip×25 · banner×16 · emptyState×11 · mediaRow×5 · section×2 · segmented×4 · meter×3 · frame×9 · timeline×7 · field×4 · enumField×3 · search×1 · BareStat ב-Row נשאר DS (רצועת-4) · צבעי-מצב-DS לא מועברים · חיפוש/טבלאות/פילטרים = DS (אטומי-forge של קלט הם ציור, לא שדה)
