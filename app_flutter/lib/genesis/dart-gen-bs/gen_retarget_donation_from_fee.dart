...
//   זרע-ראשי: families (מועמדים: families(36/38) charges(9/10) charges(7/8) charges(7/8) charges(7/8) charges(7/8) charges(7/8) incoming(7/8) charges(6/7) hist(5/5) criteria(3/3) calls(3/3) payments(3/4) payments(3/4) payments(3/4) payments(3/4) calls(3/3) payments(3/4)) · מיפוי שם 5 · ערוץ 0 · טיפוס-יחיד 0 · מקום-שמור 33
//   date⇒date(name) · amount⇒amount(name) · cur⇒cur(name) · cat⇒cat(name) · rid⇒rid(name) · id⇒∅(reserved) · name⇒∅(reserved(2 מועמדים)) · payer⇒∅(reserved(2 מועמדים)) · phone⇒∅(reserved(2 מועמדים)) · email⇒∅(reserved(2 מועמדים)) · idNum⇒∅(reserved(2 מועמדים)) · members⇒∅(reserved) · grade⇒∅(reserved(2 מועמדים)) · first⇒∅(reserved(2 מועמדים)) · charges⇒∅(reserved) · method⇒∅(reserved(2 מועמדים)) · memberId⇒∅(reserved(2 מועמדים)) · note⇒∅(reserved(2 מועמדים)) · payments⇒∅(reserved) · hok⇒∅(reserved) · day⇒∅(reserved) · active⇒∅(reserved) · startedAt⇒∅(reserved) · criteria⇒∅(reserved) · calls⇒∅(reserved) · carryBalance⇒∅(reserved) · kevaId⇒∅(reserved(2 מועמדים)) · hist⇒∅(reserved) · d⇒∅(reserved) · a⇒∅(reserved) · c⇒∅(reserved(2 מועמדים)) · clearer⇒∅(reserved(2 מועמדים)) · at⇒∅(reserved) · outcome⇒∅(reserved(2 מועמדים)) · nextDate⇒∅(reserved) · nextNote⇒∅(reserved(2 מועמדים)) · installmentOf⇒∅(reserved(2 מועמדים)) · cancelledAt⇒∅(reserved)
//   שדות-Donation בלי מקור (מקום-שמור, יאירו כשיוזרם נתון): designation, purpose · תוויות-UI = של מודול-המקור (הצבה) · הזרע = זרע-הצבה של המקור, לא ערך-אמת של Donation
