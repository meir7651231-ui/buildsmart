...
class GenAppPeruk13RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk13_root_c28, subtitle: gen_app_peruk13_root_c29, icon: gen_app_peruk13_root_c30, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk13_ent1', id), subtitle: const [gen_app_peruk13_root_c23, gen_app_peruk13_root_c24, gen_app_peruk13_root_c25, gen_app_peruk13_root_c26, gen_app_peruk13_root_c27][appStore.stageOf('app_peruk13_ent1', id).clamp(0, 4)], icon: gen_app_peruk13_root_c31, children: [
      Padding(padding: const EdgeInsets.only(bottom: 12), child: GestureDetector(behavior: HitTestBehavior.opaque, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => GenAppPeruk13Rp1Screen(initialId: id))), child: ForgeToneButton(items: [[gen_app_peruk13_root_c20]]))),
