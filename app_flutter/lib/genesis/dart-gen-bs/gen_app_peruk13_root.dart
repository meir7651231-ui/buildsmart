...
class GenAppPeruk13RootScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(animation: appStore, builder: (context, _) {
    ...
    if (r0 == null) return DsScaffold(title: gen_app_peruk13_root_c40, subtitle: gen_app_peruk13_root_c41, icon: gen_app_peruk13_root_c42, children: const []);
    return DsScaffold(title: appStore.displayOf('app_peruk13_ent1', id), subtitle: const [gen_app_peruk13_root_c35, gen_app_peruk13_root_c36, gen_app_peruk13_root_c37, gen_app_peruk13_root_c38, gen_app_peruk13_root_c39][appStore.stageOf('app_peruk13_ent1', id).clamp(0, 4)], icon: gen_app_peruk13_root_c43, children: [
