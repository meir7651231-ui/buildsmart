...
class _GenAppPeruk01HubScreenState extends State<GenAppPeruk01HubScreen> {
  ...
  List<Widget> _tiles(BuildContext context) => [
        ...
        DsNavTile(glyph: gen_app_peruk01_hub_c5, title: gen_app_peruk01_hub_c6, sub: gen_app_peruk01_hub_c7, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const GenAppPeruk01Ent2Screen()))),
        DsNavTile(glyph: gen_app_peruk01_hub_c8, title: gen_app_peruk01_hub_c9, sub: gen_app_peruk01_hub_c10, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const GenAppPeruk01Scr3Screen()))),
        DsNavTile(glyph: gen_app_peruk01_hub_c11, title: gen_app_peruk01_hub_c12, sub: gen_app_peruk01_hub_c13, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const GenAppPeruk01Rp1Screen()))),
        DsNavTile(glyph: gen_app_peruk01_hub_c14, title: gen_app_peruk01_hub_c15, sub: gen_app_peruk01_hub_c16, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const GenAppPeruk01Px1Screen()))),
        DsNavTile(glyph: gen_app_peruk01_hub_c17, title: gen_app_peruk01_hub_c18, sub: gen_app_peruk01_hub_c19, onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const GenAppPeruk01Px2Screen()))),
  ...
  Widget build(BuildContext context) {
    ...
    return DsScaffold(
      title: gen_app_peruk01_hub_c0,
      subtitle: '${vis.length} מסכים גלויים',
      icon: gen_app_peruk01_hub_c1,
      children: [
