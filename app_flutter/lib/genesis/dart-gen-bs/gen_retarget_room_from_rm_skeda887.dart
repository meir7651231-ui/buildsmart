  ...
  Widget build(BuildContext context) {
    ...
    return DsScaffold(
      ...
      children: [
        ...
        Align(
          alignment: Alignment.centerRight,
          child: SingleChildScrollView(scrollDirection: Axis.horizontal, child: ForgeSegPickerSelection(bare: true, items: [for (final s in [for (final r in _RoomData.roleDefs) r['label'] as String]) [s]], selected: {_role}, onSelect: (i) => setState(() => _role = i))),
        ),
        ...
        if (_view == 0) ...[
          ...
          Align(
            ...
            child: SingleChildScrollView(
              ...
              child: ForgeSegPickerSelection(bare: true, items: [for (final s in [for (var i = 0; i < letters.length; i++) '${letters[i]} ${_RoomData.weekIsos[i].substring(8)}']) [s]], selected: {_dayIdx}, onSelect: (i) => setState(() => _dayIdx = i)),
            ),
          ),
        ],
        const SizedBox(height: 10),
