...
import '../dart-data-bs/auto/gen_app_peruk15_main_content.dart';
import '../dart-ui-bs/ds/ds_pure.dart';
import '../dart-ui-bs/ds/ds_seam.dart';
import 'gen_app_peruk15_shell.dart';
import 'package:flutter/material.dart';

void main() => runApp(const GenAppPeruk15MainScreen());

class GenAppPeruk15MainScreen extends StatelessWidget {
  const GenAppPeruk15MainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_peruk15_main_c0,
        ...
        home: const GenAppPeruk15ShellScreen(),
      );
}
