...
class GenAppPeruk02Ent1Screen extends StatefulWidget {
  const GenAppPeruk02Ent1Screen({this.scopeField, this.scopeId, this.initial, this.editId, super.key});
...
class _GenAppPeruk02Ent1ScreenState extends State<GenAppPeruk02Ent1Screen> {
  ...
  @override
  void initState() { super.initState(); _prefill(); if (widget.editId != null) { final r = appStore.byId('app_peruk02_ent1', widget.editId!); if (r != null) WidgetsBinding.instance.addPostFrameCallback((_) { if (mounted) _edit(r); }); } }
