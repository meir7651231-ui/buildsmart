...
import '../dart-data-bs/auto/gen_app_peruk09_main_content.dart';
import '../dart-ui-bs/ds/ds_pure.dart';
import '../dart-ui-bs/ds/ds_seam.dart';
import 'gen_app_peruk09_relations.dart';
import '../dart-ui-bs/ds/ds_store.dart';
import 'gen_app_peruk09_shell.dart';
import 'package:flutter/material.dart';

void main() { registerAppRelations(appStore); runApp(const GenAppPeruk09MainScreen()); }

class GenAppPeruk09MainScreen extends StatelessWidget {
  const GenAppPeruk09MainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_peruk09_main_c0,
        ...
        home: const GenAppPeruk09ShellScreen(),
      );
}
