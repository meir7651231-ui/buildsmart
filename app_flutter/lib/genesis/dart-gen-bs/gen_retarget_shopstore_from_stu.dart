...
//   תפר-עובדות (G9b): ShopStoreFacts · count=families.length (seed-db) · מדדים 6 · hero=highN
...
class ShopStoreScreen extends StatefulWidget {
  const ShopStoreScreen({super.key, this.db}); // db מוזרק (חוק-6) — null ⇒ דאטה-האמת המובנית
