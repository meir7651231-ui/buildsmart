...
import '../dart-data-bs/auto/gen_app_tasks_main_content.dart';
import '../dart-ui-bs/ds/ds_pure.dart';
import '../dart-ui-bs/ds/ds_seam.dart';
import 'gen_app_tasks_shell.dart';
import 'package:flutter/material.dart';

void main() => runApp(const GenAppTasksMainScreen());

class GenAppTasksMainScreen extends StatelessWidget {
  const GenAppTasksMainScreen({super.key});

  @override
  Widget build(BuildContext context) => MaterialApp(
        title: gen_app_tasks_main_c0,
        ...
        home: const GenAppTasksShellScreen(),
      );
}
