    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          Row(children: [RStat(value: isValidSlug(_t2).toString(), label: gen_quest1_stat_label2)]),
          Row(children: [RStat(value: phoneRegion((isValidSlug(_t2).toString())), label: gen_quest1_stat_label3)]),
          Row(children: [RStat(value: isRtlLang((phoneRegion((isValidSlug(_t2).toString())))).toString(), label: gen_quest1_stat_label4)]),
          HeroCard(glyph: gen_quest1_card_glyph2, title: gen_quest1_card_title2, sub: gen_quest1_card_sub2, onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const GenQuest2Screen())), cardColor: BsTokens.cardLight, inkColor: BsTokens.inkLight, mutedColor: BsTokens.mutedLight, borderColor: BsTokens.divider, radius: 12),
