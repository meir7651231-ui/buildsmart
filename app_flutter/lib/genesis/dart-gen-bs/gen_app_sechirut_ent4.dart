...
class GenAppSechirutEnt4Screen extends StatefulWidget {
  const GenAppSechirutEnt4Screen({this.scopeField, this.scopeId, this.initial, this.editId, super.key});
...
class _GenAppSechirutEnt4ScreenState extends State<GenAppSechirutEnt4Screen> {
  ...
  @override
  void initState() { super.initState(); _prefill(); if (widget.editId != null) { final r = appStore.byId('app_sechirut_ent4', widget.editId!); if (r != null) WidgetsBinding.instance.addPostFrameCallback((_) { if (mounted) _edit(r); }); } }
