...
class GenAppPeruk05Ent2Screen extends StatefulWidget {
  const GenAppPeruk05Ent2Screen({this.scopeField, this.scopeId, this.initial, this.editId, super.key});
...
class _GenAppPeruk05Ent2ScreenState extends State<GenAppPeruk05Ent2Screen> {
  ...
  @override
  void initState() { super.initState(); _prefill(); if (widget.editId != null) { final r = appStore.byId('app_peruk05_ent2', widget.editId!); if (r != null) WidgetsBinding.instance.addPostFrameCallback((_) { if (mounted) _edit(r); }); } }
  ...
  Widget build(BuildContext context) {
    ...
    return DsScaffold(
      ...
      bottomBar: DsPrimaryButton(label: _editId == null ? gen_app_peruk05_ent2_c3 : gen_app_peruk05_ent2_c4, onTap: _save),
      children: [
