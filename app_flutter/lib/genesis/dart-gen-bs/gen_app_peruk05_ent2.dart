...
class GenAppPeruk05Ent2Screen extends StatefulWidget {
  const GenAppPeruk05Ent2Screen({this.scopeField, this.scopeId, super.key});
...
class _GenAppPeruk05Ent2ScreenState extends State<GenAppPeruk05Ent2Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return DsScaffold(
      ...
      children: [
        AnimatedBuilder(animation: appStore, builder: (context, _) => Padding(padding: const EdgeInsets.only(bottom: 12), child: Row(children: [Expanded(child: DsStat(label: gen_app_peruk05_ent2_c0, value: appStore.count('app_peruk05_ent2').toString(), sub: gen_app_peruk05_ent2_c17, glyph: gen_app_peruk05_ent2_c18))]))),
