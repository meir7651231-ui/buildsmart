...
// מקור: screens__gen_combined.manifest.json · המסך = דאטה; הקוד הזה = חיווט-בלבד (חוק-2).
...
class GenCombinedTokens {
  const GenCombinedTokens({required this.color});
  final Color color;
}
