...
/// StagePill — seam:series
class ForgeStagePill extends StatelessWidget {
  const ForgeStagePill({super.key});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    return Container(padding: const EdgeInsets.fromLTRB(2, 10, 2, 10), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Container(padding: const EdgeInsets.fromLTRB(11, 6, 11, 6), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Text("Label", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600))), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M9 6l6 6-6 6", skin.faint, 2, false, 24)), Container(padding: const EdgeInsets.fromLTRB(11, 6, 11, 6), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Text("Label", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600))), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M9 6l6 6-6 6", skin.faint, 2, false, 24)), Container(padding: const EdgeInsets.fromLTRB(11, 6, 11, 6), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Text("Label", style: TextStyle(color: const Color(0xFF0B0B0D), fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600))), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M9 6l6 6-6 6", skin.faint, 2, false, 24)), Container(padding: const EdgeInsets.fromLTRB(11, 6, 11, 6), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600))), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M9 6l6 6-6 6", skin.faint, 2, false, 24)), Container(padding: const EdgeInsets.fromLTRB(11, 6, 11, 6), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600)))])]));
  }
}
