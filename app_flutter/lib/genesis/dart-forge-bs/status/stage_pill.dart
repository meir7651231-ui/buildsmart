...
class ForgeStagePill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 2), child: Row(mainAxisSize: MainAxisSize.min, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M9 6l6 6-6 6", skin.mut, 2, false, 24)), Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M9 6l6 6-6 6", skin.mut, 2, false, 24)), Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M9 6l6 6-6 6", skin.mut, 2, false, 24)), Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M9 6l6 6-6 6", skin.mut, 2, false, 24)), Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w600))])]));
  }
}
