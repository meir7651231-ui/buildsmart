...
/// ProgressRing — seam:fields
class ForgeProgressRing extends StatelessWidget {
  const ForgeProgressRing({super.key});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    return Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(0, 4, 0, 4), child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, spacing: 20, children: [Container(width: 66, height: 66, child: Stack(clipBehavior: Clip.none, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.circle(33, 33, 28, skin.sunken, false, 6), _Op.arc(33, 33, 28, -3.7851, 6.2832, theme.a, 6)], 66, 66))), Positioned.fill(child: Directionality(textDirection: TextDirection.ltr, child: Container(alignment: Alignment.center, child: Text("65", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13, fontWeight: FontWeight.w700)))))])), Container(width: 66, height: 66, child: Stack(clipBehavior: Clip.none, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.circle(33, 33, 28, skin.sunken, false, 6), _Op.arc(33, 33, 28, -2.8208, 6.2832, theme.a, 6)], 66, 66))), Positioned.fill(child: Directionality(textDirection: TextDirection.ltr, child: Container(alignment: Alignment.center, child: Text("80", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13, fontWeight: FontWeight.w700)))))]))]));
  }
}
