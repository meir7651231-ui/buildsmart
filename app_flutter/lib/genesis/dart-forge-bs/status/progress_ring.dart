...
class ForgeProgressRing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(0, 4, 0, 4), child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, spacing: 20, children: [Container(width: 66, height: 66, child: Stack(clipBehavior: Clip.none, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.circle(33, 33, 28, skin.sunken, false, 6), _Op.arc(33, 33, 28, -3.7851, 6.2832, theme.a, 6)], 66, 66))), Positioned.fill(child: Container(alignment: Alignment.center, child: Text("65", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13, fontWeight: FontWeight.w700))))])), Container(width: 66, height: 66, child: Stack(clipBehavior: Clip.none, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.circle(33, 33, 28, skin.sunken, false, 6), _Op.arc(33, 33, 28, -2.8208, 6.2832, theme.a, 6)], 66, 66))), Positioned.fill(child: Container(alignment: Alignment.center, child: Text("80", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13, fontWeight: FontWeight.w700))))]))]));
  }
}
