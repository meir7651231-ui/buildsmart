...
class ForgeProgressRing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(0, 4, 0, 4), child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, spacing: 20, children: [Container(width: 66, height: 66, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 5 33 a 28 28 0 1 0 56 0 a 28 28 0 1 0 -56 0 M 5 33 a 28 28 0 1 0 56 0 a 28 28 0 1 0 -56 0", skin.mut, 1.8, false, 66)), Text("65")])), Container(width: 66, height: 66, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 5 33 a 28 28 0 1 0 56 0 a 28 28 0 1 0 -56 0 M 5 33 a 28 28 0 1 0 56 0 a 28 28 0 1 0 -56 0", skin.mut, 1.8, false, 66)), Text("80")]))]));
  }
}
