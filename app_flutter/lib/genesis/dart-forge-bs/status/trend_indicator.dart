...
class ForgeTrendIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: Wrap(spacing: 16, runSpacing: 16, crossAxisAlignment: WrapCrossAlignment.center, children: [Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [SizedBox(width: 14, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M7 17L17 7M17 7H9M17 7v8", skin.ok, false, 1.8)], 24, 24))), Text("12%", style: TextStyle(color: skin.ok, fontFamily: fonts.grotesk, fontSize: 13, fontWeight: FontWeight.w700))])), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [SizedBox(width: 14, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M7 7l10 10M17 17H9M17 17V9", skin.err, false, 1.8)], 24, 24))), Text("4%", style: TextStyle(color: skin.err, fontFamily: fonts.grotesk, fontSize: 13, fontWeight: FontWeight.w700))])), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [SizedBox(width: 14, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M5 12h14", skin.mut, false, 1.8)], 24, 24))), Text("0%", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 13, fontWeight: FontWeight.w700))]))]));
  }
}
