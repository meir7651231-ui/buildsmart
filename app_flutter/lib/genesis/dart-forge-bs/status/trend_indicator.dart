...
class ForgeTrendIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 2), child: Row(mainAxisSize: MainAxisSize.min, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M7 17L17 7M17 7H9M17 7v8", skin.mut, 1.8, false, 24)), Text("12%", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M7 7l10 10M17 17H9M17 17V9", skin.mut, 1.8, false, 24)), Text("4%", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 12h14", skin.mut, 1.8, false, 24)), Text("0%", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])]));
  }
}
