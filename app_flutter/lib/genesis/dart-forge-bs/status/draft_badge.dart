...
class ForgeDraftBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(borderRadius: BorderRadius.circular(6)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 2 2 7l10 5 10-5z", skin.ink, false, 1.8)], 24, 24))), Text("Draft", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 5))]))), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(borderRadius: BorderRadius.circular(6)), child: Text("WIP", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 5))))]));
  }
}
