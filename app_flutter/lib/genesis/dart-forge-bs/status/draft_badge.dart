...
class ForgeDraftBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(borderRadius: BorderRadius.circular(6)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 2 2 7l10 5 10-5z", skin.mut, 1.8, false, 24)), Text("Draft", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])), Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(borderRadius: BorderRadius.circular(6)), child: Text("WIP", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700)))]));
  }
}
