...
class ForgeDraftBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 2), child: Row(mainAxisSize: MainAxisSize.min, spacing: 8, children: [Container(padding: const EdgeInsets.symmetric(vertical: 3, horizontal: 8), decoration: BoxDecoration(borderRadius: BorderRadius.circular(6)), child: Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 2 2 7l10 5 10-5z", skin.mut, 1.8, false, 24)), Text("Draft", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])), Text("WIP", style: TextStyle(fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700))]));
  }
}
