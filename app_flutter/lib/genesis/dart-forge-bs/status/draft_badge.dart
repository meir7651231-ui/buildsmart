...
class ForgeDraftBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: Wrap(spacing: 8, runSpacing: 8, crossAxisAlignment: WrapCrossAlignment.center, children: [Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.warn.withValues(alpha: 0.13), border: Border.all(color: skin.warn.withValues(alpha: 0.28)), borderRadius: BorderRadius.circular(6)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 2 2 7l10 5 10-5z", skin.warn, false, 1.8)], 24, 24))), Text("Draft", style: TextStyle(color: skin.warn, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))]))), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.mut.withValues(alpha: 0.13), border: Border.all(color: skin.mut.withValues(alpha: 0.28)), borderRadius: BorderRadius.circular(6)), child: Text("WIP", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))))]));
  }
}
