...
class ForgeHierarchyChipPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Container(constraints: const BoxConstraints(minHeight: 26), padding: const EdgeInsets.fromLTRB(11, 5, 11, 5), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 10.5, fontWeight: FontWeight.w700))), Container(constraints: const BoxConstraints(minHeight: 26), padding: const EdgeInsets.fromLTRB(11, 5, 11, 5), decoration: BoxDecoration(borderRadius: BorderRadius.circular(7)), child: Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 10.5, fontWeight: FontWeight.w700)))]));
  }
}
