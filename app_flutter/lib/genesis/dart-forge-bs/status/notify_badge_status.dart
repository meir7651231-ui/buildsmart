...
/// NotifyBadge — seam:fields · 2 חריצים
class ForgeNotifyBadgeStatus extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["8", "24"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeNotifyBadgeStatus({super.key, this.fields, this.child, this.items});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: _withChild(Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 18, children: [...(items == null ? <Widget>[_hide(_f(0, "8"), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.path("M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9", skin.mut, false, 1.8), _Op.path("M10 21a2 2 0 0 0 4 0", skin.mut, false, 1.8)], 24, 24))), Positioned(top: -6, left: -6, width: 18, child: _hide(_f(0, "8"), Directionality(textDirection: TextDirection.ltr, child: Container(height: 18, constraints: const BoxConstraints(minWidth: 18), padding: const EdgeInsets.fromLTRB(5, 0, 5, 0), decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(999)), child: Center(widthFactor: 1.0, child: Text(_f(0, "8"), style: TextStyle(color: const Color(0xFFFFFFFF), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700)))))))]))), _hide(_f(1, "24"), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.path("M4 4h16v12H7l-3 3z", skin.mut, false, 1.8)], 24, 24))), Positioned(top: -6, left: -6, width: 18, child: _hide(_f(1, "24"), Directionality(textDirection: TextDirection.ltr, child: Container(height: 18, constraints: const BoxConstraints(minWidth: 18), padding: const EdgeInsets.fromLTRB(5, 0, 5, 0), decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(999)), child: Center(widthFactor: 1.0, child: Text(_f(1, "24"), style: TextStyle(color: const Color(0xFFFFFFFF), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700)))))))])))] : List<Widget>.generate(items!.length, (i) => Flexible(child: _hide(_it(items![i], 0, "8"), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.path("M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9", skin.mut, false, 1.8), _Op.path("M10 21a2 2 0 0 0 4 0", skin.mut, false, 1.8)], 24, 24))), Positioned(top: -6, left: -6, width: 18, child: _hide(_it(items![i], 0, "8"), Directionality(textDirection: TextDirection.ltr, child: Container(height: 18, constraints: const BoxConstraints(minWidth: 18), padding: const EdgeInsets.fromLTRB(5, 0, 5, 0), decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(999)), child: Center(widthFactor: 1.0, child: Text(_it(items![i], 0, "8"), style: TextStyle(color: const Color(0xFFFFFFFF), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700)))))))]))))))]), child));
    return body;
  }
}
