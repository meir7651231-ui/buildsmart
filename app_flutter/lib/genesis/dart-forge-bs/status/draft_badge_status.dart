...
/// DraftBadge — seam:fields · 2 חריצים
class ForgeDraftBadgeStatus extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["DRAFT", "WIP"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  /// G13d · וריאנט-פריט (טוקן-עיצוב: ["tone-warn","tone-neutral"]) — variants[i] = אינדקס-הוריאנט של פריט i; null ⇒ הראשון.
  final List<int>? variants;
  static const List<String> variantIds = <String>["tone-warn", "tone-neutral"];
  ...
  const ForgeDraftBadgeStatus({super.key, this.fields, this.child, this.items, this.variants});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: _withChild(Wrap(spacing: 8, runSpacing: 8, crossAxisAlignment: WrapCrossAlignment.center, children: [...(items == null ? <Widget>[Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.warn.withValues(alpha: 0.130), border: Border.all(color: skin.warn.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 24.0; return SizedBox(width: _w, height: _w / 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 2 2 7l10 5 10-5z", skin.warn, false, 1.8)], 24, 24))); }), Text(_f(0, "DRAFT"), style: TextStyle(color: skin.warn, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))]))), _hide(_f(1, "WIP"), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.mut.withValues(alpha: 0.130), border: Border.all(color: skin.mut.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Text(_f(1, "WIP"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5)))))] : List<Widget>.generate(items!.length, (i) => (switch ((variants != null && i < variants!.length) ? variants![i] : 0) { 0 => Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.warn.withValues(alpha: 0.130), border: Border.all(color: skin.warn.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 24.0; return SizedBox(width: _w, height: _w / 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 2 2 7l10 5 10-5z", skin.warn, false, 1.8)], 24, 24))); }), Text(_it(items![i], 0, "DRAFT"), style: TextStyle(color: skin.warn, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))]))), 1 => _hide(_it(items![i], 0, "WIP"), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.mut.withValues(alpha: 0.130), border: Border.all(color: skin.mut.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Text(_it(items![i], 0, "WIP"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))))), _ => Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.warn.withValues(alpha: 0.130), border: Border.all(color: skin.warn.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 24.0; return SizedBox(width: _w, height: _w / 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 2 2 7l10 5 10-5z", skin.warn, false, 1.8)], 24, 24))); }), Text(_it(items![i], 0, "DRAFT"), style: TextStyle(color: skin.warn, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))]))) })))]), child));
    return body;
  }
}
