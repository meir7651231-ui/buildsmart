...
class ForgeRadialGauge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(0, 4, 0, 4), child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, spacing: 20, children: [Container(width: 112, height: 112, child: Stack(clipBehavior: Clip.none, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.circle(56, 56, 46, skin.sunken, false, 9), _Op.arc(56, 56, 46, -3.3099, 6.2826, theme.a, 9)], 112, 112))), Positioned.fill(child: Container(alignment: Alignment.center, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Directionality(textDirection: TextDirection.ltr, child: Text("72", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 23, fontWeight: FontWeight.w700, height: 1))), Directionality(textDirection: TextDirection.ltr, child: Text("LABEL", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 8.5, letterSpacing: 1)))])))]))]));
  }
}
