...
class ForgeStatTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 5, children: [Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 11, fontWeight: FontWeight.w600)), Text("248", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 30, fontWeight: FontWeight.w700, letterSpacing: 02, height: 1)), Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [CustomPaint(size: const Size(12, 12), painter: _SvgPaint("M7 17L17 7M17 7H9M17 7v8", skin.ok, 1.8, false, 24)), Text("8%", style: TextStyle(color: skin.ok, fontFamily: fonts.he))])]));
  }
}
