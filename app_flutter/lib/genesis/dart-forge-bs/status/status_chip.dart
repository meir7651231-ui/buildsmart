...
class ForgeStatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 10, children: [Container(constraints: const BoxConstraints(minHeight: 26), padding: const EdgeInsets.fromLTRB(11, 5, 11, 5), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [Container(width: 6, height: 6, decoration: BoxDecoration(borderRadius: BorderRadius.circular(50))), Text("Label · info", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])), Container(constraints: const BoxConstraints(minHeight: 26), padding: const EdgeInsets.fromLTRB(11, 5, 11, 5), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 13l4 4L19 7", skin.ink, 1.8, false, 24)), Text("Label · success", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])), Container(constraints: const BoxConstraints(minHeight: 26), padding: const EdgeInsets.fromLTRB(11, 5, 11, 5), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 9v4M12 17h.01M10.3 4.3 2.6 18a2 2 0 0 0 1.7 3h15.4a2 2 0 0 0 1.7-3L13.7 4.3a2 2 0 0 0-3.4 0Z", skin.ink, 1.8, false, 24)), Text("Label · warning", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])), Container(constraints: const BoxConstraints(minHeight: 26), padding: const EdgeInsets.fromLTRB(11, 5, 11, 5), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 8v5M12 17h.01 M 3 12 a 9 9 0 1 0 18 0 a 9 9 0 1 0 -18 0", skin.ink, 1.8, false, 24)), Text("Label · error", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])), Container(constraints: const BoxConstraints(minHeight: 26), padding: const EdgeInsets.fromLTRB(11, 5, 11, 5), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [Container(width: 6, height: 6, decoration: BoxDecoration(borderRadius: BorderRadius.circular(50))), Text("Label · neutral", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]))]));
  }
}
