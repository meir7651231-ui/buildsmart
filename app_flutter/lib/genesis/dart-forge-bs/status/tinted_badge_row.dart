...
class ForgeTintedBadgeRow extends StatelessWidget {
  ...
  /// G13d · וריאנט-פריט (טוקן-עיצוב: ["tone-info","tone-neutral","tone-err"]) — variants[i] = אינדקס-הוריאנט של פריט i; null ⇒ הראשון.
  final List<int>? variants;
  static const List<String> variantIds = <String>["tone-info", "tone-neutral", "tone-err"];
  ...
  const ForgeTintedBadgeRow({super.key, this.fields, this.child, this.items, this.variants});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: _withChild(Wrap(spacing: 8, runSpacing: 8, crossAxisAlignment: WrapCrossAlignment.center, children: [...(items == null ? <Widget>[_hide(_f(0, "LABEL 3"), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: theme.aHi.withValues(alpha: 0.130), border: Border.all(color: theme.aHi.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Text(_f(0, "LABEL 3"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))))), _hide(_f(1, "LABEL 12"), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.mut.withValues(alpha: 0.130), border: Border.all(color: skin.mut.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Text(_f(1, "LABEL 12"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))))), _hide(_f(2, "LABEL 99+"), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.err.withValues(alpha: 0.130), border: Border.all(color: skin.err.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Text(_f(2, "LABEL 99+"), style: TextStyle(color: skin.err, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5)))))] : List<Widget>.generate(items!.length, (i) => (switch ((variants != null && i < variants!.length) ? variants![i] : 0) { 0 => _hide(_it(items![i], 0, "LABEL 3"), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: theme.aHi.withValues(alpha: 0.130), border: Border.all(color: theme.aHi.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Text(_it(items![i], 0, "LABEL 3"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))))), 1 => _hide(_it(items![i], 0, "LABEL 12"), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.mut.withValues(alpha: 0.130), border: Border.all(color: skin.mut.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Text(_it(items![i], 0, "LABEL 12"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))))), 2 => _hide(_it(items![i], 0, "LABEL 99+"), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.err.withValues(alpha: 0.130), border: Border.all(color: skin.err.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Text(_it(items![i], 0, "LABEL 99+"), style: TextStyle(color: skin.err, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))))), _ => _hide(_it(items![i], 0, "LABEL 3"), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: theme.aHi.withValues(alpha: 0.130), border: Border.all(color: theme.aHi.withValues(alpha: 0.280)), borderRadius: BorderRadius.circular(6)), child: Text(_it(items![i], 0, "LABEL 3"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.5))))) })))]), child));
    return body;
  }
}
