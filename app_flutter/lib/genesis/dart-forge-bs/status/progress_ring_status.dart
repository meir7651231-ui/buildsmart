...
class ForgeProgressRingStatus extends StatelessWidget {
  ...
  const ForgeProgressRingStatus({super.key, this.fields});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    return Container(padding: const EdgeInsets.fromLTRB(0, 4, 0, 4), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Wrap(spacing: 20, runSpacing: 20, crossAxisAlignment: WrapCrossAlignment.center, children: [Container(width: 66, height: 66, child: Stack(clipBehavior: Clip.none, children: [LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 66.0; return SizedBox(width: _w, height: _w / 1.0000, child: CustomPaint(painter: _SvgScene([_Op.circle(33, 33, 28, skin.sunken, false, 6), _Op.arc(33, 33, 28, -1.5708, 4.0689, theme.a, 6)], 66, 66))); }), Positioned.fill(child: Directionality(textDirection: TextDirection.ltr, child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Text(_f(0, "65"), style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 13, fontWeight: FontWeight.w700)))))])), Container(width: 66, height: 66, child: Stack(clipBehavior: Clip.none, children: [LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 66.0; return SizedBox(width: _w, height: _w / 1.0000, child: CustomPaint(painter: _SvgScene([_Op.circle(33, 33, 28, skin.sunken, false, 6), _Op.arc(33, 33, 28, -1.5708, 5.0332, theme.a, 6)], 66, 66))); }), Positioned.fill(child: Directionality(textDirection: TextDirection.ltr, child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Text(_f(1, "80"), style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 13, fontWeight: FontWeight.w700)))))]))])));
  }
}
