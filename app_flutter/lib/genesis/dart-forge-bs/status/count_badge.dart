...
class ForgeCountBadge extends StatelessWidget {
  ...
  const ForgeCountBadge({super.key, this.child, this.items});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: _withChild(Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 18, children: [...(items == null ? <Widget>[Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2, skin.mut, false, 1.8), _Op.path("M3 8h18", skin.mut, false, 1.8)], 24, 24))), Positioned(top: -2, right: -2, width: 10, child: Container(width: 10, height: 10, decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(999))))])), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 8, 4, skin.mut, false, 1.8), _Op.path("M4 20a8 8 0 0 1 16 0", skin.mut, false, 1.8)], 24, 24))), Positioned(top: -2, right: -2, width: 10, child: Container(width: 10, height: 10, decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(999))))]))] : List<Widget>.generate(items!.length, (i) => Flexible(child: Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2, skin.mut, false, 1.8), _Op.path("M3 8h18", skin.mut, false, 1.8)], 24, 24))), Positioned(top: -2, right: -2, width: 10, child: Container(width: 10, height: 10, decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(999))))])))))]), child));
    return body;
  }
}
