...
class ForgeCountBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(2, 8, 2, 8), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 18, children: [Container(width: 40, height: 40, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Stack(clipBehavior: Clip.none, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 4 h 18 v 16 h -18 Z M3 8h18", skin.mut, 1.8, false, 24)), Positioned(top: -2, left: -2, child: Container(width: 10, height: 10, decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(50))))])), Container(width: 40, height: 40, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Stack(clipBehavior: Clip.none, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 8 8 a 4 4 0 1 0 8 0 a 4 4 0 1 0 -8 0 M4 20a8 8 0 0 1 16 0", skin.mut, 1.8, false, 24)), Positioned(top: -2, left: -2, child: Container(width: 10, height: 10, decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(50))))]))]));
  }
}
