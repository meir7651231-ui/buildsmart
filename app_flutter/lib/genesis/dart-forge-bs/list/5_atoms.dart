...
class Forge5Atoms extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(15)), child: Container(padding: const EdgeInsets.symmetric(vertical: 11, horizontal: 15), child: Row(mainAxisSize: MainAxisSize.min, spacing: 12, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 5v14M5 12h14", skin.mut, 1.8, false, 24)), Row(mainAxisSize: MainAxisSize.min, spacing: 14, children: [Text("inherit ActionRow →"), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("SettingsActionRow"), Text("ChatSettingsActionRow"), Text("StoreSettingsActionRow"), Text("ManageRow"), Text("StockRow")])])])));
  }
}
