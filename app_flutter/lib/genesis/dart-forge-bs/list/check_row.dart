...
class ForgeCheckRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(15)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(constraints: const BoxConstraints(minHeight: 52), padding: const EdgeInsets.fromLTRB(15, 12, 15, 12), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 22, height: 22, alignment: Alignment.center, decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair, width: 1.6), borderRadius: BorderRadius.circular(6)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 14, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M5 12l5 5 9-11", const Color(0xFF0B0B0D), false, 1.8)], 24, 24))), Positioned.fill(child: const SizedBox.shrink())])), Expanded(child: Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 13.5, fontWeight: FontWeight.w600, height: 1.25, leadingDistribution: TextLeadingDistribution.even))), Directionality(textDirection: TextDirection.ltr, child: Text("248", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 13, fontWeight: FontWeight.w600)))])), Container(constraints: const BoxConstraints(minHeight: 52), padding: const EdgeInsets.fromLTRB(15, 12, 15, 12), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 22, height: 22, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair, width: 1.6), borderRadius: BorderRadius.circular(6)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 14, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M5 12l5 5 9-11", const Color(0x00000000), false, 1.8)], 24, 24))), Positioned.fill(child: const SizedBox.shrink())])), Expanded(child: Text.rich(TextSpan(children: [TextSpan(text: "Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 13.5, fontWeight: FontWeight.w600, height: 1.25, leadingDistribution: TextLeadingDistribution.even)), TextSpan(text: "Meta", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 11))])))])), Container(constraints: const BoxConstraints(minHeight: 52), padding: const EdgeInsets.fromLTRB(15, 12, 15, 12), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 22, height: 22, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair, width: 1.6), borderRadius: BorderRadius.circular(6)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 14, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M5 12l5 5 9-11", const Color(0x00000000), false, 1.8)], 24, 24))), Positioned.fill(child: const SizedBox.shrink())])), Expanded(child: Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 13.5, fontWeight: FontWeight.w600, height: 1.25, leadingDistribution: TextLeadingDistribution.even))), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(8, 3, 8, 3), decoration: BoxDecoration(color: skin.warn.withValues(alpha: 0.140), border: Border.all(color: skin.warn.withValues(alpha: 0.300)), borderRadius: BorderRadius.circular(999)), child: Text("Meta", style: TextStyle(color: skin.warn, fontFamily: fonts.grotesk, fontSize: 9, fontWeight: FontWeight.w700, letterSpacing: 0.5))))]))]));
  }
}
