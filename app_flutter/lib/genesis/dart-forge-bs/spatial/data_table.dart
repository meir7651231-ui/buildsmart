...
class ForgeDataTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 0, 13, 0), decoration: BoxDecoration(color: skin.surface, border: Border(bottom: BorderSide(color: skin.hair, width: 1))), child: Row(crossAxisAlignment: CrossAxisAlignment.center, spacing: 10, children: [Expanded(flex: 2, child: Text("LABEL", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.76))), Expanded(flex: 1, child: Directionality(textDirection: TextDirection.ltr, child: Container(constraints: const BoxConstraints(minHeight: 44), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("VALUE", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.76)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 6l4-4 4 4", skin.faint, false, 1.8)], 12, 8))), SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 2l4 4 4-4", theme.aHi, false, 1.8)], 12, 8)))])]))))), Expanded(flex: 1, child: Text("META", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.76))), Expanded(flex: 1, child: Text("STATUS", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 0.76)))])), Container(constraints: const BoxConstraints(minHeight: 42), padding: const EdgeInsets.fromLTRB(13, 0, 13, 0), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(crossAxisAlignment: CrossAxisAlignment.center, spacing: 10, children: [Expanded(flex: 2, child: Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12.5))), Expanded(flex: 1, child: Directionality(textDirection: TextDirection.ltr, child: Text("1,024", textAlign: TextAlign.left, style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 12.5, fontWeight: FontWeight.w600, fontFeatures: const [FontFeature.tabularFigures()])))), Expanded(flex: 1, child: Text("Meta", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 11.5))), Expanded(flex: 1, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 7, children: [Container(width: 8, height: 8, decoration: BoxDecoration(color: skin.ok, borderRadius: BorderRadius.circular(999))), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 10.5))]))])), Container(constraints: const BoxConstraints(minHeight: 42), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.120), border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Stack(clipBehavior: Clip.none, children: [Padding(padding: const EdgeInsets.fromLTRB(13, 0, 13, 0), child: Row(crossAxisAlignment: CrossAxisAlignment.center, spacing: 10, children: [Expanded(flex: 2, child: Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12.5))), Expanded(flex: 1, child: Directionality(textDirection: TextDirection.ltr, child: Text("512", textAlign: TextAlign.left, style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 12.5, fontWeight: FontWeight.w600, fontFeatures: const [FontFeature.tabularFigures()])))), Expanded(flex: 1, child: Text("Meta", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 11.5))), Expanded(flex: 1, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 7, children: [Container(width: 8, height: 8, decoration: BoxDecoration(color: skin.warn, borderRadius: BorderRadius.circular(999))), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 10.5))]))])), Positioned(top: 0, bottom: 0, right: 0, width: 3, child: Container(width: 3, decoration: BoxDecoration(color: theme.a)))])), Container(constraints: const BoxConstraints(minHeight: 42), padding: const EdgeInsets.fromLTRB(13, 0, 13, 0), decoration: BoxDecoration(color: const Color(0x05ECE9E2), border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(crossAxisAlignment: CrossAxisAlignment.center, spacing: 10, children: [Expanded(flex: 2, child: Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12.5))), Expanded(flex: 1, child: Directionality(textDirection: TextDirection.ltr, child: Text("248", textAlign: TextAlign.left, style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 12.5, fontWeight: FontWeight.w600, fontFeatures: const [FontFeature.tabularFigures()])))), Expanded(flex: 1, child: Text("Meta", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 11.5))), Expanded(flex: 1, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 7, children: [Container(width: 8, height: 8, decoration: BoxDecoration(color: skin.ok, borderRadius: BorderRadius.circular(999))), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 10.5))]))])), Container(constraints: const BoxConstraints(minHeight: 42), padding: const EdgeInsets.fromLTRB(13, 0, 13, 0), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(crossAxisAlignment: CrossAxisAlignment.center, spacing: 10, children: [Expanded(flex: 2, child: Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12.5))), Expanded(flex: 1, child: Directionality(textDirection: TextDirection.ltr, child: Text("92", textAlign: TextAlign.left, style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 12.5, fontWeight: FontWeight.w600, fontFeatures: const [FontFeature.tabularFigures()])))), Expanded(flex: 1, child: Text("Meta", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 11.5))), Expanded(flex: 1, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 7, children: [Container(width: 8, height: 8, decoration: BoxDecoration(color: skin.err, borderRadius: BorderRadius.circular(999))), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 10.5))]))])), Container(constraints: const BoxConstraints(minHeight: 42), padding: const EdgeInsets.fromLTRB(13, 0, 13, 0), decoration: BoxDecoration(color: const Color(0x05ECE9E2), border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(crossAxisAlignment: CrossAxisAlignment.center, spacing: 10, children: [Expanded(flex: 2, child: Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12.5))), Expanded(flex: 1, child: Directionality(textDirection: TextDirection.ltr, child: Text("37", textAlign: TextAlign.left, style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 12.5, fontWeight: FontWeight.w600, fontFeatures: const [FontFeature.tabularFigures()])))), Expanded(flex: 1, child: Text("Meta", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 11.5))), Expanded(flex: 1, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 7, children: [Container(width: 8, height: 8, decoration: BoxDecoration(color: skin.ok, borderRadius: BorderRadius.circular(999))), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 10.5))]))]))])));
  }
}
