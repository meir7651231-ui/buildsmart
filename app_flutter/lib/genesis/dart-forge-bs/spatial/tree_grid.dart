...
class ForgeTreeGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.all(16), child: Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Container(padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 13), child: Row(mainAxisSize: MainAxisSize.min, spacing: 9, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M4 2l5 4-5 4", skin.mut, 2.2, false, 12)), Text("Label"), Text("1,024", style: TextStyle(fontFamily: fonts.grotesk, fontFeatures: const [FontFeature.tabularFigures()]))])), Container(padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 13), child: Row(mainAxisSize: MainAxisSize.min, spacing: 9, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M4 2l5 4-5 4", skin.mut, 2.2, false, 12)), Text("Label"), Text("640", style: TextStyle(fontFamily: fonts.grotesk, fontFeatures: const [FontFeature.tabularFigures()]))])), Container(padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 13), child: Row(mainAxisSize: MainAxisSize.min, spacing: 9, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M4 2l5 4-5 4", skin.mut, 1.8, false, 12)), Text("Label"), Text("248", style: TextStyle(fontFamily: fonts.grotesk, fontFeatures: const [FontFeature.tabularFigures()]))])), Container(padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 13), child: Row(mainAxisSize: MainAxisSize.min, spacing: 9, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M4 2l5 4-5 4", skin.mut, 1.8, false, 12)), Text("Label"), Text("392", style: TextStyle(fontFamily: fonts.grotesk, fontFeatures: const [FontFeature.tabularFigures()]))])), Container(padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 13), child: Row(mainAxisSize: MainAxisSize.min, spacing: 9, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M4 2l5 4-5 4", skin.mut, 2.2, false, 12)), Text("Label"), Text("384", style: TextStyle(fontFamily: fonts.grotesk, fontFeatures: const [FontFeature.tabularFigures()]))])), Container(padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 13), child: Row(mainAxisSize: MainAxisSize.min, spacing: 9, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M4 2l5 4-5 4", skin.mut, 1.8, false, 12)), Text("Label"), Text("240", style: TextStyle(fontFamily: fonts.grotesk, fontFeatures: const [FontFeature.tabularFigures()]))]))])));
  }
}
