...
class ForgeTreeGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(constraints: const BoxConstraints(minHeight: 40), padding: const EdgeInsets.fromLTRB(13, 0, 13, 0), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 9, children: [Container(width: 15, height: 15, alignment: Alignment.center, child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [Padding(padding: const EdgeInsets.fromLTRB(0, 0, 0, 0), child: SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M4 2l5 4-5 4", theme.aHi, false, 1.8)], 12, 12)))), Positioned.fill(child: const SizedBox.shrink())])), Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12.5)), Directionality(textDirection: TextDirection.ltr, child: Text("1,024", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 12, fontWeight: FontWeight.w600, fontFeatures: const [FontFeature.tabularFigures()])))])), Container(constraints: const BoxConstraints(minHeight: 40), padding: const EdgeInsets.fromLTRB(13, 0, 34, 0), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 9, children: [Container(width: 15, height: 15, alignment: Alignment.center, child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [Padding(padding: const EdgeInsets.fromLTRB(0, 0, 0, 0), child: SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M4 2l5 4-5 4", theme.aHi, false, 1.8)], 12, 12)))), Positioned.fill(child: const SizedBox.shrink())])), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12.5)), Directionality(textDirection: TextDirection.ltr, child: Text("640", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 12, fontFeatures: const [FontFeature.tabularFigures()])))])), Container(constraints: const BoxConstraints(minHeight: 40), padding: const EdgeInsets.fromLTRB(13, 0, 55, 0), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 9, children: [Opacity(opacity: 0, child: Container(width: 15, height: 15, alignment: Alignment.center, child: SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M4 2l5 4-5 4", skin.mut, false, 1.8)], 12, 12))))), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12)), Directionality(textDirection: TextDirection.ltr, child: Text("248", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 12, fontFeatures: const [FontFeature.tabularFigures()])))])), Container(constraints: const BoxConstraints(minHeight: 40), padding: const EdgeInsets.fromLTRB(13, 0, 55, 0), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 9, children: [Opacity(opacity: 0, child: Container(width: 15, height: 15, alignment: Alignment.center, child: SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M4 2l5 4-5 4", skin.mut, false, 1.8)], 12, 12))))), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12)), Directionality(textDirection: TextDirection.ltr, child: Text("392", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 12, fontFeatures: const [FontFeature.tabularFigures()])))])), Container(constraints: const BoxConstraints(minHeight: 40), padding: const EdgeInsets.fromLTRB(13, 0, 13, 0), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 9, children: [Container(width: 15, height: 15, alignment: Alignment.center, child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [Padding(padding: const EdgeInsets.fromLTRB(0, 0, 0, 0), child: SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M4 2l5 4-5 4", skin.mut, false, 1.8)], 12, 12)))), Positioned.fill(child: const SizedBox.shrink())])), Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12.5)), Directionality(textDirection: TextDirection.ltr, child: Text("384", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 12, fontWeight: FontWeight.w600, fontFeatures: const [FontFeature.tabularFigures()])))])), Container(constraints: const BoxConstraints(minHeight: 40), padding: const EdgeInsets.fromLTRB(13, 0, 34, 0), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 9, children: [Opacity(opacity: 0, child: Container(width: 15, height: 15, alignment: Alignment.center, child: SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M4 2l5 4-5 4", skin.mut, false, 1.8)], 12, 12))))), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12.5)), Directionality(textDirection: TextDirection.ltr, child: Text("240", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 12, fontFeatures: const [FontFeature.tabularFigures()])))]))])));
  }
}
