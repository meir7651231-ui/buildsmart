...
class ForgeMarkerStates extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 14, children: [Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z M -3.6 -16 a 3.6 3.6 0 1 0 7.2 0 a 3.6 3.6 0 1 0 -7.2 0", skin.mut, 1.8, false, 30)), Text("default", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z M -3.6 -16 a 3.6 3.6 0 1 0 7.2 0 a 3.6 3.6 0 1 0 -7.2 0", skin.mut, 1.8, false, 30)), Text("selected", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M NaN NaN a 14 14 0 1 0 28 0 a 14 14 0 1 0 -28 0", skin.mut, 1.8, false, 32)), Text("cluster", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z M -3.6 -16 a 3.6 3.6 0 1 0 7.2 0 a 3.6 3.6 0 1 0 -7.2 0", skin.mut, 1.8, false, 30)), Text("disabled", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])]));
  }
}
