...
/// Marker states — seam:fields · 4 חריצים
class ForgeMarkerStates extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["DEFAULT", "SELECTED", "CLUSTER", "DISABLED"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeMarkerStates({super.key, this.fields, this.child, this.bare = false, this.items});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget core = Wrap(spacing: 14, runSpacing: 14, crossAxisAlignment: WrapCrossAlignment.start, children: [...(items == null ? <Widget>[_hide(_f(0, "DEFAULT"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 30, height: 38, child: CustomPaint(painter: _SvgScene([_Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", skin.surface, true, 1.6), _Op.circle(0, -16, 3.6, theme.a, true, 1.8)], 30, 32))), Text(_f(0, "DEFAULT"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))])), _hide(_f(1, "SELECTED"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 30, height: 38, child: CustomPaint(painter: _SvgScene([_Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", theme.a, true, 2), _Op.circle(0, -16, 3.6, const Color(0xFF0B0B0D), true, 1.8)], 30, 32))), Text(_f(1, "SELECTED"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))])), _hide(_f(2, "CLUSTER"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 30, height: 38, child: CustomPaint(painter: _SvgScene([_Op.circle(0, 0, 14, theme.a, true, 1.8), _Op.text("12", 0, 0, 11, const Color(0xFF0B0B0D), 1, fonts.grotesk)], 32, 32))), Text(_f(2, "CLUSTER"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))])), _hide(_f(3, "DISABLED"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 30, height: 38, child: CustomPaint(painter: _SvgScene([_Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", const Color(0x00000000), true, 1.6), _Op.circle(0, -16, 3.6, skin.faint, true, 1.8)], 30, 32))), Text(_f(3, "DISABLED"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]))] : List<Widget>.generate(items!.length, (i) => _hide(_it(items![i], 0, "DEFAULT"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 30, height: 38, child: CustomPaint(painter: _SvgScene([_Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", skin.surface, true, 1.6), _Op.circle(0, -16, 3.6, theme.a, true, 1.8)], 30, 32))), Text(_it(items![i], 0, "DEFAULT"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]))))]);
