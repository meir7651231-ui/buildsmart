...
/// Marker states — seam:fields · 5 חריצים
class ForgeMarkerStates extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["DEFAULT", "SELECTED", "12", "CLUSTER", "DISABLED"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
