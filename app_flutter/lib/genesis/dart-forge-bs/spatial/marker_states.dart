...
class ForgeMarkerStates extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Wrap(spacing: 14, runSpacing: 14, crossAxisAlignment: WrapCrossAlignment.start, children: [Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 30, height: 38, child: CustomPaint(painter: _SvgScene([_Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", skin.surface, true, 1.6), _Op.circle(0, -16, 3.6, theme.a, true, 1.8)], 30, 32))), Text("DEFAULT", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 30, height: 38, child: CustomPaint(painter: _SvgScene([_Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", theme.a, true, 2), _Op.circle(0, -16, 3.6, const Color(0xFF0B0B0D), true, 1.8)], 30, 32))), Text("SELECTED", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 30, height: 38, child: CustomPaint(painter: _SvgScene([_Op.circle(0, 0, 14, theme.a, true, 1.8), _Op.text("12", 0, 0, 11, const Color(0xFF0B0B0D), 1, fonts.grotesk)], 32, 32))), Text("CLUSTER", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 30, height: 38, child: CustomPaint(painter: _SvgScene([_Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", const Color(0x00000000), true, 1.6), _Op.circle(0, -16, 3.6, skin.faint, true, 1.8)], 30, 32))), Text("DISABLED", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))])]));
  }
}
