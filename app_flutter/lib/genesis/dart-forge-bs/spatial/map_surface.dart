...
/// MapSurface — seam:fields · 1 חריצים
class ForgeMapSurface extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["12"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  final bool bare;
  const ForgeMapSurface({super.key, this.fields, this.child, this.bare = false});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget core = Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 440.0; return SizedBox(width: _w, height: _w / 1.8803, child: CustomPaint(painter: _SvgScene([_Op.line(0, 58, 440, 58, skin.hair2, 1.8), _Op.line(0, 117, 440, 117, skin.hair2, 1.8), _Op.line(0, 176, 440, 176, skin.hair2, 1.8), _Op.line(88, 0, 88, 234, skin.hair2, 1.8), _Op.line(176, 0, 176, 234, skin.hair2, 1.8), _Op.line(264, 0, 264, 234, skin.hair2, 1.8), _Op.line(352, 0, 352, 234, skin.hair2, 1.8), _Op.path("M40 150 C70 96 120 84 168 104 C210 121 214 70 268 74 C332 79 356 118 402 108 L420 150 C388 196 300 210 236 196 C168 181 92 210 52 182 Z", skin.ink.withValues(alpha: 0.03), true, 1), _Op.path("M 66 178 L 150 120 L 232 150 L 322 92 L 398 120", theme.a.withValues(alpha: 0.90), false, 2), _Op.circle(66, 178, 3, theme.aHi, true, 1.8), _Op.circle(232, 150, 3, theme.aHi, true, 1.8), _Op.circle(398, 120, 3, theme.aHi, true, 1.8), _Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", skin.surface, true, 1.6), _Op.circle(0, -16, 3.6, theme.a, true, 1.8), _Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", skin.surface, true, 1.6), _Op.circle(0, -16, 3.6, theme.a, true, 1.8), _Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", theme.a, true, 2), _Op.circle(0, -16, 3.6, skin.onA, true, 1.8), _Op.circle(0, 0, 15, theme.a, true, 1.8), _Op.text(_f(0, "12"), 0, 0, 12, skin.onA, 1, fonts.grotesk)], 440, 234))); }));
