...
class ForgeMapSurface extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: SizedBox(width: double.infinity, child: Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: FractionallySizedBox(widthFactor: 1.000, heightFactor: 1.000, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 440, height: 234, child: CustomPaint(painter: _SvgScene([_Op.line(0, 58, 440, 58, skin.hair2, 1.8), _Op.line(0, 117, 440, 117, skin.hair2, 1.8), _Op.line(0, 176, 440, 176, skin.hair2, 1.8), _Op.line(88, 0, 88, 234, skin.hair2, 1.8), _Op.line(176, 0, 176, 234, skin.hair2, 1.8), _Op.line(264, 0, 264, 234, skin.hair2, 1.8), _Op.line(352, 0, 352, 234, skin.hair2, 1.8), _Op.path("M40 150 C70 96 120 84 168 104 C210 121 214 70 268 74 C332 79 356 118 402 108 L420 150 C388 196 300 210 236 196 C168 181 92 210 52 182 Z", const Color(0x08ECE9E2), true, 1), _Op.path("M 66 178 L 150 120 L 232 150 L 322 92 L 398 120", theme.a, false, 2), _Op.circle(66, 178, 3, theme.aHi, true, 1.8), _Op.circle(232, 150, 3, theme.aHi, true, 1.8), _Op.circle(398, 120, 3, theme.aHi, true, 1.8), _Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", skin.surface, true, 1.6), _Op.circle(0, -16, 3.6, theme.a, true, 1.8), _Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", skin.surface, true, 1.6), _Op.circle(0, -16, 3.6, theme.a, true, 1.8), _Op.path("M0 0 C-9 -15 -9 -24 0 -24 C9 -24 9 -15 0 0 Z", theme.a, true, 2), _Op.circle(0, -16, 3.6, const Color(0xFF0B0B0D), true, 1.8), _Op.circle(0, 0, 15, theme.a, true, 1.8), _Op.text("12", 0, 0, 12, const Color(0xFF0B0B0D), 1, fonts.grotesk)], 440, 234))))))));
  }
}
