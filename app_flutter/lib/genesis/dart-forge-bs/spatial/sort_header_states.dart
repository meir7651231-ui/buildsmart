...
class ForgeSortHeaderStates extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 18, children: [Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("Value", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 6l4-4 4 4", skin.mut, 2.4, false, 12)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 2l4 4 4-4", skin.mut, 2.4, false, 12))])]), Text("unsorted", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("Value", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 6l4-4 4 4", skin.mut, 2.4, false, 12)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 2l4 4 4-4", skin.mut, 2.4, false, 12))])]), Text("ascending", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("Value", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 6l4-4 4 4", skin.mut, 2.4, false, 12)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 2l4 4 4-4", skin.mut, 2.4, false, 12))])]), Text("descending", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])]));
  }
}
