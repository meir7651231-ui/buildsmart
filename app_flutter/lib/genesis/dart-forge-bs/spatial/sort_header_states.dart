...
/// SortHeader states — seam:fields · 6 חריצים
class ForgeSortHeaderStates extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["VALUE", "UNSORTED", "VALUE", "ASCENDING", "VALUE", "DESCENDING"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeSortHeaderStates({super.key, this.fields, this.child, this.bare = false, this.items});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget core = Wrap(spacing: 18, runSpacing: 18, crossAxisAlignment: WrapCrossAlignment.start, children: [...(items == null ? <Widget>[Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text(_f(0, "VALUE"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.88)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 6l4-4 4 4", skin.faint, false, 1.8)], 12, 8))), SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 2l4 4 4-4", skin.faint, false, 1.8)], 12, 8)))])]), Text(_f(1, "UNSORTED"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text(_f(2, "VALUE"), style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.88)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 6l4-4 4 4", theme.aHi, false, 1.8)], 12, 8))), SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 2l4 4 4-4", skin.faint, false, 1.8)], 12, 8)))])]), Text(_f(3, "ASCENDING"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text(_f(4, "VALUE"), style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.88)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 6l4-4 4 4", skin.faint, false, 1.8)], 12, 8))), SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 2l4 4 4-4", theme.aHi, false, 1.8)], 12, 8)))])]), Text(_f(5, "DESCENDING"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))])] : List<Widget>.generate(items!.length, (i) => Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text(_it(items![i], 0, "VALUE"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.88)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 6l4-4 4 4", skin.faint, false, 1.8)], 12, 8))), SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 2l4 4 4-4", skin.faint, false, 1.8)], 12, 8)))])]), Text(_it(items![i], 1, "UNSORTED"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))])))]);
