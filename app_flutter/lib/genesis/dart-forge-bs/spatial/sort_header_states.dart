...
class ForgeSortHeaderStates extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.all(16), child: Row(mainAxisSize: MainAxisSize.min, spacing: 14, children: [Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [Text("Value", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 6l4-4 4 4", skin.mut, 2.4, false, 12)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 2l4 4 4-4", skin.mut, 2.4, false, 12))])]), Text("unsorted")]), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [Text("Value", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 6l4-4 4 4", skin.mut, 2.4, false, 12)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 2l4 4 4-4", skin.mut, 2.4, false, 12))])]), Text("ascending")]), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [Text("Value", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 6l4-4 4 4", skin.mut, 2.4, false, 12)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2 2l4 4 4-4", skin.mut, 2.4, false, 12))])]), Text("descending")])]));
  }
}
