...
class ForgeSortHeaderStates extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Wrap(spacing: 18, runSpacing: 18, crossAxisAlignment: WrapCrossAlignment.start, children: [Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("VALUE", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.88)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 6l4-4 4 4", skin.faint, false, 1.8)], 12, 8))), SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 2l4 4 4-4", skin.faint, false, 1.8)], 12, 8)))])]), Text("UNSORTED", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("VALUE", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.88)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 6l4-4 4 4", theme.aHi, false, 1.8)], 12, 8))), SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 2l4 4 4-4", skin.faint, false, 1.8)], 12, 8)))])]), Text("ASCENDING", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("VALUE", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.88)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 6l4-4 4 4", skin.faint, false, 1.8)], 12, 8))), SizedBox(width: 9, height: 6, child: CustomPaint(painter: _SvgScene([_Op.path("M2 2l4 4 4-4", theme.aHi, false, 1.8)], 12, 8)))])]), Text("DESCENDING", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))])]));
  }
}
