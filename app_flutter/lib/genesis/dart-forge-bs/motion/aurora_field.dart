...
/// AuroraField — seam:fields · 1 חריצים
class ForgeAuroraField extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["AURORA"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
