...
class ForgeTypeWriter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(height: 150, decoration: BoxDecoration(color: skin.sunken), child: Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: Container(padding: const EdgeInsets.fromLTRB(16, 0, 16, 0), child: Text("Label", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 15))))]));
  }
}
