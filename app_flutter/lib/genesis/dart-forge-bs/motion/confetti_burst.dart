...
class ForgeConfettiBurst extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(height: 150, decoration: BoxDecoration(color: skin.sunken), child: SizedBox(width: double.infinity, child: Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(15, 9, 15, 9), decoration: BoxDecoration(border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Text("ACTION · BURST", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 10, letterSpacing: 1.40))))), Positioned.fill(child: SizedBox(width: double.infinity, child: const SizedBox.shrink()))])));
  }
}
