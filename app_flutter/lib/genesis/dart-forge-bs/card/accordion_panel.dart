...
/// AccordionPanel — seam:fields · 5 חריצים
class ForgeAccordionPanel extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "Label", "Meta", "Label", "Meta"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
