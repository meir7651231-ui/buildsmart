...
/// MetricTile — seam:fields · 3 חריצים
class ForgeMetricTile extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "1,024", "4%"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
