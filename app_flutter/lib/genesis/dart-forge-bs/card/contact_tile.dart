...
class ForgeContactTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(15)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 11, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 8 8 a 4 4 0 1 0 8 0 a 4 4 0 1 0 -8 0 M4 20a8 8 0 0116 0", skin.mut, 1.8, false, 24)), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("Label"), Text("Meta")]), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M15 6l-6 6 6 6", skin.mut, 2, false, 24))]));
  }
}
