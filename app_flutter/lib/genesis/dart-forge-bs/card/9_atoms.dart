...
class Forge9Atoms extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisSize: MainAxisSize.min, spacing: 14, children: [Text("L"), Text("inherit DsRecordCard →"), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("OrderCard"), Text("CustomerCard"), Text("SupplierTile"), Text("SummaryCard"), Text("ProposalCard"), Text("ApprovalCard"), Text("PenaltyCard"), Text("VacationRequestCard"), Text("DeliveryOptionCard")])]);
  }
}
