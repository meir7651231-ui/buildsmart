...
class ForgePriceEstimatePanel extends StatelessWidget {
  ...
  /// G13d · וריאנט-פריט (טוקן-עיצוב: ["","tot"]) — variants[i] = אינדקס-הוריאנט של פריט i; null ⇒ הראשון.
  final List<int>? variants;
  static const List<String> variantIds = <String>["", "tot"];
