...
class ForgeTrendCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 11, fontWeight: FontWeight.w600)), Directionality(textDirection: TextDirection.ltr, child: Text.rich(TextSpan(children: [TextSpan(text: "7.4", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 30, fontWeight: FontWeight.w700, letterSpacing: -0.60, height: 1, leadingDistribution: TextLeadingDistribution.even)), TextSpan(text: "k", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 15, fontWeight: FontWeight.w700, letterSpacing: -0.30, height: 1, leadingDistribution: TextLeadingDistribution.even))]))), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [SizedBox(width: 12, height: 12, child: CustomPaint(painter: _SvgScene([_Op.path("M7 17L17 7M17 7H9M17 7v8", skin.ok, false, 1.8)], 24, 24))), Text("Meta", style: TextStyle(color: skin.ok, fontFamily: fonts.grotesk, fontSize: 11, fontWeight: FontWeight.w600))]))]));
  }
}
