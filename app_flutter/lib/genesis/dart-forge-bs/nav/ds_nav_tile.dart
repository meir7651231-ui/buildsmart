...
/// DsNavTile — seam:collection · 3 חריצים
class ForgeDsNavTile extends StatelessWidget {
  ...
  const ForgeDsNavTile({super.key, this.fields, this.child, this.items, this.selected, this.onSelect});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: _withChild(Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [Container(padding: const EdgeInsets.fromLTRB(10, 10, 10, 10), decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [...(items == null ? <Widget>[Container(constraints: const BoxConstraints(minWidth: 56), padding: const EdgeInsets.fromLTRB(12, 9, 12, 9), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.120), borderRadius: BorderRadius.circular(12)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [SizedBox(width: 20, height: 20, child: CustomPaint(painter: _SvgScene([_Op.path("M3 12l9-8 9 8M5 10v10h14V10", theme.aHi, false, 1.8)], 24, 24))), Text(_f(0, "Label"), style: TextStyle(color: theme.aHi, fontFamily: fonts.he, fontSize: 9.5, fontWeight: FontWeight.w600))]))), Container(constraints: const BoxConstraints(minWidth: 56), padding: const EdgeInsets.fromLTRB(12, 9, 12, 9), decoration: BoxDecoration(borderRadius: BorderRadius.circular(12)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [SizedBox(width: 20, height: 20, child: CustomPaint(painter: _SvgScene([_Op.rect(4, 4, 16, 16, 3, skin.faint, false, 1.8)], 24, 24))), Text(_f(1, "Label"), style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 9.5, fontWeight: FontWeight.w600))]))), Container(constraints: const BoxConstraints(minWidth: 56), padding: const EdgeInsets.fromLTRB(12, 9, 12, 9), decoration: BoxDecoration(borderRadius: BorderRadius.circular(12)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [SizedBox(width: 20, height: 20, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 8, 4, skin.faint, false, 1.8), _Op.path("M4 20a8 8 0 0116 0", skin.faint, false, 1.8)], 24, 24))), Text(_f(2, "Label"), style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 9.5, fontWeight: FontWeight.w600))])))] : List<Widget>.generate(items!.length, (i) => ((selected?.contains(i) ?? false) ? GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: Container(constraints: const BoxConstraints(minWidth: 56), padding: const EdgeInsets.fromLTRB(12, 9, 12, 9), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.120), borderRadius: BorderRadius.circular(12)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [SizedBox(width: 20, height: 20, child: CustomPaint(painter: _SvgScene([_Op.path("M3 12l9-8 9 8M5 10v10h14V10", theme.aHi, false, 1.8)], 24, 24))), Text(_it(items![i], 0, "Label"), style: TextStyle(color: theme.aHi, fontFamily: fonts.he, fontSize: 9.5, fontWeight: FontWeight.w600))])))) : GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: Container(constraints: const BoxConstraints(minWidth: 56), padding: const EdgeInsets.fromLTRB(12, 9, 12, 9), decoration: BoxDecoration(borderRadius: BorderRadius.circular(12)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [SizedBox(width: 20, height: 20, child: CustomPaint(painter: _SvgScene([_Op.rect(4, 4, 16, 16, 3, skin.faint, false, 1.8)], 24, 24))), Text(_it(items![i], 0, "Label"), style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 9.5, fontWeight: FontWeight.w600))])))))))]))]), child));
    return body;
  }
}
