...
/// FabMenu — seam:fields · 3 חריצים
class ForgeFabMenuNav extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["closed", "Label", "Label"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeFabMenuNav({super.key, this.fields, this.child, this.onAction, this.items});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(constraints: const BoxConstraints(minHeight: 180), padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: _withChild(Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [_hide(_f(0, "closed"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 24.0; return SizedBox(width: _w, height: _w / 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 5v14M5 12h14", skin.ink, false, 1.8)], 24, 24))); }))), Directionality(textDirection: TextDirection.ltr, child: Text(_f(0, "closed"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9)))])), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, spacing: 9, children: [...(items == null ? <Widget>[_hide(_f(1, "Label"), Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 9, children: [_hide(_f(1, "Label"), Container(padding: const EdgeInsets.fromLTRB(9, 4, 9, 4), decoration: BoxDecoration(color: skin.raised2, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Text(_f(1, "Label"), style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 11, fontWeight: FontWeight.w600)))), GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(1), child: Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: SizedBox(width: 16, height: 16, child: CustomPaint(painter: _SvgScene([_Op.path("M12 5v14M5 12h14", theme.aHi, false, 1.8)], 24, 24)))))])), _hide(_f(2, "Label"), Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 9, children: [_hide(_f(2, "Label"), Container(padding: const EdgeInsets.fromLTRB(9, 4, 9, 4), decoration: BoxDecoration(color: skin.raised2, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Text(_f(2, "Label"), style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 11, fontWeight: FontWeight.w600)))), GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(2), child: Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: SizedBox(width: 16, height: 16, child: CustomPaint(painter: _SvgScene([_Op.path("M5 13l4 4L19 7", theme.aHi, false, 1.8)], 24, 24)))))]))] : List<Widget>.generate(items!.length, (i) => _hide(_it(items![i], 0, "Label"), Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 9, children: [_hide(_it(items![i], 0, "Label"), Container(padding: const EdgeInsets.fromLTRB(9, 4, 9, 4), decoration: BoxDecoration(color: skin.raised2, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Text(_it(items![i], 0, "Label"), style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 11, fontWeight: FontWeight.w600)))), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: SizedBox(width: 16, height: 16, child: CustomPaint(painter: _SvgScene([_Op.path("M12 5v14M5 12h14", theme.aHi, false, 1.8)], 24, 24))))])))), GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(3), child: Container(width: 52, height: 52, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(16), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 12), blurRadius: 26, spreadRadius: 0)]), child: SizedBox(width: 22, height: 22, child: CustomPaint(painter: _SvgScene([_Op.path("M12 5v14M5 12h14", const Color(0xFF0B0B0D), false, 1.8)], 24, 24)))))])]), child));
    return body;
  }
}
