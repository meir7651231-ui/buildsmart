...
/// MenuRow — seam:fields · 3 חריצים
class ForgeMenuRow extends StatelessWidget {
  ...
  const ForgeMenuRow({super.key, this.fields, this.child, this.items, this.selected, this.onSelect});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(13)), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [...(items == null ? <Widget>[_hide(_f(0, "Label"), Container(constraints: const BoxConstraints(minHeight: 44), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.100), border: Border(bottom: BorderSide(color: skin.hair2, width: 1))), child: SizedBox(width: double.infinity, child: Stack(clipBehavior: Clip.none, children: [Padding(padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 30, height: 30, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 15, height: 15, child: CustomPaint(painter: _SvgScene([_Op.path("M3 12l9-8 9 8M5 10v10h14V10", theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Text(_f(0, "Label"), style: TextStyle(color: theme.aHi, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he))), SizedBox(width: 13, height: 13, child: CustomPaint(painter: _SvgScene([_Op.path("M15 6l-6 6 6 6", skin.faint, false, 1.8)], 24, 24)))])), Positioned(top: 8, bottom: 8, right: 0, width: 3, child: Container(width: 3, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(999))))])))), _hide(_f(1, "Label"), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 30, height: 30, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 15, height: 15, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 12, 9, theme.aHi, false, 1.8), _Op.path("M12 8v4M12 16h.01", theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Text(_f(1, "Label"), style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he))), SizedBox(width: 13, height: 13, child: CustomPaint(painter: _SvgScene([_Op.path("M15 6l-6 6 6 6", skin.faint, false, 1.8)], 24, 24)))]))), _hide(_f(2, "Label"), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 30, height: 30, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 15, height: 15, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 8, 4, theme.aHi, false, 1.8), _Op.path("M4 20a8 8 0 0116 0", theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Text(_f(2, "Label"), style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he))), SizedBox(width: 13, height: 13, child: CustomPaint(painter: _SvgScene([_Op.path("M15 6l-6 6 6 6", skin.faint, false, 1.8)], 24, 24)))])))] : List<Widget>.generate(items!.length, (i) => ((selected?.contains(i) ?? false) ? GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: _hide(_it(items![i], 0, "Label"), Container(constraints: const BoxConstraints(minHeight: 44), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.100), border: Border(bottom: BorderSide(color: skin.hair2, width: 1))), child: SizedBox(width: double.infinity, child: Stack(clipBehavior: Clip.none, children: [Padding(padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 30, height: 30, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 15, height: 15, child: CustomPaint(painter: _SvgScene([_Op.path("M3 12l9-8 9 8M5 10v10h14V10", theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Text(_it(items![i], 0, "Label"), style: TextStyle(color: theme.aHi, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he))), SizedBox(width: 13, height: 13, child: CustomPaint(painter: _SvgScene([_Op.path("M15 6l-6 6 6 6", skin.faint, false, 1.8)], 24, 24)))])), Positioned(top: 8, bottom: 8, right: 0, width: 3, child: Container(width: 3, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(999))))]))))) : GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: _hide(_it(items![i], 0, "Label"), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 30, height: 30, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 15, height: 15, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 12, 9, theme.aHi, false, 1.8), _Op.path("M12 8v4M12 16h.01", theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Text(_it(items![i], 0, "Label"), style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he))), SizedBox(width: 13, height: 13, child: CustomPaint(painter: _SvgScene([_Op.path("M15 6l-6 6 6 6", skin.faint, false, 1.8)], 24, 24)))])))))))]), child));
    return body;
  }
}
