...
class ForgeMenuRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(13)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), decoration: BoxDecoration(color: theme.a), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 30, height: 30, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M3 12l9-8 9 8M5 10v10h14V10", skin.mut, 1.8, false, 24))), Text("Label", style: TextStyle(color: theme.aHi, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M15 6l-6 6 6 6", skin.mut, 2, false, 24))])), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 30, height: 30, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 12 a 9 9 0 1 0 18 0 a 9 9 0 1 0 -18 0 M12 8v4M12 16h.01", skin.mut, 1.8, false, 24))), Text("Label", style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M15 6l-6 6 6 6", skin.mut, 2, false, 24))])), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 30, height: 30, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 8 8 a 4 4 0 1 0 8 0 a 4 4 0 1 0 -8 0 M4 20a8 8 0 0116 0", skin.mut, 1.8, false, 24))), Text("Label", style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M15 6l-6 6 6 6", skin.mut, 2, false, 24))]))]));
  }
}
