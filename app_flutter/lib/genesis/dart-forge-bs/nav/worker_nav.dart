...
/// WorkerNav — seam:collection · 5 חריצים
class ForgeWorkerNav extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "Label", "3", "Label", "Label"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeWorkerNav({super.key, this.fields, this.child, this.items, this.selected, this.onSelect});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(6, 8, 6, 8), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.raised, skin.surface], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16), boxShadow: [BoxShadow(color: const Color(0x4D000000), offset: const Offset(0, -6), blurRadius: 20, spreadRadius: 0)]), child: _withChild(Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceAround, crossAxisAlignment: CrossAxisAlignment.center, children: [...(items == null ? <Widget>[Container(constraints: const BoxConstraints(minHeight: 44, minWidth: 52), padding: const EdgeInsets.fromLTRB(8, 6, 8, 6), decoration: BoxDecoration(borderRadius: BorderRadius.circular(11)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Container(padding: const EdgeInsets.fromLTRB(12, 4, 12, 4), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: SizedBox(width: 21, height: 21, child: CustomPaint(painter: _SvgScene([_Op.path("M3 12l9-8 9 8M5 10v10h14V10", theme.aHi, false, 1.8)], 24, 24)))), Text(_f(0, "Label"), style: TextStyle(color: theme.aHi, fontFamily: fonts.he, fontSize: 10, fontWeight: FontWeight.w600))]))), Container(constraints: const BoxConstraints(minHeight: 44, minWidth: 52), padding: const EdgeInsets.fromLTRB(8, 6, 8, 6), decoration: BoxDecoration(borderRadius: BorderRadius.circular(11)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Container(padding: const EdgeInsets.fromLTRB(12, 4, 12, 4), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: SizedBox(width: 21, height: 21, child: CustomPaint(painter: _SvgScene([_Op.rect(4, 4, 16, 16, 3, skin.faint, false, 1.8)], 24, 24)))), Text(_f(1, "Label"), style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 10, fontWeight: FontWeight.w600))]))), Container(constraints: const BoxConstraints(minHeight: 44, minWidth: 52), decoration: BoxDecoration(borderRadius: BorderRadius.circular(11)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Stack(clipBehavior: Clip.none, children: [Padding(padding: const EdgeInsets.fromLTRB(8, 6, 8, 6), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Container(padding: const EdgeInsets.fromLTRB(12, 4, 12, 4), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: SizedBox(width: 21, height: 21, child: CustomPaint(painter: _SvgScene([_Op.circle(11, 11, 7, skin.faint, false, 1.8), _Op.path("M21 21l-4-4", skin.faint, false, 1.8)], 24, 24)))), Text(_f(3, "Label"), style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 10, fontWeight: FontWeight.w600))])), Positioned(top: 2, right: 5, width: 16, child: _hide(_f(2, "3"), Container(height: 16, constraints: const BoxConstraints(minWidth: 16), padding: const EdgeInsets.fromLTRB(3, 0, 3, 0), decoration: BoxDecoration(color: const Color(0xFFE0574E), border: Border.all(color: skin.raised, width: 2), borderRadius: BorderRadius.circular(999)), child: Center(widthFactor: 1.0, child: Text(_f(2, "3"), style: TextStyle(color: const Color(0xFFFFFFFF), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, fontWeight: FontWeight.w700))))))]))), Container(constraints: const BoxConstraints(minHeight: 44, minWidth: 52), padding: const EdgeInsets.fromLTRB(8, 6, 8, 6), decoration: BoxDecoration(borderRadius: BorderRadius.circular(11)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Container(padding: const EdgeInsets.fromLTRB(12, 4, 12, 4), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: SizedBox(width: 21, height: 21, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 8, 4, skin.faint, false, 1.8), _Op.path("M4 20a8 8 0 0116 0", skin.faint, false, 1.8)], 24, 24)))), Text(_f(4, "Label"), style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 10, fontWeight: FontWeight.w600))])))] : List<Widget>.generate(items!.length, (i) => Flexible(child: ((selected?.contains(i) ?? false) ? GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: Container(constraints: const BoxConstraints(minHeight: 44, minWidth: 52), padding: const EdgeInsets.fromLTRB(8, 6, 8, 6), decoration: BoxDecoration(borderRadius: BorderRadius.circular(11)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Container(padding: const EdgeInsets.fromLTRB(12, 4, 12, 4), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: SizedBox(width: 21, height: 21, child: CustomPaint(painter: _SvgScene([_Op.path("M3 12l9-8 9 8M5 10v10h14V10", theme.aHi, false, 1.8)], 24, 24)))), Text(_it(items![i], 0, "Label"), style: TextStyle(color: theme.aHi, fontFamily: fonts.he, fontSize: 10, fontWeight: FontWeight.w600))])))) : GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: Container(constraints: const BoxConstraints(minHeight: 44, minWidth: 52), padding: const EdgeInsets.fromLTRB(8, 6, 8, 6), decoration: BoxDecoration(borderRadius: BorderRadius.circular(11)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Container(padding: const EdgeInsets.fromLTRB(12, 4, 12, 4), decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: SizedBox(width: 21, height: 21, child: CustomPaint(painter: _SvgScene([_Op.rect(4, 4, 16, 16, 3, skin.faint, false, 1.8)], 24, 24)))), Text(_it(items![i], 0, "Label"), style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 10, fontWeight: FontWeight.w600))]))))))))]), child));
    return body;
  }
}
