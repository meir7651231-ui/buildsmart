...
/// StackedBarGroup — seam:series · 2 חריצים
class ForgeStackedBarGroup extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "4%"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
