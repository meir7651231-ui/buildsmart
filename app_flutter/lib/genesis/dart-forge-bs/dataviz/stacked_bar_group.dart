...
/// StackedBarGroup — seam:series · 5 חריצים
class ForgeStackedBarGroup extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "4%", "Q1", "Q2", "Q3"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  /// G13a · מילויי-אחוז (0..1) לפי סדר-הופעה/פריט (9 בדמו). null ⇒ ערכי-העיצוב; חסר ⇒ 0 (אין המצאה).
  final List<double>? values;
  double _v(int i, double d) => values == null ? d : (i < values!.length ? values![i].clamp(0.0, 1.0) : 0.0);
  const ForgeStackedBarGroup({super.key, this.fields, this.child, this.values});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(constraints: const BoxConstraints(minHeight: 150), padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, spacing: 10, children: [Flexible(child: Text(_f(0, "Label"), style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis, softWrap: false)), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 3, children: [SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M7 7l10 10M17 17H9M17 17V9", skin.err, false, 1.8)], 24, 24))), Text(_f(1, "4%"), style: TextStyle(color: skin.err, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 10.5, fontWeight: FontWeight.w700))]))]), LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 240.0; return SizedBox(width: _w, height: _w / 2.5000, child: CustomPaint(painter: _SvgScene([_Op.line(0, 80, 240, 80, skin.hair, 1), _Op.rect(14, 80 - _v(0, 0.6429) * 56, 14, _v(0, 0.6429) * 56, 2, theme.a, true, 1.8), _Op.rect(30, 80 - _v(1, 0.8929) * 56, 14, _v(1, 0.8929) * 56, 2, theme.c2, true, 1.8), _Op.rect(46, 80 - _v(2, 0.4643) * 56, 14, _v(2, 0.4643) * 56, 2, theme.c3, true, 1.8), _Op.rect(86, 80 - _v(3, 0.75) * 56, 14, _v(3, 0.75) * 56, 2, theme.a, true, 1.8), _Op.rect(102, 80 - _v(4, 0.5357) * 56, 14, _v(4, 0.5357) * 56, 2, theme.c2, true, 1.8), _Op.rect(118, 80 - _v(5, 0.8214) * 56, 14, _v(5, 0.8214) * 56, 2, theme.c3, true, 1.8), _Op.rect(158, 80 - _v(6, 0.5) * 56, 14, _v(6, 0.5) * 56, 2, theme.a, true, 1.8), _Op.rect(174, 80 - _v(7, 1) * 56, 14, _v(7, 1) * 56, 2, theme.c2, true, 1.8), _Op.rect(190, 80 - _v(8, 0.6071) * 56, 14, _v(8, 0.6071) * 56, 2, theme.c3, true, 1.8), _Op.text(_f(2, "Q1"), 37, 92, 9, skin.faint, 1, fonts.grotesk), _Op.text(_f(3, "Q2"), 109, 92, 9, skin.faint, 1, fonts.grotesk), _Op.text(_f(4, "Q3"), 181, 92, 9, skin.faint, 1, fonts.grotesk)], 240, 96))); })]), child));
    return body;
  }
}
