...
/// StackedBarGroup — seam:series
class ForgeStackedBarGroup extends StatelessWidget {
  const ForgeStackedBarGroup({super.key});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    return Container(constraints: const BoxConstraints(minHeight: 150), padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, spacing: 10, children: [Flexible(child: Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis, softWrap: false)), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 3, children: [SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M7 7l10 10M17 17H9M17 17V9", skin.err, false, 1.8)], 24, 24))), Text("4%", style: TextStyle(color: skin.err, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 10.5, fontWeight: FontWeight.w700))]))]), LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 240.0; return SizedBox(width: _w, height: _w / 2.5000, child: CustomPaint(painter: _SvgScene([_Op.line(0, 80, 240, 80, skin.hair, 1), _Op.rect(14, 44, 14, 36, 2, theme.a, true, 1.8), _Op.rect(30, 30, 14, 50, 2, theme.c2, true, 1.8), _Op.rect(46, 54, 14, 26, 2, theme.c3, true, 1.8), _Op.rect(86, 38, 14, 42, 2, theme.a, true, 1.8), _Op.rect(102, 50, 14, 30, 2, theme.c2, true, 1.8), _Op.rect(118, 34, 14, 46, 2, theme.c3, true, 1.8), _Op.rect(158, 52, 14, 28, 2, theme.a, true, 1.8), _Op.rect(174, 24, 14, 56, 2, theme.c2, true, 1.8), _Op.rect(190, 46, 14, 34, 2, theme.c3, true, 1.8), _Op.text("Q1", 37, 92, 9, skin.faint, 1, fonts.grotesk), _Op.text("Q2", 109, 92, 9, skin.faint, 1, fonts.grotesk), _Op.text("Q3", 181, 92, 9, skin.faint, 1, fonts.grotesk)], 240, 96))); })]));
  }
}
