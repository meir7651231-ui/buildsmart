...
class ForgeStackedBarGroup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(constraints: const BoxConstraints(minHeight: 150), padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label"), Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 3, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M7 7l10 10M17 17H9M17 17V9", skin.mut, 1.8, false, 24)), Text("4%", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])]), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 0 80 L 240 80 M 14 44 h 14 v 36 h -14 Z M 30 30 h 14 v 50 h -14 Z M 46 54 h 14 v 26 h -14 Z M 86 38 h 14 v 42 h -14 Z M 102 50 h 14 v 30 h -14 Z M 118 34 h 14 v 46 h -14 Z M 158 52 h 14 v 28 h -14 Z M 174 24 h 14 v 56 h -14 Z M 190 46 h 14 v 34 h -14 Z", skin.mut, 1.8, false, 240))]));
  }
}
