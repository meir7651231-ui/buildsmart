...
/// StatBlock — seam:fields · 3 חריצים
class ForgeStatBlock extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "248", "12% Meta"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
