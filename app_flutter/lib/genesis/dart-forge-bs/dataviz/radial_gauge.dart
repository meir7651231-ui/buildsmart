...
/// RadialGauge — seam:fields · 4 חריצים
class ForgeRadialGauge extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "248", "0", "500"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
