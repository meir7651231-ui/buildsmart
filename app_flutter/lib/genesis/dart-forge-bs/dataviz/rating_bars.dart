...
/// RatingBars — seam:fields · 10 חריצים
class ForgeRatingBars extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "248", "120", "A", "86", "B", "164", "C", "64", "D"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeRatingBars({super.key, this.fields, this.child});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(constraints: const BoxConstraints(minHeight: 150), padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, spacing: 10, children: [Flexible(child: Text(_f(0, "Label"), style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis, softWrap: false)), Flexible(child: Directionality(textDirection: TextDirection.ltr, child: Text(_f(1, "248"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 22, fontWeight: FontWeight.w700, letterSpacing: -0.44, height: 1, leadingDistribution: TextLeadingDistribution.even), overflow: TextOverflow.ellipsis, softWrap: false)))]), LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 240.0; return SizedBox(width: _w, height: _w / 2.5000, child: CustomPaint(painter: _SvgScene([_Op.line(52, 6, 52, 86, skin.hair, 1), _Op.rect(52, 8, 120, 14, 3, theme.a.withValues(alpha: 0.260), true, 1.8), _Op.text(_f(2, "120"), 178, 19, 9.5, skin.mut, 0, fonts.grotesk), _Op.text(_f(3, "A"), 46, 19, 9, skin.faint, 2, fonts.grotesk), _Op.rect(52, 30, 86, 14, 3, theme.a.withValues(alpha: 0.260), true, 1.8), _Op.text(_f(4, "86"), 144, 41, 9.5, skin.mut, 0, fonts.grotesk), _Op.text(_f(5, "B"), 46, 41, 9, skin.faint, 2, fonts.grotesk), _Op.rect(52, 52, 164, 14, 3, skin.ink, true, 1.8, g: [theme.aHi, theme.a], gs: [0.00, 1.00], gv: [0.00, 0.00, 0.00, 1.00]), _Op.text(_f(6, "164"), 222, 63, 9.5, skin.mut, 0, fonts.grotesk), _Op.text(_f(7, "C"), 46, 63, 9, skin.faint, 2, fonts.grotesk), _Op.rect(52, 74, 64, 14, 3, theme.a.withValues(alpha: 0.260), true, 1.8), _Op.text(_f(8, "64"), 122, 85, 9.5, skin.mut, 0, fonts.grotesk), _Op.text(_f(9, "D"), 46, 85, 9, skin.faint, 2, fonts.grotesk)], 240, 96))); })]), child));
    return body;
  }
}
