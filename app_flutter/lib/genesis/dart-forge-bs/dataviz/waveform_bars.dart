...
/// WaveformBars — seam:fields · 2 חריצים
class ForgeWaveformBars extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "1,024"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  /// G13a · מילויי-אחוז (0..1) לפי סדר-הופעה/פריט (14 בדמו). null ⇒ ערכי-העיצוב; חסר ⇒ 0 (אין המצאה).
  final List<double>? values;
  double _v(int i, double d) => values == null ? d : (i < values!.length ? values![i].clamp(0.0, 1.0) : 0.0);
  const ForgeWaveformBars({super.key, this.fields, this.child, this.values});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, spacing: 10, children: [Flexible(child: Text(_f(0, "Label"), style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis, softWrap: false)), Flexible(child: Directionality(textDirection: TextDirection.ltr, child: Text(_f(1, "1,024"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 22, fontWeight: FontWeight.w700, letterSpacing: -0.44, height: 1, leadingDistribution: TextLeadingDistribution.even), overflow: TextOverflow.ellipsis, softWrap: false)))]), SizedBox(height: 46, child: LayoutBuilder(builder: (ctx, cns) => SizedBox(width: cns.maxWidth.isFinite ? cns.maxWidth : 240, height: 46, child: CustomPaint(painter: _SvgScene([_Op.rect(4, 46 - _v(0, 0.4762) * 42, 10, _v(0, 0.4762) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(20, 46 - _v(1, 0.619) * 42, 10, _v(1, 0.619) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(36, 46 - _v(2, 0.381) * 42, 10, _v(2, 0.381) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(52, 46 - _v(3, 0.7143) * 42, 10, _v(3, 0.7143) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(68, 46 - _v(4, 0.5238) * 42, 10, _v(4, 0.5238) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(84, 46 - _v(5, 0.8095) * 42, 10, _v(5, 0.8095) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(100, 46 - _v(6, 0.5714) * 42, 10, _v(6, 0.5714) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(116, 46 - _v(7, 0.6667) * 42, 10, _v(7, 0.6667) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(132, 46 - _v(8, 0.4286) * 42, 10, _v(8, 0.4286) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(148, 46 - _v(9, 0.7619) * 42, 10, _v(9, 0.7619) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(164, 46 - _v(10, 0.619) * 42, 10, _v(10, 0.619) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(180, 46 - _v(11, 0.8571) * 42, 10, _v(11, 0.8571) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8), _Op.rect(196, 46 - _v(12, 1) * 42, 10, _v(12, 1) * 42, 2, skin.ink, true, 1.8, g: [theme.aHi, theme.a], gs: [0.00, 1.00], gv: [0.00, 0.00, 0.00, 1.00]), _Op.rect(212, 46 - _v(13, 0.7143) * 42, 10, _v(13, 0.7143) * 42, 2, theme.a.withValues(alpha: 0.300), true, 1.8)], 240, 46)))))]), child));
    return body;
  }
}
