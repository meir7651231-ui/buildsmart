...
class ForgeWaveformBars extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, spacing: 10, children: [Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600)), Text("1,024", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 22, fontWeight: FontWeight.w700))]), CustomPaint(size: const Size(16, 46), painter: _SvgPaint("M 4 26 h 10 v 20 h -10 Z M 20 20 h 10 v 26 h -10 Z M 36 30 h 10 v 16 h -10 Z M 52 16 h 10 v 30 h -10 Z M 68 24 h 10 v 22 h -10 Z M 84 12 h 10 v 34 h -10 Z M 100 22 h 10 v 24 h -10 Z M 116 18 h 10 v 28 h -10 Z M 132 28 h 10 v 18 h -10 Z M 148 14 h 10 v 32 h -10 Z M 164 20 h 10 v 26 h -10 Z M 180 10 h 10 v 36 h -10 Z M 196 4 h 10 v 42 h -10 Z M 212 16 h 10 v 30 h -10 Z", skin.ink, 1.8, false, 240))]));
  }
}
