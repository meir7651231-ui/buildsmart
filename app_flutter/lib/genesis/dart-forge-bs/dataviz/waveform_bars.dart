...
class ForgeWaveformBars extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, spacing: 10, children: [Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600)), Directionality(textDirection: TextDirection.ltr, child: Text("1,024", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 22, fontWeight: FontWeight.w700, letterSpacing: -0.44, height: 1, leadingDistribution: TextLeadingDistribution.even)))]), SizedBox(width: double.infinity, child: FractionallySizedBox(widthFactor: 1.000, heightFactor: 1.000, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 240, height: 46, child: CustomPaint(painter: _SvgScene([_Op.rect(4, 26, 10, 20, 2, skin.ink, false, 1.8), _Op.rect(20, 20, 10, 26, 2, skin.ink, false, 1.8), _Op.rect(36, 30, 10, 16, 2, skin.ink, false, 1.8), _Op.rect(52, 16, 10, 30, 2, skin.ink, false, 1.8), _Op.rect(68, 24, 10, 22, 2, skin.ink, false, 1.8), _Op.rect(84, 12, 10, 34, 2, skin.ink, false, 1.8), _Op.rect(100, 22, 10, 24, 2, skin.ink, false, 1.8), _Op.rect(116, 18, 10, 28, 2, skin.ink, false, 1.8), _Op.rect(132, 28, 10, 18, 2, skin.ink, false, 1.8), _Op.rect(148, 14, 10, 32, 2, skin.ink, false, 1.8), _Op.rect(164, 20, 10, 26, 2, skin.ink, false, 1.8), _Op.rect(180, 10, 10, 36, 2, skin.ink, false, 1.8), _Op.rect(196, 4, 10, 42, 2, skin.ink, true, 1.8, g: [theme.aHi, theme.a], gs: [0.00, 1.00], gv: [0.00, 0.00, 0.00, 1.00]), _Op.rect(212, 16, 10, 30, 2, theme.a.withValues(alpha: 0.300), true, 1.8)], 240, 46))))))]));
  }
}
