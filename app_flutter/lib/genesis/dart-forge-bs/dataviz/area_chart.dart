...
class ForgeAreaChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 11, children: [Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("Label"), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("7.4", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("k")])]), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 0 28 L 240 28 M 0 58 L 240 58 M2,72 C30,66 44,40 70,44 C96,48 108,22 134,26 C160,30 176,54 200,46 C222,39 232,30 238,26 L238,88 L2,88 Z M2,72 C30,66 44,40 70,44 C96,48 108,22 134,26 C160,30 176,54 200,46 C222,39 232,30 238,26 M 130.6 26 a 3.4 3.4 0 1 0 6.8 0 a 3.4 3.4 0 1 0 -6.8 0 M 0 88 L 240 88", skin.mut, 1.8, false, 240))]));
  }
}
