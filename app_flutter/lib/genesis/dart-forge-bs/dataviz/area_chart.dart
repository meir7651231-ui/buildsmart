...
/// AreaChart — seam:fields · 3 חריצים
class ForgeAreaChart extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "7.4", "k"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeAreaChart({super.key, this.fields, this.child});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(constraints: const BoxConstraints(minHeight: 150), padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, spacing: 10, children: [Flexible(child: Text(_f(0, "Label"), style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis, softWrap: false)), Directionality(textDirection: TextDirection.ltr, child: Text.rich(TextSpan(children: [TextSpan(text: _f(1, "7.4"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 22, fontWeight: FontWeight.w700, letterSpacing: -0.44, height: 1, leadingDistribution: TextLeadingDistribution.even)), TextSpan(text: _f(2, "k"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 13, fontWeight: FontWeight.w700, letterSpacing: -0.26, height: 1, leadingDistribution: TextLeadingDistribution.even))])))]), LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 240.0; return SizedBox(width: _w, height: _w / 2.4000, child: CustomPaint(painter: _SvgScene([_Op.line(0, 28, 240, 28, skin.hair2, 1), _Op.line(0, 58, 240, 58, skin.hair2, 1), _Op.path("M2,72 C30,66 44,40 70,44 C96,48 108,22 134,26 C160,30 176,54 200,46 C222,39 232,30 238,26 L238,88 L2,88 Z", skin.ink, true, 1.8, g: [theme.a.withValues(alpha: 0.38), theme.a.withValues(alpha: 0.00)], gs: [0.00, 1.00], gv: [0.00, 0.00, 0.00, 1.00]), _Op.path("M2,72 C30,66 44,40 70,44 C96,48 108,22 134,26 C160,30 176,54 200,46 C222,39 232,30 238,26", theme.aHi, false, 2.4), _Op.circle(134, 26, 3.4, theme.aHi, true, 1.6), _Op.line(0, 88, 240, 88, skin.hair, 1)], 240, 100))); })]), child));
    return body;
  }
}
