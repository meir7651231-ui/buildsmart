...
/// BarChart — seam:fields · 6 חריצים
class ForgeBarChart extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "12%", "86", "01", "04", "07"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  /// G13a · מילויי-אחוז (0..1) לפי סדר-הופעה/פריט (7 בדמו). null ⇒ ערכי-העיצוב; חסר ⇒ 0 (אין המצאה).
  final List<double>? values;
  double _v(int i, double d) => values == null ? d : (i < values!.length ? values![i].clamp(0.0, 1.0) : 0.0);
  const ForgeBarChart({super.key, this.fields, this.child, this.values});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(constraints: const BoxConstraints(minHeight: 150), padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, spacing: 10, children: [Flexible(child: Text(_f(0, "Label"), style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis, softWrap: false)), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 3, children: [SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M7 17L17 7M17 7H9M17 7v8", skin.ok, false, 1.8)], 24, 24))), Text(_f(1, "12%"), style: TextStyle(color: skin.ok, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 10.5, fontWeight: FontWeight.w700))]))]), LayoutBuilder(builder: (ctx, cns) { final _w = cns.maxWidth.isFinite ? cns.maxWidth : 240.0; return SizedBox(width: _w, height: _w / 2.5000, child: CustomPaint(painter: _SvgScene([_Op.line(0, 24, 240, 24, skin.hair2, 1), _Op.line(0, 52, 240, 52, skin.hair2, 1), _Op.line(0, 80, 240, 80, skin.hair, 1), _Op.rect(8, 80 - _v(0, 0.4242) * 66, 22, _v(0, 0.4242) * 66, 3, theme.a.withValues(alpha: 0.260), true, 1.8), _Op.rect(42, 80 - _v(1, 0.6061) * 66, 22, _v(1, 0.6061) * 66, 3, theme.a.withValues(alpha: 0.260), true, 1.8), _Op.rect(76, 80 - _v(2, 0.3333) * 66, 22, _v(2, 0.3333) * 66, 3, theme.a.withValues(alpha: 0.260), true, 1.8), _Op.rect(110, 80 - _v(3, 0.697) * 66, 22, _v(3, 0.697) * 66, 3, theme.a.withValues(alpha: 0.260), true, 1.8), _Op.rect(144, 80 - _v(4, 1) * 66, 22, _v(4, 1) * 66, 3, skin.ink, true, 1.8, g: [theme.aHi, theme.a], gs: [0.00, 1.00], gv: [0.00, 0.00, 0.00, 1.00]), _Op.rect(178, 80 - _v(5, 0.5152) * 66, 22, _v(5, 0.5152) * 66, 3, theme.a.withValues(alpha: 0.260), true, 1.8), _Op.rect(212, 80 - _v(6, 0.3636) * 66, 22, _v(6, 0.3636) * 66, 3, theme.a.withValues(alpha: 0.260), true, 1.8), _Op.text(_f(2, "86"), 155, 9, 9.5, skin.mut, 1, fonts.grotesk), _Op.text(_f(3, "01"), 19, 92, 9, skin.faint, 0, fonts.grotesk), _Op.text(_f(4, "04"), 121, 92, 9, skin.faint, 0, fonts.grotesk), _Op.text(_f(5, "07"), 223, 92, 9, skin.faint, 0, fonts.grotesk)], 240, 96))); })]), child));
    return body;
  }
}
