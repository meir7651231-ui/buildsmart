...
class ForgeBarChart extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "12%"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
