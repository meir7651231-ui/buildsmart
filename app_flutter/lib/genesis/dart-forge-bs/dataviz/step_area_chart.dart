...
class ForgeStepAreaChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 11, children: [Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("Label"), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("92", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("%")])]), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 0 88 L 240 88 M2,68 H40 V50 H78 V58 H116 V32 H154 V40 H192 V22 H238 M2,68 H40 V50 H78 V58 H116 V32 H154 V40 H192 V22 H238 V88 H2 Z", skin.mut, 1.8, false, 240))]));
  }
}
