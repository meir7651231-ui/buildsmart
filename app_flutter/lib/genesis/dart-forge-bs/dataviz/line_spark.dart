...
class ForgeLineSpark extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 12, 16, 12), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 2, children: [Container(padding: const EdgeInsets.fromLTRB(2, 3, 2, 3), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 58, child: Text("Label", style: TextStyle(color: skin.mut, fontSize: 12, fontFamily: fonts.he))), Expanded(child: SizedBox(height: 30, child: LayoutBuilder(builder: (ctx, cns) => SizedBox(width: cns.maxWidth.isFinite ? cns.maxWidth : 200, height: 30, child: CustomPaint(painter: _SvgScene([_Op.path("M2,22 L26,18 L50,20 L74,10 L98,14 L122,6 L146,12 L170,4 L198,8", theme.aHi, false, 2), _Op.circle(170, 4, 2.6, theme.aHi, true, 1.8)], 200, 30)))))), Directionality(textDirection: TextDirection.ltr, child: Container(constraints: const BoxConstraints(minWidth: 44), child: Text("+18%", style: TextStyle(color: skin.ok, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 14, fontWeight: FontWeight.w700))))])), Container(padding: const EdgeInsets.fromLTRB(2, 3, 2, 3), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 58, child: Text("Label", style: TextStyle(color: skin.mut, fontSize: 12, fontFamily: fonts.he))), Expanded(child: SizedBox(height: 30, child: LayoutBuilder(builder: (ctx, cns) => SizedBox(width: cns.maxWidth.isFinite ? cns.maxWidth : 200, height: 30, child: CustomPaint(painter: _SvgScene([_Op.path("M2,8 L26,12 L50,10 L74,16 L98,14 L122,20 L146,18 L170,24 L198,22", theme.c2, false, 2), _Op.circle(170, 24, 2.6, theme.c2, true, 1.8)], 200, 30)))))), Directionality(textDirection: TextDirection.ltr, child: Container(constraints: const BoxConstraints(minWidth: 44), child: Text("-6%", style: TextStyle(color: skin.err, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 14, fontWeight: FontWeight.w700))))])), Container(padding: const EdgeInsets.fromLTRB(2, 3, 2, 3), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair2, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 58, child: Text("Label", style: TextStyle(color: skin.mut, fontSize: 12, fontFamily: fonts.he))), Expanded(child: SizedBox(height: 30, child: LayoutBuilder(builder: (ctx, cns) => SizedBox(width: cns.maxWidth.isFinite ? cns.maxWidth : 200, height: 30, child: CustomPaint(painter: _SvgScene([_Op.path("M2,16 L26,14 L50,18 L74,12 L98,15 L122,11 L146,14 L170,9 L198,12", theme.c3, false, 2), _Op.circle(170, 9, 2.6, theme.c3, true, 1.8)], 200, 30)))))), Directionality(textDirection: TextDirection.ltr, child: Container(constraints: const BoxConstraints(minWidth: 44), child: Text("+3%", style: TextStyle(color: skin.ok, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 14, fontWeight: FontWeight.w700))))]))]));
  }
}
