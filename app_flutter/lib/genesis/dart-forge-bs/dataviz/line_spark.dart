...
class ForgeLineSpark extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 12, 16, 12), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 2, children: [Container(padding: const EdgeInsets.fromLTRB(2, 3, 2, 3), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Text("Label"), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2,22 L26,18 L50,20 L74,10 L98,14 L122,6 L146,12 L170,4 L198,8 M 167.4 4 a 2.6 2.6 0 1 0 5.2 0 a 2.6 2.6 0 1 0 -5.2 0", skin.mut, 1.8, false, 200)), Text("+18%", style: TextStyle(color: skin.ok))])), Container(padding: const EdgeInsets.fromLTRB(2, 3, 2, 3), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Text("Label"), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2,8 L26,12 L50,10 L74,16 L98,14 L122,20 L146,18 L170,24 L198,22 M 167.4 24 a 2.6 2.6 0 1 0 5.2 0 a 2.6 2.6 0 1 0 -5.2 0", skin.mut, 1.8, false, 200)), Text("-6%", style: TextStyle(color: skin.err))])), Container(padding: const EdgeInsets.fromLTRB(2, 3, 2, 3), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Text("Label"), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2,16 L26,14 L50,18 L74,12 L98,15 L122,11 L146,14 L170,9 L198,12 M 167.4 9 a 2.6 2.6 0 1 0 5.2 0 a 2.6 2.6 0 1 0 -5.2 0", skin.mut, 1.8, false, 200)), Text("+3%", style: TextStyle(color: skin.ok))]))]));
  }
}
