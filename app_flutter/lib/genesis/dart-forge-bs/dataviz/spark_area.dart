...
/// SparkArea — seam:fields · 2 חריצים
class ForgeSparkArea extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "21%"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
