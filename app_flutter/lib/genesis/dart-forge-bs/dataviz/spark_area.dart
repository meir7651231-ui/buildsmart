...
class ForgeSparkArea extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 13), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label"), Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 3, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M7 17L17 7M17 7H9M17 7v8", skin.mut, 1.8, false, 24)), Text("21%", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])]), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M2,34 L34,28 L66,32 L98,18 L130,24 L162,10 L194,16 L238,6 L238,46 L2,46 Z M2,34 L34,28 L66,32 L98,18 L130,24 L162,10 L194,16 L238,6", skin.mut, 1.8, false, 240))]));
  }
}
