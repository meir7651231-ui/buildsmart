...
class ForgeLinkRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(18, 18, 18, 18), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("שורה עם", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("קישור מודגש", style: TextStyle(color: theme.aHi, fontWeight: FontWeight.w600)), Text("וגם", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("קו תחתון", style: TextStyle(color: theme.aHi)), Text("בתוך פסקה — כל מצב נגזר מ-var(--a).", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Container(margin: const EdgeInsets.fromLTRB(0, 12, 0, 0), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 10, children: [Text("Label"), Text("·"), Text("Label"), Text("·"), Text("Meta")])]))]));
  }
}
