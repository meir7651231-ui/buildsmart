...
class ForgeNumberedList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.symmetric(vertical: 22, horizontal: 24), decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("Label"), Text("— שלב ראשון בתהליך.", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Text("שלב שני, טקסט ממשיך בשורה נוחה."), Text("Meta · שלב שלישי.")]));
  }
}
