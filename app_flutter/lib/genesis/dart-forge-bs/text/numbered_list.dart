...
class ForgeNumberedList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(24, 22, 24, 22), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he)), Text("— שלב ראשון בתהליך.", style: TextStyle(color: skin.mut, fontFamily: fonts.he))]), Text("שלב שני, טקסט ממשיך בשורה נוחה.", style: TextStyle(color: skin.mut, fontFamily: fonts.he)), Text("Meta · שלב שלישי.", style: TextStyle(color: skin.mut, fontFamily: fonts.he))]));
  }
}
