...
class ForgeGradientText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(24, 22, 24, 22), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.c2, theme.a, theme.c3], begin: Alignment.topCenter, end: Alignment.bottomCenter)), child: Text("כותרת מדורגת", style: TextStyle(color: skin.ink, fontFamily: fonts.serifHe, fontSize: 34, fontWeight: FontWeight.w700))), Container(margin: const EdgeInsets.fromLTRB(0, 16, 0, 0), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.c2, theme.a, theme.c3], begin: Alignment.topCenter, end: Alignment.bottomCenter)), child: Text("GRADIENT · TEXT", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 22, fontWeight: FontWeight.w700)))]));
  }
}
