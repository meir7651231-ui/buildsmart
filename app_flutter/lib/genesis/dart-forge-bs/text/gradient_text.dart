...
class ForgeGradientText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(24, 22, 24, 22), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [ShaderMask(shaderCallback: (b) => LinearGradient(colors: [theme.c2, theme.a, theme.c3], begin: Alignment.topCenter, end: Alignment.bottomCenter).createShader(b), blendMode: BlendMode.srcIn, child: Text("כותרת מדורגת", style: TextStyle(color: const Color(0xFFFFFFFF), fontFamily: fonts.serifHe, fontSize: 34, fontWeight: FontWeight.w700, letterSpacing: -0.34, height: 1.08, leadingDistribution: TextLeadingDistribution.even))), const SizedBox(height: 16), Directionality(textDirection: TextDirection.ltr, child: ShaderMask(shaderCallback: (b) => LinearGradient(colors: [theme.c2, theme.a, theme.c3], begin: Alignment.topCenter, end: Alignment.bottomCenter).createShader(b), blendMode: BlendMode.srcIn, child: Text("GRADIENT · TEXT", style: TextStyle(color: const Color(0xFFFFFFFF), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 22, fontWeight: FontWeight.w700, letterSpacing: 2, height: 1.08, leadingDistribution: TextLeadingDistribution.even))))]));
  }
}
