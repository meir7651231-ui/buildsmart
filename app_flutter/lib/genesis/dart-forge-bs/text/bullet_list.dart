...
class ForgeBulletList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(24, 22, 24, 22), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(margin: const EdgeInsets.fromLTRB(0, 8, 0, 8), child: Stack(clipBehavior: Clip.none, children: [Text.rich(TextSpan(children: [TextSpan(text: "Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 14, fontWeight: FontWeight.w600, height: 1.75)), TextSpan(text: "— לורם איפסום דולור סיט אמט קונסקטורר.", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 14, height: 1.75))])), Positioned(top: 8.68, right: 3, child: const SizedBox.shrink())])), Container(margin: const EdgeInsets.fromLTRB(0, 8, 0, 8), child: Text("אדיפיסינג אלית, שורה שנייה ברוחב נוח.", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 14, height: 1.75))), Container(margin: const EdgeInsets.fromLTRB(0, 8, 0, 8), child: Text("Meta · פריט שלישי קצר.", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 14, height: 1.75)))]));
  }
}
