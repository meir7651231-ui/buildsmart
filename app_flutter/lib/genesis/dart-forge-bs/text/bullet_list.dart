...
class ForgeBulletList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.symmetric(vertical: 22, horizontal: 24), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("Label"), Text("— לורם איפסום דולור סיט אמט קונסקטורר.", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Text("אדיפיסינג אלית, שורה שנייה ברוחב נוח."), Text("Meta · פריט שלישי קצר.")]));
  }
}
