...
class ForgeMetaTicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(decoration: BoxDecoration(color: skin.sunken), child: const SizedBox.shrink()), Container(padding: const EdgeInsets.fromLTRB(16, 12, 16, 16), child: Directionality(textDirection: TextDirection.ltr, child: Text("Meta ticker — Label · Value pairs streaming, one row, tabular. Reduced-motion parks it.", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 11, fontFeatures: const [FontFeature.tabularFigures()]))))]);
  }
}
