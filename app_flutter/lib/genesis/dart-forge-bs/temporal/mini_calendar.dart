...
/// MiniCalendar — seam:fields · 9 חריצים
class ForgeMiniCalendar extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "2026", "א", "ב", "ג", "ד", "ה", "ו", "ש"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeMiniCalendar({super.key, this.fields, this.child, this.onAction});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Container(width: 44, height: 44, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 15, height: 15, child: CustomPaint(painter: _SvgScene([_Op.path("M9 6l6 6-6 6", skin.mut, false, 1.8)], 24, 24))))), Text.rich(TextSpan(children: [TextSpan(text: _f(0, "Label"), style: TextStyle(color: skin.ink, fontFamily: fonts.serifHe, fontSize: 17)), WidgetSpan(alignment: PlaceholderAlignment.middle, child: _hide(_f(1, "2026"), Directionality(textDirection: TextDirection.ltr, child: Container(margin: const EdgeInsets.fromLTRB(0, 0, 6, 0), child: Text(_f(1, "2026"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 12, fontFeatures: const [FontFeature.tabularFigures()]))))))])), GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(1), child: Container(width: 44, height: 44, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 15, height: 15, child: CustomPaint(painter: _SvgScene([_Op.path("M15 6l-6 6 6 6", skin.mut, false, 1.8)], 24, 24)))))]), const SizedBox(height: 12), Row(crossAxisAlignment: CrossAxisAlignment.center, spacing: 3, children: [Expanded(flex: 1, child: Text(_f(2, "א"), textAlign: TextAlign.center, style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, letterSpacing: 0.48))), Expanded(flex: 1, child: Text(_f(3, "ב"), textAlign: TextAlign.center, style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, letterSpacing: 0.48))), Expanded(flex: 1, child: Text(_f(4, "ג"), textAlign: TextAlign.center, style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, letterSpacing: 0.48))), Expanded(flex: 1, child: Text(_f(5, "ד"), textAlign: TextAlign.center, style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, letterSpacing: 0.48))), Expanded(flex: 1, child: Text(_f(6, "ה"), textAlign: TextAlign.center, style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, letterSpacing: 0.48))), Expanded(flex: 1, child: Text(_f(7, "ו"), textAlign: TextAlign.center, style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, letterSpacing: 0.48))), Expanded(flex: 1, child: Text(_f(8, "ש"), textAlign: TextAlign.center, style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, letterSpacing: 0.48)))]), const SizedBox(height: 5), const SizedBox.shrink()]), child));
    return body;
  }
}
