...
/// FilterBar — seam:collection · 4 חריצים
class ForgeFilterBar extends StatelessWidget {
  ...
  const ForgeFilterBar({super.key, this.fields, this.child, this.control, this.onAction, this.items, this.selected, this.onSelect});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(16, 14, 16, 14), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: _withChild(Wrap(spacing: 12, runSpacing: 12, crossAxisAlignment: WrapCrossAlignment.center, children: [Container(constraints: const BoxConstraints(minWidth: 170), child: SizedBox(width: double.infinity, child: Stack(clipBehavior: Clip.none, children: [Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [Expanded(child: (control == null ? Directionality(textDirection: TextDirection.rtl, child: SizedBox(width: double.infinity, child: Container(height: 44, constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 0, 40, 0), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: Align(alignment: Alignment.centerRight, child: Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 13)))))) : Padding(padding: const EdgeInsets.fromLTRB(13, 0, 40, 0), child: control!)))]), Positioned(right: 13, top: 0, bottom: 0, child: Align(alignment: Alignment.center, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 16, height: 16, child: CustomPaint(painter: _SvgScene([_Op.circle(11, 11, 7, skin.mut, false, 1.8), _Op.path("M21 21l-4-4", skin.mut, false, 1.8)], 24, 24)))])))]))), Container(width: 1, margin: const EdgeInsets.fromLTRB(2, 0, 2, 0), decoration: BoxDecoration(color: skin.hair)), Wrap(spacing: 7, runSpacing: 7, crossAxisAlignment: WrapCrossAlignment.center, children: [...(items == null ? <Widget>[Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 8, 13, 8), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.120), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [SizedBox(width: 13, height: 13, child: CustomPaint(painter: _SvgScene([_Op.path("M5 13l4 4L19 7", theme.aHi, false, 1.8)], 24, 24))), Text(_f(0, "Label"), style: TextStyle(color: theme.aHi, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600))]))), _hide(_f(1, "Label"), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 8, 13, 8), decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Text(_f(1, "Label"), style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600))))), _hide(_f(2, "Label"), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 8, 13, 8), decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Text(_f(2, "Label"), style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600)))))] : List<Widget>.generate(items!.length, (i) => ((selected?.contains(i) ?? false) ? GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 8, 13, 8), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.120), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [SizedBox(width: 13, height: 13, child: CustomPaint(painter: _SvgScene([_Op.path("M5 13l4 4L19 7", theme.aHi, false, 1.8)], 24, 24))), Text(_it(items![i], 0, "Label"), style: TextStyle(color: theme.aHi, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600))])))) : GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: _hide(_it(items![i], 0, "Label"), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 8, 13, 8), decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Text(_it(items![i], 0, "Label"), style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600)))))))))]), GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 8, 13, 8), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [SizedBox(width: 15, height: 15, child: CustomPaint(painter: _SvgScene([_Op.path("M3 6h18M6 12h12M9 18h6", skin.ink, false, 1.8)], 24, 24))), Text(_f(3, "Label"), style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600))]))))]), child));
    return body;
  }
}
