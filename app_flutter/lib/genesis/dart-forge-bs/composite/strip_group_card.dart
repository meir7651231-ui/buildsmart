...
/// StripGroupCard — seam:fields · 9 חריצים
class ForgeStripGroupCard extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "Meta", "Label", "Meta", "Value", "Label", "Meta", "Label", "Meta"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
