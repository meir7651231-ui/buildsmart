...
class ForgeSummaryStatStrip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(18)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(18, 16, 18, 14), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 38, height: 38, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [theme.gl, skin.sunken], stops: [0.0, 0.60]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 3, 7, 7, 1.5, theme.aHi, false, 1.8), _Op.rect(14, 3, 7, 7, 1.5, theme.aHi, false, 1.8), _Op.rect(3, 14, 7, 7, 1.5, theme.aHi, false, 1.8), _Op.rect(14, 14, 7, 7, 1.5, theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 14, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text("Meta", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 11)))]))])), Container(padding: const EdgeInsets.fromLTRB(18, 18, 18, 18), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 14, children: [Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text("14", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1)))]))), Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text.rich(TextSpan(children: [TextSpan(text: "7.4", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1)), TextSpan(text: "k", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 14, fontWeight: FontWeight.w700, letterSpacing: -0.28, height: 1))])))]))), Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text("36", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1)))]))), Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text("5", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1)))])))]))]))]));
  }
}
