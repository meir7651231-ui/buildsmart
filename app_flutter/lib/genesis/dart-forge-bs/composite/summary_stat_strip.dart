...
class ForgeSummaryStatStrip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(18)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(18, 16, 18, 14), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 38, height: 38, decoration: BoxDecoration(color: theme.gl, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 3 h 7 v 7 h -7 Z M 14 3 h 7 v 7 h -7 Z M 3 14 h 7 v 7 h -7 Z M 14 14 h 7 v 7 h -7 Z", theme.aHi, 1.8, false, 24))), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("Meta", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])])), Container(padding: const EdgeInsets.fromLTRB(18, 18, 18, 18), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 14, children: [Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Text("14", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: 02, height: 1))])), Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("7.4", style: TextStyle(color: theme.aHi, fontFamily: fonts.he)), Text("k", style: TextStyle(color: skin.mut, fontSize: 14, fontFamily: fonts.he))])])), Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Text("36", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: 02, height: 1))])), Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Text("5", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: 02, height: 1))]))]))]))]));
  }
}
