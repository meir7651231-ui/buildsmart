...
/// RequestComposer — seam:self · 3 חריצים
class ForgeRequestComposer extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "Meta", "Value"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  /// G13a · קבוצת-פריטים: items[i] = חריצי-הטקסט של פריט i (0 חריצים · 3 בדמו · לחיץ: onSelect(i)). null ⇒ פריטי-העיצוב.
  ...
  const ForgeRequestComposer({super.key, this.fields, this.child, this.onAction, this.items, this.onSelect});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(18)), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(18, 16, 18, 14), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 38, height: 38, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [theme.gl, skin.sunken], stops: [0.0, 0.60]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.path("M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z", theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text(_f(0, "Label"), style: TextStyle(color: skin.ink, fontSize: 14, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text(_f(1, "Meta"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11)))]))])), _hide(_f(2, "Value"), Container(padding: const EdgeInsets.fromLTRB(18, 18, 18, 14), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 14, children: [_hide(_f(2, "Value"), Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [_hide(_f(2, "Value"), Directionality(textDirection: TextDirection.rtl, child: SizedBox(width: double.infinity, child: Container(constraints: const BoxConstraints(minHeight: 84), padding: const EdgeInsets.fromLTRB(16, 14, 16, 14), child: Text(_f(2, "Value"), textAlign: TextAlign.right, style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 14, height: 1.55, leadingDistribution: TextLeadingDistribution.even)))))), Container(padding: const EdgeInsets.fromLTRB(10, 8, 10, 8), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [...(items == null ? <Widget>[Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.path("M21 12l-9 9a5 5 0 01-7-7l9-9a3.5 3.5 0 015 5l-9 9a2 2 0 01-3-3l8-8", skin.mut, false, 1.8)], 24, 24)))), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 3, 18, 18, 2, skin.mut, false, 1.8), _Op.circle(9, 9, 2, skin.mut, false, 1.8), _Op.path("M21 15l-5-5L5 21", skin.mut, false, 1.8)], 24, 24)))), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 12, 4, skin.mut, false, 1.8), _Op.path("M16 8v5a3 3 0 006 0v-1a10 10 0 10-4 8", skin.mut, false, 1.8)], 24, 24))))] : List<Widget>.generate(items!.length, (i) => Flexible(child: GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.path("M21 12l-9 9a5 5 0 01-7-7l9-9a3.5 3.5 0 015 5l-9 9a2 2 0 01-3-3l8-8", skin.mut, false, 1.8)], 24, 24)))))))), Expanded(child: const SizedBox.shrink()), GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(999)), child: SizedBox(width: 17, height: 17, child: CustomPaint(painter: _SvgScene([_Op.path("M22 2L11 13M22 2l-7 20-4-9-9-4z", skin.onA, false, 1.8)], 24, 24)))))]))])))])))]), child));
    return body;
  }
}
