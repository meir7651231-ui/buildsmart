...
class ForgeStatClusterCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(18)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(18, 16, 18, 14), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 38, height: 38, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [theme.gl, skin.sunken], stops: [0.0, 0.60]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.path("M4 20V10M12 20V4M20 20v-6", theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 14, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text("Meta · overview", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 11)))])), Container(padding: const EdgeInsets.fromLTRB(12, 7, 12, 7), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Text("Option", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600)), SizedBox(width: 14, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M6 9l6 6 6-6", skin.ink, false, 1.8)], 24, 24)))])))])), Container(padding: const EdgeInsets.fromLTRB(18, 18, 18, 18), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 14, children: [Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text("248", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1, leadingDistribution: TextLeadingDistribution.even))), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M7 17L17 7M17 7H9M17 7v8", skin.ok, false, 1.8)], 24, 24))), Text("12%", style: TextStyle(color: skin.ok, fontFamily: fonts.grotesk, fontSize: 11, fontWeight: FontWeight.w600))]))]))), Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text("1,024", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1, leadingDistribution: TextLeadingDistribution.even))), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M7 7l10 10M17 17H9M17 17V9", skin.err, false, 1.8)], 24, 24))), Text("4%", style: TextStyle(color: skin.err, fontFamily: fonts.grotesk, fontSize: 11, fontWeight: FontWeight.w600))]))]))), Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text("Label", style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text("92%", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1, leadingDistribution: TextLeadingDistribution.even))), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [SizedBox(width: 11, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M7 17L17 7M17 7H9M17 7v8", skin.ok, false, 1.8)], 24, 24))), Text("8%", style: TextStyle(color: skin.ok, fontFamily: fonts.grotesk, fontSize: 11, fontWeight: FontWeight.w600))]))])))]))]))]));
  }
}
