...
class ForgeCartSummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(18)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(18, 16, 18, 16), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 38, height: 38, decoration: BoxDecoration(color: theme.gl, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M6 6h15l-1.5 9h-12zM6 6L5 3H2M9 20a1 1 0 11-2 0 1 1 0 012 0zM19 20a1 1 0 11-2 0 1 1 0 012 0z", theme.aHi, 1.8, false, 24))), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("Meta · 3 items", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])])), Container(padding: const EdgeInsets.fromLTRB(18, 18, 18, 18), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(0, 11, 0, 11), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 32, height: 32, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: Text("2", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 12, fontWeight: FontWeight.w600))), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("Meta", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Text("124", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13.5))])), Container(padding: const EdgeInsets.fromLTRB(0, 11, 0, 11), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 32, height: 32, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: Text("1", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 12, fontWeight: FontWeight.w600))), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("Meta", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Text("86", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13.5))])), Container(padding: const EdgeInsets.fromLTRB(0, 11, 0, 11), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 32, height: 32, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: Text("4", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 12, fontWeight: FontWeight.w600))), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("Meta", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Text("212", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13.5))]))])), Container(padding: const EdgeInsets.fromLTRB(18, 14, 18, 14), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he)), Text("422", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk))]), Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he)), Text("38", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk))]), Container(padding: const EdgeInsets.fromLTRB(0, 14, 0, 0), child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w700, fontFamily: fonts.he)), Text("460", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 22, fontWeight: FontWeight.w700, letterSpacing: 02))]))]))]));
  }
}
