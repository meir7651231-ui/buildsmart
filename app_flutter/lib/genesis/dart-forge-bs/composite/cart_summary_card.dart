...
class ForgeCartSummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(18)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(18, 16, 18, 16), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 38, height: 38, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [theme.gl, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.path("M6 6h15l-1.5 9h-12zM6 6L5 3H2M9 20a1 1 0 11-2 0 1 1 0 012 0zM19 20a1 1 0 11-2 0 1 1 0 012 0z", theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 14, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Text("Meta · 3 items", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 11))]))])), Container(padding: const EdgeInsets.fromLTRB(18, 18, 18, 18), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(0, 11, 0, 11), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 32, height: 32, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: Text("2", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 12, fontWeight: FontWeight.w600))), Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Text("Meta", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 10))])), Text("124", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13.5))])), Container(padding: const EdgeInsets.fromLTRB(0, 11, 0, 11), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 32, height: 32, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: Text("1", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 12, fontWeight: FontWeight.w600))), Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Text("Meta", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 10))])), Text("86", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13.5))])), Container(padding: const EdgeInsets.fromLTRB(0, 11, 0, 11), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 32, height: 32, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(9)), child: Text("4", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 12, fontWeight: FontWeight.w600))), Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Text("Meta", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 10))])), Text("212", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 13.5))]))])), Container(padding: const EdgeInsets.fromLTRB(18, 14, 18, 14), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he)), Text("422", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk))]), Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he)), Text("38", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk))]), Container(padding: const EdgeInsets.fromLTRB(0, 14, 0, 0), child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w700, fontFamily: fonts.he)), Text("460", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 22, fontWeight: FontWeight.w700, letterSpacing: -0.44))]))]))]));
  }
}
