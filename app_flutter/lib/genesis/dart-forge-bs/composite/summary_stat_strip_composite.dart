...
/// SummaryStatStrip — seam:collection · 11 חריצים
class ForgeSummaryStatStripComposite extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "Meta", "Label", "14", "Label", "7.4", "k", "Label", "36", "Label", "5"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeSummaryStatStripComposite({super.key, this.fields, this.child, this.items});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(18)), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(18, 16, 18, 14), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: skin.hair, width: 1))), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 38, height: 38, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [theme.gl, skin.sunken], stops: [0.0, 0.60]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 19, height: 19, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 3, 7, 7, 1.5, theme.aHi, false, 1.8), _Op.rect(14, 3, 7, 7, 1.5, theme.aHi, false, 1.8), _Op.rect(3, 14, 7, 7, 1.5, theme.aHi, false, 1.8), _Op.rect(14, 14, 7, 7, 1.5, theme.aHi, false, 1.8)], 24, 24)))), Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text(_f(0, "Label"), style: TextStyle(color: skin.ink, fontSize: 14, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Text(_f(1, "Meta"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11)))]))])), Container(padding: const EdgeInsets.fromLTRB(18, 18, 18, 18), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 14, children: [Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [...(items == null ? <Widget>[Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text(_f(2, "Label"), style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), SizedBox(width: double.infinity, child: Directionality(textDirection: TextDirection.ltr, child: Text(_f(3, "14"), style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1, leadingDistribution: TextLeadingDistribution.even))))]))), Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text(_f(4, "Label"), style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), SizedBox(width: double.infinity, child: Directionality(textDirection: TextDirection.ltr, child: Text.rich(TextSpan(children: [TextSpan(text: _f(5, "7.4"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1, leadingDistribution: TextLeadingDistribution.even)), TextSpan(text: _f(6, "k"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 14, fontWeight: FontWeight.w700, letterSpacing: -0.28, height: 1, leadingDistribution: TextLeadingDistribution.even))]))))]))), Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text(_f(7, "Label"), style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), SizedBox(width: double.infinity, child: Directionality(textDirection: TextDirection.ltr, child: Text(_f(8, "36"), style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1, leadingDistribution: TextLeadingDistribution.even))))]))), Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text(_f(9, "Label"), style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), SizedBox(width: double.infinity, child: Directionality(textDirection: TextDirection.ltr, child: Text(_f(10, "5"), style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1, leadingDistribution: TextLeadingDistribution.even))))])))] : List<Widget>.generate(items!.length, (i) => Expanded(child: Container(padding: const EdgeInsets.fromLTRB(16, 15, 16, 15), decoration: BoxDecoration(border: Border(right: BorderSide(color: skin.hair, width: 1))), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Text(_it(items![i], 0, "Label"), style: TextStyle(color: skin.mut, fontSize: 10.5, fontWeight: FontWeight.w600, fontFamily: fonts.he)), SizedBox(width: double.infinity, child: Directionality(textDirection: TextDirection.ltr, child: Text(_it(items![i], 1, "14"), style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 26, fontWeight: FontWeight.w700, letterSpacing: -0.52, height: 1, leadingDistribution: TextLeadingDistribution.even))))])))))]))]))]), child));
    return body;
  }
}
