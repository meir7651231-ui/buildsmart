...
/// PageHeader — seam:title+actions · 4 חריצים
class ForgePageHeader extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["SECTION", "Label", "Meta · a one-line summary of what this page holds, kept quiet in muted ink.", "Action"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgePageHeader({super.key, this.fields, this.child, this.onAction, this.items, this.onSelect});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(22, 20, 22, 20), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: _withChild(Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 16, children: [Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Directionality(textDirection: TextDirection.ltr, child: Container(margin: const EdgeInsets.fromLTRB(0, 0, 0, 8), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Container(width: 22, height: 1, decoration: BoxDecoration(color: theme.a)), Text(_f(0, "SECTION"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 10, fontWeight: FontWeight.w600, letterSpacing: 2))]))), Text(_f(1, "Label"), style: TextStyle(color: skin.ink, fontFamily: fonts.serifHe, fontSize: 24, fontWeight: FontWeight.w700, letterSpacing: -0.24, height: 1.05, leadingDistribution: TextLeadingDistribution.even)), const SizedBox(height: 7), _hide(_f(2, "Meta · a one-line summary of what this page holds, kept quiet in muted ink."), IntrinsicWidth(child: Text(_f(2, "Meta · a one-line summary of what this page holds, kept quiet in muted ink."), style: TextStyle(color: skin.mut, fontSize: 12.5, height: 1.45, leadingDistribution: TextLeadingDistribution.even, fontFamily: fonts.he))))])), ...(items == null ? <Widget>[Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.circle(11, 11, 7, skin.mut, false, 1.8), _Op.path("M21 21l-4-4", skin.mut, false, 1.8)], 24, 24)))), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.path("M12 5v14M5 12h14", skin.mut, false, 1.8)], 24, 24))))] : List<Widget>.generate(items!.length, (i) => Flexible(child: GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.circle(11, 11, 7, skin.mut, false, 1.8), _Op.path("M21 21l-4-4", skin.mut, false, 1.8)], 24, 24)))))))), GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(15, 9, 15, 9), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(11)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 7, children: [SizedBox(width: 15, height: 15, child: CustomPaint(painter: _SvgScene([_Op.path("M12 5v14M5 12h14", skin.sunken, false, 1.8)], 24, 24))), Text(_f(3, "Action"), style: TextStyle(color: skin.sunken, fontFamily: fonts.he, fontSize: 12, fontWeight: FontWeight.w600))]))))]), child));
    return body;
  }
}
