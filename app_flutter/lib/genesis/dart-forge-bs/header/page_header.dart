...
class ForgePageHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(22, 20, 22, 20), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 16, children: [Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(margin: const EdgeInsets.fromLTRB(0, 0, 0, 8), child: Text("SECTION", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 10, fontWeight: FontWeight.w600, letterSpacing: 2))), Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.serifHe, fontSize: 24, fontWeight: FontWeight.w700, letterSpacing: 01, height: 1.05)), Container(margin: const EdgeInsets.fromLTRB(0, 7, 0, 0), child: Text("Meta · a one-line summary of what this page holds, kept quiet in muted ink.", style: TextStyle(color: skin.mut, fontSize: 12.5, height: 1.45, fontFamily: fonts.he)))]), Container(width: 40, height: 40, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 4 11 a 7 7 0 1 0 14 0 a 7 7 0 1 0 -14 0 M21 21l-4-4", skin.mut, 1.8, false, 24))), Container(width: 40, height: 40, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 5v14M5 12h14", skin.mut, 1.8, false, 24))), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(15, 9, 15, 9), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(11)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 7, children: [CustomPaint(size: const Size(15, 15), painter: _SvgPaint("M12 5v14M5 12h14", const Color(0xFF0A0A0C), 1.8, false, 24)), Text("Action", style: TextStyle(color: const Color(0xFF0A0A0C), fontFamily: fonts.he))]))]));
  }
}
