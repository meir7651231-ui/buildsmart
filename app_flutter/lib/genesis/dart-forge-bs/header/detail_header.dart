...
/// DetailHeader — seam:title+actions · 3 חריצים
class ForgeDetailHeader extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["SECTION", "Label", "Action"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
