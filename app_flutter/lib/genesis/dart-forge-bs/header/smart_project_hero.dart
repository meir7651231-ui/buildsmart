...
/// SmartProjectHero — seam:title · 3 חריצים
class ForgeSmartProjectHero extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["PROJECT", "Label", "Meta"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
