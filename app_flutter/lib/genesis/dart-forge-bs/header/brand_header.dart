...
class ForgeBrandHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(18, 15, 18, 15), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Wrap(spacing: 14, runSpacing: 14, crossAxisAlignment: WrapCrossAlignment.center, children: [Container(width: 42, height: 42, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(12), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 6), blurRadius: 18, spreadRadius: 0)]), child: Text("L", style: TextStyle(color: const Color(0xFF0A0A0C), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 18, fontWeight: FontWeight.w700))), Directionality(textDirection: TextDirection.ltr, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.serif, fontFamilyFallback: [fonts.serifHe], fontSize: 19, fontWeight: FontWeight.w600, letterSpacing: -0.38)), const SizedBox(height: 2), Text("META", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9, fontWeight: FontWeight.w600, letterSpacing: 2))])), SizedBox(width: double.infinity, child: Wrap(spacing: 4, runSpacing: 4, crossAxisAlignment: WrapCrossAlignment.center, children: [Container(padding: const EdgeInsets.fromLTRB(12, 7, 12, 7), decoration: BoxDecoration(borderRadius: BorderRadius.circular(9)), child: Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 12.5))), Container(padding: const EdgeInsets.fromLTRB(12, 7, 12, 7), decoration: BoxDecoration(borderRadius: BorderRadius.circular(9)), child: Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12.5))), Container(padding: const EdgeInsets.fromLTRB(12, 7, 12, 7), decoration: BoxDecoration(borderRadius: BorderRadius.circular(9)), child: Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12.5))), Container(padding: const EdgeInsets.fromLTRB(12, 7, 12, 7), decoration: BoxDecoration(borderRadius: BorderRadius.circular(9)), child: Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12.5)))])), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 8, 4, skin.mut, false, 1.8), _Op.path("M4 20a8 8 0 0116 0", skin.mut, false, 1.8)], 24, 24))))]));
  }
}
