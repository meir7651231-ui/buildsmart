...
class ForgeCartFabButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(width: 52, height: 52, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(16), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 12), blurRadius: 26, spreadRadius: 0)]), child: Stack(clipBehavior: Clip.none, children: [CustomPaint(size: const Size(22, 22), painter: _SvgPaint("M4 5h2l2 11h9l2-7H7 M 9 20 a 1 1 0 1 0 2 0 a 1 1 0 1 0 -2 0 M 16 20 a 1 1 0 1 0 2 0 a 1 1 0 1 0 -2 0", const Color(0xFF0B0B0D), 1.8, false, 24)), Positioned(top: -4, left: -4, child: Container(width: 18, height: 18, decoration: BoxDecoration(color: theme.c3, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(50)), child: Text("2", style: TextStyle(color: const Color(0xFF0B0B0D), fontFamily: fonts.grotesk, fontSize: 9, fontWeight: FontWeight.w700))))]));
  }
}
