...
/// CartFabButton — seam:fields
class ForgeCartFabButton extends StatelessWidget {
  const ForgeCartFabButton({super.key});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    return Container(width: 52, height: 52, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(16), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 12), blurRadius: 26, spreadRadius: 0)]), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [SizedBox(width: 22, height: 22, child: CustomPaint(painter: _SvgScene([_Op.path("M4 5h2l2 11h9l2-7H7", const Color(0xFF0B0B0D), false, 1.8), _Op.circle(10, 20, 1, const Color(0xFF0B0B0D), false, 1.8), _Op.circle(17, 20, 1, const Color(0xFF0B0B0D), false, 1.8)], 24, 24))), Positioned(top: -4, right: -4, child: Container(width: 18, height: 18, alignment: Alignment.center, decoration: BoxDecoration(color: theme.c3, border: Border.all(color: skin.canvas, width: 2), borderRadius: BorderRadius.circular(999)), child: Text("2", style: TextStyle(color: const Color(0xFF0B0B0D), fontFamily: fonts.grotesk, fontSize: 9, fontWeight: FontWeight.w700))))]));
  }
}
