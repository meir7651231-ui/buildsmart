...
class ForgeAnimatedToggle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget body = GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Container(width: 46, height: 27, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.centerLeft, end: Alignment.centerRight), border: Border.all(color: skin.hi.withValues(alpha: 0.18)), borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 3), blurRadius: 10, spreadRadius: 0), BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 14, spreadRadius: 0)]), child: _withChild(Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: const SizedBox.shrink()), Positioned(top: 2, right: 2, width: 21, child: Container(width: 21, height: 21, alignment: Alignment.center, decoration: BoxDecoration(color: skin.hi, borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: skin.shade.withValues(alpha: 0.35), offset: const Offset(0, 2), blurRadius: 4, spreadRadius: 0)]), child: SizedBox(width: 12, height: 12, child: CustomPaint(painter: _SvgScene([_Op.path("M5 13l4 4L19 7", skin.ink, false, 1.8)], 24, 24)))))]), child)));
    return body;
  }
}
