...
class ForgeAnimatedToggle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(width: 46, height: 27, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.centerLeft, end: Alignment.centerRight), border: Border.all(color: const Color(0x2EFFFFFF)), borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 3), blurRadius: 10, spreadRadius: 0), BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 14, spreadRadius: 0)]), child: Stack(clipBehavior: Clip.none, children: [Positioned(top: 2, right: 2, child: Container(width: 21, height: 21, alignment: Alignment.center, decoration: BoxDecoration(color: const Color(0xFFFFFFFF), borderRadius: BorderRadius.circular(50), boxShadow: [BoxShadow(color: const Color(0x59000000), offset: const Offset(0, 2), blurRadius: 4, spreadRadius: 0)]), child: SizedBox(width: 12, height: 12, child: CustomPaint(painter: _SvgScene([_Op.path("M5 13l4 4L19 7", skin.ink, false, 1.8)], 24, 24)))))]));
  }
}
