...
/// QuickActionButton — seam:fields
class ForgeQuickActionButton extends StatelessWidget {
  const ForgeQuickActionButton({super.key});
  @override
  Widget build(BuildContext context) {
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    return Container(height: 44, decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.16), border: Border.all(color: theme.a.withValues(alpha: 0.30)), borderRadius: BorderRadius.circular(11)), child: Center(widthFactor: 1.0, child: Stack(clipBehavior: Clip.none, children: [Padding(padding: const EdgeInsets.fromLTRB(16, 0, 16, 0), child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, spacing: 7, children: [SizedBox(width: 16, height: 16, child: CustomPaint(painter: _SvgScene([_Op.path("M13 2L4 14h7l-1 8 9-12h-7z", theme.aHi, false, 1.8)], 24, 24))), Text("Action", style: TextStyle(color: theme.aHi, fontFamily: fonts.he, fontSize: 13, fontWeight: FontWeight.w700))])), Positioned(top: 0, left: 0, right: 0, child: Container(height: 1.2, decoration: BoxDecoration(color: const Color(0xB3FFFFFF))))])));
  }
}
