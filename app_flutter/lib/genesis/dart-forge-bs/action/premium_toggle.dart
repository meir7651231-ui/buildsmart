...
class ForgePremiumToggle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget body = switch (state) {
      ForgePremiumToggleState.state => Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Container(width: 46, height: 27, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.centerLeft, end: Alignment.centerRight), border: Border.all(color: skin.hi.withValues(alpha: 0.18)), borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 3), blurRadius: 10, spreadRadius: 0)]), child: _withChild(Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: const SizedBox.shrink()), Positioned(top: 2, right: 2, width: 21, child: Container(width: 21, height: 21, decoration: BoxDecoration(color: skin.hi, borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: skin.shade.withValues(alpha: 0.35), offset: const Offset(0, 2), blurRadius: 4, spreadRadius: 0)])))]), child))), Text(_f(0, "on"), style: TextStyle(color: skin.ink, fontSize: 16, fontFamily: fonts.he))]),
      ForgePremiumToggleState.state1 => Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Container(width: 46, height: 27, alignment: Alignment.center, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hi.withValues(alpha: 0.18)), borderRadius: BorderRadius.circular(999)), child: _withChild(Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: const SizedBox.shrink()), Positioned(top: 2, right: 2, width: 21, child: Container(width: 21, height: 21, decoration: BoxDecoration(color: skin.hi, borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: skin.shade.withValues(alpha: 0.35), offset: const Offset(0, 2), blurRadius: 4, spreadRadius: 0)])))]), child))), Text(_f(0, "off"), style: TextStyle(color: skin.ink, fontSize: 16, fontFamily: fonts.he))]),
      ForgePremiumToggleState.state2 => Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Container(width: 46, height: 27, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.centerLeft, end: Alignment.centerRight), border: Border.all(color: skin.hi.withValues(alpha: 0.18)), borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 3), blurRadius: 10, spreadRadius: 0)]), child: _withChild(Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: const SizedBox.shrink()), Positioned(top: 2, right: 2, width: 21, child: Container(width: 21, height: 21, decoration: BoxDecoration(color: skin.hi, borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: skin.shade.withValues(alpha: 0.35), offset: const Offset(0, 2), blurRadius: 4, spreadRadius: 0)])))]), child))), Text(_f(0, "focus"), style: TextStyle(color: skin.ink, fontSize: 16, fontFamily: fonts.he))]),
      ForgePremiumToggleState.state3 => Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Opacity(opacity: 0.5, child: Container(width: 46, height: 27, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.centerLeft, end: Alignment.centerRight), border: Border.all(color: skin.hi.withValues(alpha: 0.18)), borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 3), blurRadius: 10, spreadRadius: 0)]), child: _withChild(Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: const SizedBox.shrink()), Positioned(top: 2, right: 2, width: 21, child: Container(width: 21, height: 21, decoration: BoxDecoration(color: skin.hi, borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: skin.shade.withValues(alpha: 0.35), offset: const Offset(0, 2), blurRadius: 4, spreadRadius: 0)])))]), child)))), Text(_f(0, "disabled"), style: TextStyle(color: skin.ink, fontSize: 16, fontFamily: fonts.he))]),
    };
    return body;
  }
}
