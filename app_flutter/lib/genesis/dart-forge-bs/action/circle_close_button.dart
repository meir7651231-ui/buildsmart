...
/// CircleCloseButton — seam:fields
class ForgeCircleCloseButton extends StatelessWidget {
  ...
  const ForgeCircleCloseButton({super.key, this.child, this.onAction});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final Widget body = GestureDetector(behavior: HitTestBehavior.opaque, onTap: onAction == null ? null : () => onAction!(0), child: Container(width: 42, height: 42, alignment: Alignment.center, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: _withChild(SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.path("M6 6l12 12M18 6L6 18", skin.ink, false, 1.8)], 24, 24))), child)));
    return body;
  }
}
