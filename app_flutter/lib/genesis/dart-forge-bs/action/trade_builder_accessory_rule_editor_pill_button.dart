...
/// TradeBuilderAccessoryRuleEditorPillButton — seam:fields · 1 חריצים
class ForgeTradeBuilderAccessoryRuleEditorPillButton extends StatelessWidget {
  ...
  const ForgeTradeBuilderAccessoryRuleEditorPillButton({super.key, this.fields, this.child, this.onAction});
  @override
