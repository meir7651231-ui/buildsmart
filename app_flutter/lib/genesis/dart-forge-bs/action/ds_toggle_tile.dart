...
class ForgeDsToggleTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(12, 12, 12, 12), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: const Color(0x73E6B84F)), borderRadius: BorderRadius.circular(11)), child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.he)), Text("ZERO · no seam", style: TextStyle(color: skin.warn, fontFamily: fonts.grotesk, fontSize: 9))]));
  }
}
