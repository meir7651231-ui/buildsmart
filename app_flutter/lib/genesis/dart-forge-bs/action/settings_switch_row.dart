...
/// SettingsSwitchRow — seam:fields · 2 חריצים
class ForgeSettingsSwitchRow extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "on"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
