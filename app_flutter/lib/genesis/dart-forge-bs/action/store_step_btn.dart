...
class ForgeStoreStepBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text.rich(TextSpan(children: [TextSpan(text: "QTY", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9, letterSpacing: 1)), WidgetSpan(alignment: PlaceholderAlignment.middle, child: Container(decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [Container(width: 38, height: 44, alignment: Alignment.center, child: Text("−", style: TextStyle(color: skin.ink, fontSize: 17, fontFamily: fonts.he))), Container(constraints: const BoxConstraints(minWidth: 40), child: Text("1", textAlign: TextAlign.center, style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 16, fontWeight: FontWeight.w600))), Container(width: 38, height: 44, alignment: Alignment.center, child: Text("+", style: TextStyle(color: skin.ink, fontSize: 17, fontFamily: fonts.he)))])))]));
  }
}
