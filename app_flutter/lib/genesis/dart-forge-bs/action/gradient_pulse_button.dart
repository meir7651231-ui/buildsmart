...
/// GradientPulseButton — seam:fields · 1 חריצים
class ForgeGradientPulseButton extends StatelessWidget {
  ...
  const ForgeGradientPulseButton({super.key, this.fields, this.child, this.onAction});
  @override
