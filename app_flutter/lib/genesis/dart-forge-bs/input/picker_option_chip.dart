...
class ForgePickerOptionChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(14, 8, 14, 8), decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 7, children: [SizedBox(width: 13, height: 13, child: CustomPaint(painter: _SvgScene([_Op.path("M5 13l4 4L19 7", skin.mut, false, 1.8)], 24, 24))), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12.5, fontWeight: FontWeight.w600))])), Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(14, 8, 14, 8), decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 12.5, fontWeight: FontWeight.w600)))]);
  }
}
