...
/// DsDateField — seam:self · 1 חריצים
class ForgeDsDateFieldInput extends StatelessWidget {
  ...
  const ForgeDsDateFieldInput({super.key, this.fields, this.child, this.control});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [SizedBox(width: double.infinity, child: Text(_f(0, "Label"), textAlign: TextAlign.right, style: TextStyle(color: skin.mut, fontFamily: fonts.he, fontSize: 11, fontWeight: FontWeight.w600))), Stack(clipBehavior: Clip.none, children: [Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [Expanded(child: (control == null ? Directionality(textDirection: TextDirection.ltr, child: SizedBox(width: double.infinity, child: Container(height: 44, constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 0, 40, 0), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: Align(alignment: Alignment.centerLeft, child: Text("01 · 09 · 26", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 13)))))) : Padding(padding: const EdgeInsets.fromLTRB(13, 0, 40, 0), child: control!)))]), Positioned(right: 13, top: 0, bottom: 0, child: Align(alignment: Alignment.center, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 16, height: 16, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 5, 18, 16, 2, skin.mut, false, 1.8), _Op.path("M3 9h18M8 3v4M16 3v4", skin.mut, false, 1.8)], 24, 24)))])))])]), child);
    return body;
  }
}
