...
/// PremiumField — seam:fields · מצבים חיים · 2 חריצים
...
class ForgePremiumField extends StatelessWidget {
  ...
  const ForgePremiumField({super.key, this.state = ForgePremiumFieldState.rest, this.fields});
  @override
