...
class ForgePremiumField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return switch (state) {
      ForgePremiumFieldState.rest => Stack(clipBehavior: Clip.none, children: [Padding(padding: const EdgeInsets.fromLTRB(0, 6, 0, 0), child: Container(height: 52, constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 0, 42, 0), decoration: BoxDecoration(border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 13)))), Positioned(left: 15, child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 17, height: 17, child: CustomPaint(painter: _SvgScene([_Op.path("M12 12a4 4 0 100-8 4 4 0 000 8zM4 20a8 8 0 0116 0", theme.aHi, false, 1.8)], 24, 24)))])), Positioned(top: 24, left: 42, child: Container(padding: const EdgeInsets.fromLTRB(4, 0, 4, 0), decoration: BoxDecoration(color: skin.surface), child: Text("Label", style: TextStyle(color: skin.faint, fontSize: 14, fontFamily: fonts.he)))), Positioned(left: 14, right: 14, child: Container(height: 2, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.c2, theme.a, theme.c3], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.circular(2))))]),
      ForgePremiumFieldState.focusFilled => Stack(clipBehavior: Clip.none, children: [Padding(padding: const EdgeInsets.fromLTRB(0, 6, 0, 0), child: Container(height: 52, constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 0, 42, 0), decoration: BoxDecoration(border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 0, spreadRadius: 3)]), child: Text("Value", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 13)))), Positioned(left: 15, child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 17, height: 17, child: CustomPaint(painter: _SvgScene([_Op.path("M12 12a4 4 0 100-8 4 4 0 000 8zM4 20a8 8 0 0116 0", theme.aHi, false, 1.8)], 24, 24)))])), Positioned(top: -1, left: 16, child: Container(padding: const EdgeInsets.fromLTRB(4, 0, 4, 0), decoration: BoxDecoration(color: skin.surface), child: Text("Label", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 10)))), Positioned(left: 14, right: 14, child: Container(height: 2, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.c2, theme.a, theme.c3], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.circular(2))))]),
    };
  }
}
