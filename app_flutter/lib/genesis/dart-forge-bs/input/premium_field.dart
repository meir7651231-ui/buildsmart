...
/// PremiumField — seam:fields · מצבים חיים · 1 חריצים
enum ForgePremiumFieldState { rest, focusFilled }

class ForgePremiumField extends StatelessWidget {
  final ForgePremiumFieldState state;
  ...
  const ForgePremiumField({super.key, this.state = ForgePremiumFieldState.rest, this.fields, this.child, this.control});
  @override
  Widget build(BuildContext context) {
    ...
    final Widget body = switch (state) {
      ForgePremiumFieldState.rest => _withChild(SizedBox(width: double.infinity, child: Stack(clipBehavior: Clip.none, children: [Padding(padding: const EdgeInsets.fromLTRB(0, 6, 0, 0), child: (control == null ? Directionality(textDirection: TextDirection.rtl, child: SizedBox(width: double.infinity, child: Container(height: 52, constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 0, 42, 0), decoration: BoxDecoration(color: const Color(0x00000000), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Align(alignment: Alignment.centerRight, child: Text("Label", style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 13)))))) : Padding(padding: const EdgeInsets.fromLTRB(14, 0, 42, 0), child: control!))), Positioned(right: 15, child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 17, height: 17, child: CustomPaint(painter: _SvgScene([_Op.path("M12 12a4 4 0 100-8 4 4 0 000 8zM4 20a8 8 0 0116 0", theme.aHi, false, 1.8)], 24, 24)))])), Positioned(top: 24, right: 42, child: _hide(_f(0, "Label"), Container(padding: const EdgeInsets.fromLTRB(4, 0, 4, 0), decoration: BoxDecoration(gradient: LinearGradient(colors: [const Color(0x00000000), skin.surface], begin: Alignment.topCenter, end: Alignment.bottomCenter)), child: Text(_f(0, "Label"), style: TextStyle(color: skin.faint, fontSize: 14, fontFamily: fonts.he))))), Positioned(bottom: 0, left: 14, right: 14, child: Container(height: 2, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.c2, theme.a, theme.c3], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.circular(2))))])), child),
      ForgePremiumFieldState.focusFilled => _withChild(SizedBox(width: double.infinity, child: Stack(clipBehavior: Clip.none, children: [Padding(padding: const EdgeInsets.fromLTRB(0, 6, 0, 0), child: (control == null ? Directionality(textDirection: TextDirection.rtl, child: SizedBox(width: double.infinity, child: Container(height: 52, constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(14, 0, 42, 0), decoration: BoxDecoration(color: const Color(0x00000000), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 0, spreadRadius: 3)]), child: Align(alignment: Alignment.centerRight, child: Text("Value", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 13)))))) : Padding(padding: const EdgeInsets.fromLTRB(14, 0, 42, 0), child: control!))), Positioned(right: 15, child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 17, height: 17, child: CustomPaint(painter: _SvgScene([_Op.path("M12 12a4 4 0 100-8 4 4 0 000 8zM4 20a8 8 0 0116 0", theme.aHi, false, 1.8)], 24, 24)))])), Positioned(top: -1, right: 16, child: _hide(_f(0, "Label"), Container(padding: const EdgeInsets.fromLTRB(4, 0, 4, 0), decoration: BoxDecoration(gradient: LinearGradient(colors: [const Color(0x00000000), skin.surface], begin: Alignment.topCenter, end: Alignment.bottomCenter)), child: Text(_f(0, "Label"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 10))))), Positioned(bottom: 0, left: 14, right: 14, child: Container(height: 2, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.c2, theme.a, theme.c3], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.circular(2))))])), child),
    };
    return body;
  }
}
