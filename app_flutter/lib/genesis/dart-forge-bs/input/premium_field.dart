...
/// PremiumField — seam:fields · מצבים חיים
...
class ForgePremiumField extends StatelessWidget {
  ...
  const ForgePremiumField({super.key, this.state = ForgePremiumFieldState.rest});
  @override
