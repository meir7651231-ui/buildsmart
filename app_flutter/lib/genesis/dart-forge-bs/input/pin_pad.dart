...
class ForgePinPad extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 9, children: [Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("1", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("2", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("3", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("4", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("5", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("6", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("7", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("8", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("9", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), const SizedBox.shrink(), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Text("0", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 19, fontWeight: FontWeight.w600))), Container(height: 52, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: SizedBox(width: 20, height: 20, child: CustomPaint(painter: _SvgScene([_Op.path("M20 6H9L4 12l5 6h11a1 1 0 001-1V7a1 1 0 00-1-1zM17 9l-5 6M12 9l5 6", skin.mut, false, 1.8)], 24, 24))))]);
  }
}
