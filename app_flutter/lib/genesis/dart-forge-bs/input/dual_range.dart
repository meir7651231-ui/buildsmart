...
class ForgeDualRange extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(4, 14, 4, 6), child: _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(height: 6, decoration: BoxDecoration(color: skin.raised2, borderRadius: BorderRadius.circular(999)), child: SizedBox(width: double.infinity, child: Stack(clipBehavior: Clip.none, children: [Positioned(top: 0, bottom: 0, child: Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 12, spreadRadius: 0)]))), Positioned(width: 20, child: Container(width: 20, height: 20, decoration: BoxDecoration(color: skin.hi, borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: skin.shade.withValues(alpha: 0.4), offset: const Offset(0, 2), blurRadius: 6, spreadRadius: 0), BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 0, spreadRadius: 4)]))), Positioned(width: 20, child: Container(width: 20, height: 20, decoration: BoxDecoration(color: skin.hi, borderRadius: BorderRadius.circular(999), boxShadow: [BoxShadow(color: skin.shade.withValues(alpha: 0.4), offset: const Offset(0, 2), blurRadius: 6, spreadRadius: 0), BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 0, spreadRadius: 4)])))]))), const SizedBox(height: 12), Directionality(textDirection: TextDirection.ltr, child: Text(_f(0, "26 — 74"), textAlign: TextAlign.center, style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 11)))]), child));
    return body;
  }
}
