...
class ForgeWheelPicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(0, 2, 0, 2), child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.stretch, spacing: 14, children: [Container(width: 132, height: 264, decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: const SizedBox.shrink()), Positioned.fill(child: Opacity(opacity: 0.6, child: Container(height: 48, padding: const EdgeInsets.fromLTRB(0, 22, 0, 22), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.08)))))])), Container(width: 132, height: 264, decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: const SizedBox.shrink()), Positioned.fill(child: Opacity(opacity: 0.6, child: Container(height: 48, padding: const EdgeInsets.fromLTRB(0, 22, 0, 22), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.08)))))]))]));
  }
}
