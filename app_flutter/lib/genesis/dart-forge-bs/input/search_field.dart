...
class ForgeSearchField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(mainAxisSize: MainAxisSize.min, children: [_icon(skin.mut), Text("Value", style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 13)), _icon(skin.mut)]);
  }
}
