...
class ForgeTagInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(15)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 11, children: [Container(padding: const EdgeInsets.all(9), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Row(mainAxisSize: MainAxisSize.min, spacing: 7, children: [Container(padding: const EdgeInsets.fromLTRB(11, 5, 6, 5), decoration: BoxDecoration(color: theme.a, border: Border.all(color: theme.a), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M6 6l12 12M18 6L6 18", skin.mut, 1.8, false, 24))])), Container(padding: const EdgeInsets.fromLTRB(11, 5, 6, 5), decoration: BoxDecoration(color: theme.a, border: Border.all(color: theme.a), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M6 6l12 12M18 6L6 18", skin.mut, 1.8, false, 24))])), Container(padding: const EdgeInsets.fromLTRB(11, 5, 6, 5), decoration: BoxDecoration(color: theme.a, border: Border.all(color: theme.a), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M6 6l12 12M18 6L6 18", skin.mut, 1.8, false, 24))])), Container(padding: const EdgeInsets.fromLTRB(11, 5, 6, 5), decoration: BoxDecoration(color: theme.a, border: Border.all(color: theme.a), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, spacing: 5, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M6 6l12 12M18 6L6 18", skin.mut, 1.8, false, 24))])), Text("Value…", style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 13))]))]));
  }
}
