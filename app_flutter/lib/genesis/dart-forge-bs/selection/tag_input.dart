...
class ForgeTagInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(constraints: const BoxConstraints(minHeight: 130), padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(15)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 8, children: [Container(constraints: const BoxConstraints(minHeight: 48), padding: const EdgeInsets.fromLTRB(9, 9, 9, 9), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: Wrap(spacing: 7, runSpacing: 7, crossAxisAlignment: WrapCrossAlignment.center, children: [Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(11, 5, 6, 5), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.14), border: Border.all(color: theme.a.withValues(alpha: 0.34)), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("Label", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 11, fontWeight: FontWeight.w600)), Opacity(opacity: 0.75, child: Container(width: 20, height: 20, alignment: Alignment.center, decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M6 6l12 12M18 6L6 18", theme.aHi, false, 1.8)], 24, 24))), Positioned.fill(child: const SizedBox.shrink())])))]))), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(11, 5, 6, 5), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.14), border: Border.all(color: theme.a.withValues(alpha: 0.34)), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("Label", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 11, fontWeight: FontWeight.w600)), Opacity(opacity: 0.75, child: Container(width: 20, height: 20, alignment: Alignment.center, decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M6 6l12 12M18 6L6 18", theme.aHi, false, 1.8)], 24, 24))), Positioned.fill(child: const SizedBox.shrink())])))]))), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(11, 5, 6, 5), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.14), border: Border.all(color: theme.a.withValues(alpha: 0.34)), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("Label", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 11, fontWeight: FontWeight.w600)), Opacity(opacity: 0.75, child: Container(width: 20, height: 20, alignment: Alignment.center, decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M6 6l12 12M18 6L6 18", theme.aHi, false, 1.8)], 24, 24))), Positioned.fill(child: const SizedBox.shrink())])))]))), Directionality(textDirection: TextDirection.ltr, child: Container(padding: const EdgeInsets.fromLTRB(11, 5, 6, 5), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.14), border: Border.all(color: theme.a.withValues(alpha: 0.34)), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("Label", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 11, fontWeight: FontWeight.w600)), Opacity(opacity: 0.75, child: Container(width: 20, height: 20, alignment: Alignment.center, decoration: BoxDecoration(borderRadius: BorderRadius.circular(999)), child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M6 6l12 12M18 6L6 18", theme.aHi, false, 1.8)], 24, 24))), Positioned.fill(child: const SizedBox.shrink())])))]))), Expanded(child: Container(constraints: const BoxConstraints(minHeight: 44, minWidth: 70), padding: const EdgeInsets.fromLTRB(4, 4, 4, 4), child: Align(alignment: Alignment.centerRight, child: Text("Value…", style: TextStyle(color: skin.faint, fontFamily: fonts.he, fontSize: 13)))))]))]));
  }
}
