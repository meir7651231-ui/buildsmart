...
/// RegressionPanelCheckRow — seam:state · 4 חריצים
class ForgeRegressionPanelCheckRow extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "Meta · locked", "Label", "Meta"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
