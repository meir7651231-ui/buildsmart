...
class ForgeRegressionPanelCheckRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(15)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 11, children: [Row(mainAxisSize: MainAxisSize.min, spacing: 11, children: [Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.ink), borderRadius: BorderRadius.circular(7)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 12l5 5L19 7", skin.mut, 1.8, false, 24))), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 13)), Text("Meta · locked", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 10))])]), Row(mainAxisSize: MainAxisSize.min, spacing: 11, children: [Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.ink), borderRadius: BorderRadius.circular(7)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 12l5 5L19 7", skin.mut, 1.8, false, 24))), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he, fontSize: 13)), Text("Meta", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 10))])])]));
  }
}
