...
class ForgeFacetChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(constraints: const BoxConstraints(minHeight: 130), padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(15)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 8, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 7, 13, 7), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 12l5 5L19 7", const Color(0xFF0A0A0C), 1.8, false, 24)), Text("Label", style: TextStyle(color: const Color(0xFF0A0A0C), fontFamily: fonts.he))])), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 7, 13, 7), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 12l5 5L19 7", skin.mut, 1.8, false, 24)), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he))])), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 7, 13, 7), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 12l5 5L19 7", const Color(0xFF0A0A0C), 1.8, false, 24)), Text("Label", style: TextStyle(color: const Color(0xFF0A0A0C), fontFamily: fonts.he))])), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 7, 13, 7), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 12l5 5L19 7", skin.mut, 1.8, false, 24)), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he))])), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 7, 13, 7), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 12l5 5L19 7", skin.mut, 1.8, false, 24)), Text("Label", style: TextStyle(color: skin.mut, fontFamily: fonts.he))])), Container(constraints: const BoxConstraints(minHeight: 44), padding: const EdgeInsets.fromLTRB(13, 7, 13, 7), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M5 12l5 5L19 7", const Color(0xFF0A0A0C), 1.8, false, 24)), Text("Label", style: TextStyle(color: const Color(0xFF0A0A0C), fontFamily: fonts.he))]))])]));
  }
}
