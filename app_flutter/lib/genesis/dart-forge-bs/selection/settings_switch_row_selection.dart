...
/// SettingsSwitchRow — seam:state · 4 חריצים
class ForgeSettingsSwitchRowSelection extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "Meta", "Label", "ON"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
