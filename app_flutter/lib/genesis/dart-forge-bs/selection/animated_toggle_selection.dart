...
/// AnimatedToggle — seam:state · 4 חריצים
class ForgeAnimatedToggleSelection extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "Meta", "Label", "Meta · locked"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
