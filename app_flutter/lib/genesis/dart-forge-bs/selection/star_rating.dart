...
class ForgeStarRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(15)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 11, children: [Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Row(mainAxisSize: MainAxisSize.min, spacing: 4, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.mut, 1.8, false, 24)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.mut, 1.8, false, 24)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.mut, 1.8, false, 24)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.mut, 1.8, false, 24)), CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.mut, 1.8, false, 24))]), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("Value", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Text("3"), Text("/ 5", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])])]));
  }
}
