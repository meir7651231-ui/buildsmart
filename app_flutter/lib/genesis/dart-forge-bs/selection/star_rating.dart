...
class ForgeStarRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(constraints: const BoxConstraints(minHeight: 130), padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.surface, skin.sunken], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(15)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [Container(margin: const EdgeInsets.fromLTRB(0, 0, 0, 0), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.20), false, 1.8)], 24, 24)))), Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.20), false, 1.8)], 24, 24)))), Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.20), false, 1.8)], 24, 24)))), Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.20), false, 1.8)], 24, 24)))), Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.20), false, 1.8)], 24, 24))))]), Directionality(textDirection: TextDirection.ltr, child: Container(margin: const EdgeInsets.fromLTRB(0, 10, 0, 0), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Value", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 10)), Text("3", style: TextStyle(color: theme.aHi, fontFamily: fonts.he)), Text("/ 5", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 10))])))]))]));
  }
}
