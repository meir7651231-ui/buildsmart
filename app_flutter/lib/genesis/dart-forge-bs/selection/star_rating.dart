...
/// StarRating — seam:value · 3 חריצים
class ForgeStarRating extends StatelessWidget {
  ...
  final bool bare;
  /// G13a · קבוצת-פריטים: items[i] = חריצי-הטקסט של פריט i (0 חריצים · 5 בדמו · לחיץ: onSelect(i) · selected = הפריטים-הפעילים). null ⇒ פריטי-העיצוב.
  ...
  const ForgeStarRating({super.key, this.fields, this.child, this.bare = false, this.items, this.selected, this.onSelect});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget core = Container(margin: const EdgeInsets.fromLTRB(0, 0, 0, 0), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [...(items == null ? <Widget>[Container(padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: SizedBox(width: 26, height: 26, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.200), false, 1.8)], 24, 24))))), Container(padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: SizedBox(width: 26, height: 26, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.200), false, 1.8)], 24, 24))))), Container(padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: SizedBox(width: 26, height: 26, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.200), false, 1.8)], 24, 24))))), Container(padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: SizedBox(width: 26, height: 26, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.200), false, 1.8)], 24, 24))))), Container(padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: SizedBox(width: 26, height: 26, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.200), false, 1.8)], 24, 24)))))] : List<Widget>.generate(items!.length, (i) => Flexible(child: ((selected?.contains(i) ?? false) ? GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: Container(padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: SizedBox(width: 26, height: 26, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.200), false, 1.8)], 24, 24)))))) : GestureDetector(behavior: HitTestBehavior.opaque, onTap: onSelect == null ? null : () => onSelect!(i), child: Container(padding: const EdgeInsets.fromLTRB(3, 3, 3, 3), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: SizedBox(width: 26, height: 26, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 18.3 6.1 21.4l1.1-6.5L2.5 10.3l6.5-.9z", skin.ink.withValues(alpha: 0.200), false, 1.8)], 24, 24))))))))))]), const SizedBox(height: 10), Directionality(textDirection: TextDirection.ltr, child: Text.rich(TextSpan(children: [TextSpan(text: _f(0, "Value "), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 10)), TextSpan(text: _f(1, "3"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 10)), TextSpan(text: _f(2, " / 5"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 10))])))]));
