...
class ForgeDeliveryTicks extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.all(16), child: Container(padding: const EdgeInsets.symmetric(vertical: 4, horizontal: 2), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 9, children: [Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(borderRadius: BorderRadius.circular(16)), child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Row(mainAxisSize: MainAxisSize.min, spacing: 18, children: [Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 4, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M4 6l3.2 3.2L14 2.5", skin.mut, 1.8, false, 18)), Text("sent")]), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 4, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M1 6l3.2 3.2L11 2.5 M7 9.2L13.6 2.5", skin.mut, 1.8, false, 18)), Text("delivered")]), Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 4, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M1 6l3.2 3.2L11 2.5 M7 9.2L13.6 2.5", skin.mut, 1.8, false, 18)), Text("read")])])]))])));
  }
}
