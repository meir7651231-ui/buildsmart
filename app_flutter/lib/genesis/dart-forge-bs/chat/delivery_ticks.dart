...
/// DeliveryTicks — seam:fields · 4 חריצים
class ForgeDeliveryTicks extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label ", "SENT", "DELIVERED", "READ"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeDeliveryTicks({super.key, this.fields, this.child, this.bare = false, this.items});
  @override
  Widget build(BuildContext context) {
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget core = Container(padding: const EdgeInsets.fromLTRB(2, 4, 2, 4), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 9, children: [Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text(_f(0, "Label "), style: TextStyle(color: const Color(0xFF0B0B0D), fontSize: 13.5, height: 1.42, leadingDistribution: TextLeadingDistribution.even, fontFamily: fonts.he)), const SizedBox(height: 9), Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.end, spacing: 18, children: [...(items == null ? <Widget>[_hide(_f(1, "SENT"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 22, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M4 6l3.2 3.2L14 2.5", const Color(0x6B0B0B0D), false, 1.8)], 18, 11)))]), Text(_f(1, "SENT"), style: TextStyle(color: const Color(0x800B0B0D), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8, letterSpacing: 0.48, height: 1.42, leadingDistribution: TextLeadingDistribution.even))])), _hide(_f(2, "DELIVERED"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 22, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M1 6l3.2 3.2L11 2.5", const Color(0x6B0B0B0D), false, 1.8), _Op.path("M7 9.2L13.6 2.5", const Color(0x6B0B0B0D), false, 1.8)], 18, 11)))]), Text(_f(2, "DELIVERED"), style: TextStyle(color: const Color(0x800B0B0D), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8, letterSpacing: 0.48, height: 1.42, leadingDistribution: TextLeadingDistribution.even))])), _hide(_f(3, "READ"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 22, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M1 6l3.2 3.2L11 2.5", theme.a800, false, 1.8), _Op.path("M7 9.2L13.6 2.5", theme.a800, false, 1.8)], 18, 11)))]), Text(_f(3, "READ"), style: TextStyle(color: const Color(0x800B0B0D), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8, letterSpacing: 0.48, height: 1.42, leadingDistribution: TextLeadingDistribution.even))]))] : List<Widget>.generate(items!.length, (i) => Flexible(child: _hide(_it(items![i], 0, "SENT"), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 4, children: [Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 22, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M4 6l3.2 3.2L14 2.5", const Color(0x6B0B0B0D), false, 1.8)], 18, 11)))]), Text(_it(items![i], 0, "SENT"), style: TextStyle(color: const Color(0x800B0B0D), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8, letterSpacing: 0.48, height: 1.42, leadingDistribution: TextLeadingDistribution.even))])))))])]))]));
