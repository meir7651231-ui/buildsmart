...
/// Bubble states — seam:fields · 9 חריצים
class ForgeBubbleStates extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "14:20", "INCOMING", "Label", "14:21 ", "OUTGOING", "Label", "now", "SENDING"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  const ForgeBubbleStates({super.key, this.fields, this.child, this.bare = false, this.items});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget core = Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 10, children: [...(items == null ? <Widget>[Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 5, children: [Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text(_f(0, "Label"), style: TextStyle(color: skin.ink, fontSize: 13.5, height: 1.42, leadingDistribution: TextLeadingDistribution.even, fontFamily: fonts.he)), const SizedBox(height: 3), Directionality(textDirection: TextDirection.ltr, child: Text(_f(1, "14:20"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, height: 1.42, leadingDistribution: TextLeadingDistribution.even, fontFeatures: const [FontFeature.tabularFigures()])))])), Text(_f(2, "INCOMING"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 5, children: [SizedBox(width: double.infinity, child: Align(alignment: Alignment.centerLeft, heightFactor: 1.0, child: IntrinsicWidth(child: Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text(_f(3, "Label"), style: TextStyle(color: const Color(0xFF0B0B0D), fontSize: 13.5, height: 1.42, leadingDistribution: TextLeadingDistribution.even, fontFamily: fonts.he)), const SizedBox(height: 3), Directionality(textDirection: TextDirection.ltr, child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text(_f(4, "14:21 "), style: TextStyle(color: const Color(0x990B0B0D), fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, height: 1.42, leadingDistribution: TextLeadingDistribution.even, fontFeatures: const [FontFeature.tabularFigures()])), Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 15, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M1 6l3.2 3.2L11 2.5", theme.a800, false, 1.8), _Op.path("M7 9.2L13.6 2.5", theme.a800, false, 1.8)], 18, 11)))])]))]))))), Text(_f(5, "OUTGOING"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 5, children: [SizedBox(width: double.infinity, child: Align(alignment: Alignment.centerLeft, heightFactor: 1.0, child: IntrinsicWidth(child: Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(color: skin.raised, borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text(_f(6, "Label"), style: TextStyle(color: skin.mut, fontSize: 13.5, height: 1.42, leadingDistribution: TextLeadingDistribution.even, fontFamily: fonts.he)), const SizedBox(height: 3), Directionality(textDirection: TextDirection.ltr, child: Text(_f(7, "now"), style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, height: 1.42, leadingDistribution: TextLeadingDistribution.even, fontFeatures: const [FontFeature.tabularFigures()])))]))))), Text(_f(8, "SENDING"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))])] : List<Widget>.generate(items!.length, (i) => Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 5, children: [Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text(_it(items![i], 0, "Label"), style: TextStyle(color: skin.ink, fontSize: 13.5, height: 1.42, leadingDistribution: TextLeadingDistribution.even, fontFamily: fonts.he)), const SizedBox(height: 3), Directionality(textDirection: TextDirection.ltr, child: Text(_it(items![i], 1, "14:20"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 9.5, height: 1.42, leadingDistribution: TextLeadingDistribution.even, fontFeatures: const [FontFeature.tabularFigures()])))])), Text(_it(items![i], 2, "INCOMING"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8.5, letterSpacing: 0.68))])))]);
