...
class ForgeBubbleStates extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 10, children: [Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 5, children: [Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Container(margin: const EdgeInsets.fromLTRB(0, 3, 0, 0), child: Text("14:20", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, fontFeatures: const [FontFeature.tabularFigures()])))])), Text("incoming", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 5, children: [Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Container(margin: const EdgeInsets.fromLTRB(0, 3, 0, 0), child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("14:21", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M1 6l3.2 3.2L11 2.5 M7 9.2L13.6 2.5", skin.mut, 1.8, false, 18))])]))])), Text("outgoing", style: TextStyle(color: skin.ink, fontFamily: fonts.he))]), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 5, children: [Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(color: skin.raised, borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Container(margin: const EdgeInsets.fromLTRB(0, 3, 0, 0), child: Text("now", style: TextStyle(color: skin.ink, fontFamily: fonts.grotesk, fontSize: 9.5, fontFeatures: const [FontFeature.tabularFigures()])))])), Text("sending", style: TextStyle(color: skin.ink, fontFamily: fonts.he))])]));
  }
}
