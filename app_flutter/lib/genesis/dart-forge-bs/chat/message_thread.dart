...
class ForgeMessageThread extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Container(padding: const EdgeInsets.fromLTRB(2, 4, 2, 4), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 9, children: [Container(padding: const EdgeInsets.fromLTRB(12, 5, 12, 5), decoration: BoxDecoration(border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Text("Meta", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 11.5, height: 1.42))), Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label · Value", style: TextStyle(color: skin.ink, fontSize: 13.5, height: 1.42, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Container(margin: const EdgeInsets.fromLTRB(0, 3, 0, 0), child: Text("14:31", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, height: 1.42, fontFeatures: const [FontFeature.tabularFigures()]))))])), Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: const Color(0xFF0B0B0D), fontSize: 13.5, height: 1.42, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Container(margin: const EdgeInsets.fromLTRB(0, 3, 0, 0), child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("14:32", style: TextStyle(color: const Color(0x990B0B0D), fontFamily: fonts.grotesk, fontSize: 9.5, height: 1.42, fontFeatures: const [FontFeature.tabularFigures()])), Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 15, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M1 6l3.2 3.2L11 2.5", theme.a800, false, 1.8), _Op.path("M7 9.2L13.6 2.5", theme.a800, false, 1.8)], 18, 11)))])])))])), Container(padding: const EdgeInsets.fromLTRB(0, 6, 0, 6), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Expanded(child: Container(height: 1, decoration: BoxDecoration(color: skin.hair))), Text("META", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, letterSpacing: 1.33)), Expanded(child: Container(height: 1, decoration: BoxDecoration(color: skin.hair)))])), Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(color: skin.surface, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 13.5, height: 1.42, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Container(margin: const EdgeInsets.fromLTRB(0, 3, 0, 0), child: Text("14:36", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 9.5, height: 1.42, fontFeatures: const [FontFeature.tabularFigures()]))))])), Container(padding: const EdgeInsets.fromLTRB(13, 9, 13, 7), decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(16)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label · Value · Meta", style: TextStyle(color: const Color(0xFF0B0B0D), fontSize: 13.5, height: 1.42, fontFamily: fonts.he)), Directionality(textDirection: TextDirection.ltr, child: Container(margin: const EdgeInsets.fromLTRB(0, 3, 0, 0), child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.center, spacing: 5, children: [Text("14:38", style: TextStyle(color: const Color(0x990B0B0D), fontFamily: fonts.grotesk, fontSize: 9.5, height: 1.42, fontFeatures: const [FontFeature.tabularFigures()])), Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [SizedBox(width: 15, height: 11, child: CustomPaint(painter: _SvgScene([_Op.path("M1 6l3.2 3.2L11 2.5", const Color(0x6B0B0B0D), false, 1.8), _Op.path("M7 9.2L13.6 2.5", const Color(0x6B0B0B0D), false, 1.8)], 18, 11)))])])))]))])));
  }
}
