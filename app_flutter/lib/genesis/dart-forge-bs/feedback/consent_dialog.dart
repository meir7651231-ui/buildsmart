...
/// ConsentDialog — seam:fields · 4 חריצים
class ForgeConsentDialog extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["Label", "Meta · consent", "Label", "Action"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
