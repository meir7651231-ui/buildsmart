...
class ForgeShimmerSkeleton extends StatelessWidget {
  ...
  const ForgeShimmerSkeleton({super.key, this.child, this.items, this.values});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final Widget body = _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 10, children: [...(items == null ? <Widget>[FractionallySizedBox(widthFactor: _v(0, 0.700), alignment: Alignment.centerRight, child: Container(height: 12, decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.raised, skin.raised2, skin.raised], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.circular(7)))), SizedBox(width: double.infinity, child: Container(height: 12, decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.raised, skin.raised2, skin.raised], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.circular(7)))), FractionallySizedBox(widthFactor: _v(1, 0.450), alignment: Alignment.centerRight, child: Container(height: 12, decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.raised, skin.raised2, skin.raised], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.circular(7))))] : List<Widget>.generate(items!.length, (i) => FractionallySizedBox(widthFactor: _v(i, 0.700), alignment: Alignment.centerRight, child: Container(height: 12, decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.raised, skin.raised2, skin.raised], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.circular(7))))))]), child);
    return body;
  }
}
