...
/// SnackToast — seam:fields · 3 חריצים
class ForgeSnackToast extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["DOCKED · OVER CONTENT", "Label", "Meta"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
  ...
  /// G13a · קבוצת-פריטים: items[i] = חריצי-הטקסט של פריט i (0 חריצים · 4 בדמו). null ⇒ פריטי-העיצוב.
  ...
  const ForgeSnackToast({super.key, this.fields, this.child, this.items, this.variants, this.values});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = Container(height: 236, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: _withChild(SizedBox(width: double.infinity, child: Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: Opacity(opacity: 0.4, child: Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 9, children: [...(items == null ? <Widget>[FractionallySizedBox(widthFactor: _v(0, 0.500), alignment: Alignment.centerRight, child: Container(height: 16, decoration: BoxDecoration(color: skin.raised, borderRadius: BorderRadius.circular(6)))), Container(height: 11, decoration: BoxDecoration(color: skin.raised2, borderRadius: BorderRadius.circular(6))), FractionallySizedBox(widthFactor: _v(1, 0.800), alignment: Alignment.centerRight, child: Container(height: 11, decoration: BoxDecoration(color: skin.raised2, borderRadius: BorderRadius.circular(6)))), FractionallySizedBox(widthFactor: _v(2, 0.900), alignment: Alignment.centerRight, child: Container(height: 11, decoration: BoxDecoration(color: skin.raised2, borderRadius: BorderRadius.circular(6))))] : List<Widget>.generate(items!.length, (i) => (switch ((variants != null && i < variants!.length) ? variants![i] : 0) { 0 => FractionallySizedBox(widthFactor: _v(i, 0.500), alignment: Alignment.centerRight, child: Container(height: 16, decoration: BoxDecoration(color: skin.raised, borderRadius: BorderRadius.circular(6)))), 1 => Container(height: 11, decoration: BoxDecoration(color: skin.raised2, borderRadius: BorderRadius.circular(6))), _ => FractionallySizedBox(widthFactor: _v(i, 0.500), alignment: Alignment.centerRight, child: Container(height: 16, decoration: BoxDecoration(color: skin.raised, borderRadius: BorderRadius.circular(6)))) })))])))), Positioned(bottom: 12, left: 12, right: 12, child: Container(padding: const EdgeInsets.fromLTRB(15, 13, 15, 13), decoration: BoxDecoration(color: skin.raised2, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(13), boxShadow: [BoxShadow(color: const Color(0x80000000), offset: const Offset(0, 14), blurRadius: 40, spreadRadius: 0)]), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 12, children: [Container(width: 30, height: 30, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(9)), child: SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.path("M5 13l4 4L19 7", const Color(0xFF0B0B0D), false, 1.8)], 24, 24)))), Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text(_f(1, "Label"), style: TextStyle(color: skin.ink, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: fonts.he)), Text(_f(2, "Meta"), style: TextStyle(color: skin.mut, fontSize: 11, fontFamily: fonts.he))]))]))), Positioned(top: 8, left: 10, child: Directionality(textDirection: TextDirection.ltr, child: Text(_f(0, "DOCKED · OVER CONTENT"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8, letterSpacing: 1))))])), child));
    return body;
  }
}
