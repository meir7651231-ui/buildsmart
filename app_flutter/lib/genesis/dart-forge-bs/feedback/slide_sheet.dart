...
class ForgeSlideSheet extends StatelessWidget {
  ...
  const ForgeSlideSheet({super.key, this.fields});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final fonts = DsSeam.fontsOf(context);  // פונט
    return Container(height: 210, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(14)), child: SizedBox(width: double.infinity, child: Stack(clipBehavior: Clip.none, children: [Positioned.fill(child: Opacity(opacity: 0.4, child: Container(padding: const EdgeInsets.fromLTRB(16, 16, 16, 16), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 9, children: [FractionallySizedBox(widthFactor: 0.500, alignment: Alignment.centerRight, child: Container(height: 16, decoration: BoxDecoration(color: skin.raised, borderRadius: BorderRadius.circular(6)))), Container(height: 11, decoration: BoxDecoration(color: skin.raised2, borderRadius: BorderRadius.circular(6))), FractionallySizedBox(widthFactor: 0.750, alignment: Alignment.centerRight, child: Container(height: 11, decoration: BoxDecoration(color: skin.raised2, borderRadius: BorderRadius.circular(6))))])))), Positioned(bottom: 0, left: 0, right: 0, child: Container(padding: const EdgeInsets.fromLTRB(16, 8, 16, 16), decoration: BoxDecoration(gradient: LinearGradient(colors: [skin.raised, skin.surface], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border.all(color: skin.hair), boxShadow: [BoxShadow(color: const Color(0x99000000), offset: const Offset(0, -18), blurRadius: 50, spreadRadius: 0)]), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 12, children: [Container(width: 38, height: 4, margin: const EdgeInsets.fromLTRB(0, 2, 0, 6), decoration: BoxDecoration(color: skin.faint, borderRadius: BorderRadius.circular(999))), Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [Flexible(child: Text(_f(1, "Label"), style: TextStyle(color: skin.ink, fontFamily: fonts.serifHe, fontSize: 15, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis, softWrap: false)), Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: SizedBox(width: 14, height: 14, child: CustomPaint(painter: _SvgScene([_Op.path("M6 6l12 12M18 6L6 18", skin.mut, false, 1.8)], 24, 24))))]), Container(padding: const EdgeInsets.fromLTRB(0, 10, 0, 0), decoration: BoxDecoration(border: Border(top: BorderSide(color: skin.hair, width: 1))), child: Text(_f(2, "Meta"), style: TextStyle(color: skin.mut, fontSize: 12, fontFamily: fonts.he)))]))), Positioned(top: 8, left: 10, child: Directionality(textDirection: TextDirection.ltr, child: Text(_f(0, "RISES FROM BOTTOM"), style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 8, letterSpacing: 1))))])));
  }
}
