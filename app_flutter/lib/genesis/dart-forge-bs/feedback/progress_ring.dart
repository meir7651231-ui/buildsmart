...
class ForgeProgressRing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 9, children: [_icon(skin.mut), Text("65%", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 11))]);
  }
}
