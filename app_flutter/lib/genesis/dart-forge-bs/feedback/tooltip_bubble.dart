...
class ForgeTooltipBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Container(padding: const EdgeInsets.fromLTRB(11, 8, 11, 8), decoration: BoxDecoration(color: skin.ink, borderRadius: BorderRadius.circular(9), boxShadow: [BoxShadow(color: const Color(0x80000000), offset: const Offset(0, 8), blurRadius: 33, spreadRadius: 0)]), child: Text("Label", style: TextStyle(color: skin.canvas, fontSize: 12, fontWeight: FontWeight.w600, fontFamily: fonts.he))), Container(margin: const EdgeInsets.fromLTRB(0, 2, 0, 0), child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Text("TooltipBubble", style: TextStyle(color: skin.ink, fontFamily: fonts.he)), Container(padding: const EdgeInsets.fromLTRB(5, 1, 5, 1), decoration: BoxDecoration(border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(999)), child: Text("FIELDS", style: TextStyle(color: skin.mut, fontFamily: fonts.grotesk, fontSize: 7.5, fontWeight: FontWeight.w600, letterSpacing: 1)))]))]);
  }
}
