...
class ForgeNotifyBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 20, children: [Container(width: 40, height: 40, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: Stack(clipBehavior: Clip.none, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M18 8a6 6 0 10-12 0c0 7-3 9-3 9h18s-3-2-3-9", skin.mut, 1.8, false, 24)), Positioned(top: -3, left: -3, child: Container(width: 12, height: 12, decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.surface, width: 2), borderRadius: BorderRadius.circular(50))))])), Container(width: 40, height: 40, decoration: BoxDecoration(color: skin.raised, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(11)), child: Stack(clipBehavior: Clip.none, children: [CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M4 4h16v12H5l-1 4z", skin.mut, 1.8, false, 24)), Positioned(top: -6, left: -6, child: Container(height: 18, constraints: const BoxConstraints(minWidth: 18), padding: const EdgeInsets.fromLTRB(4, 0, 4, 0), decoration: BoxDecoration(color: skin.err, border: Border.all(color: skin.surface, width: 2), borderRadius: BorderRadius.circular(999)), child: Text("3", style: TextStyle(color: const Color(0xFFFFFFFF), fontFamily: fonts.grotesk, fontSize: 9, fontWeight: FontWeight.w700))))]))]);
  }
}
