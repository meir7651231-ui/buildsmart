...
class ForgeAlertBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 10, children: [Container(padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.12), border: Border.all(color: theme.a.withValues(alpha: 0.34)), borderRadius: BorderRadius.circular(12)), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 12, 9, theme.aHi, false, 1.8), _Op.path("M12 8v4M12 16h.01", theme.aHi, false, 1.8)], 24, 24))), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 12.5, fontWeight: FontWeight.w700, fontFamily: fonts.he)), Container(margin: const EdgeInsets.fromLTRB(0, 1, 0, 0), child: Text("info · morphs with theme", style: TextStyle(color: skin.mut, fontSize: 11, fontFamily: fonts.he)))])])), Container(padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), decoration: BoxDecoration(color: skin.ok.withValues(alpha: 0.12), border: Border.all(color: skin.ok.withValues(alpha: 0.34)), borderRadius: BorderRadius.circular(12)), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.path("M5 13l4 4L19 7", skin.ok, false, 1.8)], 24, 24))), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 12.5, fontWeight: FontWeight.w700, fontFamily: fonts.he)), Container(margin: const EdgeInsets.fromLTRB(0, 1, 0, 0), child: Text("success · fixed green", style: TextStyle(color: skin.mut, fontSize: 11, fontFamily: fonts.he)))])])), Container(padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), decoration: BoxDecoration(color: skin.warn.withValues(alpha: 0.12), border: Border.all(color: skin.warn.withValues(alpha: 0.34)), borderRadius: BorderRadius.circular(12)), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.path("M12 3l9 16H3zM12 10v4M12 17h.01", skin.warn, false, 1.8)], 24, 24))), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 12.5, fontWeight: FontWeight.w700, fontFamily: fonts.he)), Container(margin: const EdgeInsets.fromLTRB(0, 1, 0, 0), child: Text("warning · fixed amber", style: TextStyle(color: skin.mut, fontSize: 11, fontFamily: fonts.he)))])])), Container(padding: const EdgeInsets.fromLTRB(14, 12, 14, 12), decoration: BoxDecoration(color: skin.err.withValues(alpha: 0.14), border: Border.all(color: skin.err.withValues(alpha: 0.38)), borderRadius: BorderRadius.circular(12)), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.start, spacing: 11, children: [SizedBox(width: 18, height: 18, child: CustomPaint(painter: _SvgScene([_Op.circle(12, 12, 9, skin.err, false, 1.8), _Op.path("M15 9l-6 6M9 9l6 6", skin.err, false, 1.8)], 24, 24))), Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Label", style: TextStyle(color: skin.ink, fontSize: 12.5, fontWeight: FontWeight.w700, fontFamily: fonts.he)), Container(margin: const EdgeInsets.fromLTRB(0, 1, 0, 0), child: Text("error · fixed red", style: TextStyle(color: skin.mut, fontSize: 11, fontFamily: fonts.he)))])]))]);
  }
}
