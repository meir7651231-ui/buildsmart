...
class ForgeGalleryGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Container(decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 4 h 18 v 16 h -18 Z M 6.9 9 a 1.6 1.6 0 1 0 3.2 0 a 1.6 1.6 0 1 0 -3.2 0 M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, 1.8, false, 24))), Container(decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 4 h 18 v 16 h -18 Z M 6.9 9 a 1.6 1.6 0 1 0 3.2 0 a 1.6 1.6 0 1 0 -3.2 0 M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, 1.8, false, 24))), Container(decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 4 h 18 v 16 h -18 Z M 6.9 9 a 1.6 1.6 0 1 0 3.2 0 a 1.6 1.6 0 1 0 -3.2 0 M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, 1.8, false, 24))), Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Text("+12", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 12, fontWeight: FontWeight.w700)))]);
  }
}
