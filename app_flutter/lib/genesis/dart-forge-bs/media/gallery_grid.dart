...
/// GalleryGrid — seam:collection · 1 חריצים
class ForgeGalleryGrid extends StatelessWidget {
  ...
  const ForgeGalleryGrid({super.key, this.fields, this.child});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final fonts = DsSeam.fontsOf(context);  // פונט
    final Widget body = _withChild(Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, spacing: 6, children: [Row(crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [Expanded(flex: 1, child: AspectRatio(aspectRatio: 1.0000, child: Container(decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [Color.lerp(skin.raised2, theme.a, 0.120)!, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: FractionallySizedBox(widthFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24)))))))))), Expanded(flex: 1, child: AspectRatio(aspectRatio: 1.0000, child: Container(decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [Color.lerp(skin.raised2, theme.a, 0.120)!, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: FractionallySizedBox(widthFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24))))))))))]), Row(crossAxisAlignment: CrossAxisAlignment.center, spacing: 6, children: [Expanded(flex: 1, child: AspectRatio(aspectRatio: 1.0000, child: Container(decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [Color.lerp(skin.raised2, theme.a, 0.120)!, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: FractionallySizedBox(widthFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24)))))))))), Expanded(flex: 1, child: _hide(_f(0, "+12"), Directionality(textDirection: TextDirection.ltr, child: AspectRatio(aspectRatio: 1.0000, child: Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Text(_f(0, "+12"), style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 12, fontWeight: FontWeight.w700))))))))])]), child);
    return body;
  }
}
