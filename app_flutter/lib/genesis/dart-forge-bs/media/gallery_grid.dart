...
class ForgeGalleryGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Container(decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.12), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.ink, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.ink, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, false, 1.8)], 24, 24)))), Container(decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.12), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.ink, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.ink, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, false, 1.8)], 24, 24)))), Container(decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.12), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.ink, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.ink, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, false, 1.8)], 24, 24)))), Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Text("+12", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 12, fontWeight: FontWeight.w700)))]);
  }
}
