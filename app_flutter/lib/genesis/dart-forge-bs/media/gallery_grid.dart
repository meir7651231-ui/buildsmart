...
class ForgeGalleryGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 6, children: [Container(decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [theme.a.withValues(alpha: 0.12), skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: FractionallySizedBox(widthFactor: 0.380, heightFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24)))))))), Container(decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [theme.a.withValues(alpha: 0.12), skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: FractionallySizedBox(widthFactor: 0.380, heightFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24)))))))), Container(decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [theme.a.withValues(alpha: 0.12), skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: FractionallySizedBox(widthFactor: 0.380, heightFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24)))))))), Directionality(textDirection: TextDirection.ltr, child: Container(decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(8)), child: Center(widthFactor: 1.0, heightFactor: 1.0, child: Text("+12", style: TextStyle(color: theme.aHi, fontFamily: fonts.grotesk, fontSize: 12, fontWeight: FontWeight.w700)))))]);
  }
}
