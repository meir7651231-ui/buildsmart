...
class ForgeImageFacePager extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(2, 2, 2, 2), child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [Container(width: 64, height: 64, decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.12), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(10)), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.ink, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.ink, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, false, 1.8)], 24, 24)))), Container(width: 64, height: 64, decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.12), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(10)), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.ink, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.ink, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, false, 1.8)], 24, 24)))), Container(width: 64, height: 64, decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.12), border: Border.all(color: theme.a, width: 2), borderRadius: BorderRadius.circular(10), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 0, spreadRadius: 3)]), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.ink, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.ink, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, false, 1.8)], 24, 24)))), Container(width: 64, height: 64, decoration: BoxDecoration(color: theme.a.withValues(alpha: 0.12), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(10)), child: AspectRatio(aspectRatio: 1.0000, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.ink, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.ink, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.ink, false, 1.8)], 24, 24))))]));
  }
}
