...
class ForgeImageFacePager extends StatelessWidget {
  ...
  const ForgeImageFacePager({super.key, this.child, this.items, this.selected});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    final Widget body = Container(padding: const EdgeInsets.fromLTRB(2, 2, 2, 2), child: _withChild(SingleChildScrollView(scrollDirection: Axis.horizontal, child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, spacing: 8, children: [...(items == null ? <Widget>[Container(width: 64, height: 64, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [Color.lerp(skin.raised2, theme.a, 0.120)!, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(10)), child: FractionallySizedBox(widthFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24))))))), Container(width: 64, height: 64, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [Color.lerp(skin.raised2, theme.a, 0.120)!, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(10)), child: FractionallySizedBox(widthFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24))))))), Container(width: 64, height: 64, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [Color.lerp(skin.raised2, theme.a, 0.120)!, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: theme.a, width: 2), borderRadius: BorderRadius.circular(10), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 0, spreadRadius: 3)]), child: FractionallySizedBox(widthFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, theme.aHi, false, 1.8), _Op.circle(8.5, 9, 1.6, theme.aHi, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", theme.aHi, false, 1.8)], 24, 24)))))), Container(width: 64, height: 64, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [Color.lerp(skin.raised2, theme.a, 0.120)!, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(10)), child: FractionallySizedBox(widthFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24)))))))] : List<Widget>.generate(items!.length, (i) => Flexible(child: ((selected?.contains(i) ?? false) ? Container(width: 64, height: 64, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [Color.lerp(skin.raised2, theme.a, 0.120)!, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: theme.a, width: 2), borderRadius: BorderRadius.circular(10), boxShadow: [BoxShadow(color: theme.gl, offset: const Offset(0, 0), blurRadius: 0, spreadRadius: 3)]), child: FractionallySizedBox(widthFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, theme.aHi, false, 1.8), _Op.circle(8.5, 9, 1.6, theme.aHi, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", theme.aHi, false, 1.8)], 24, 24)))))) : Container(width: 64, height: 64, alignment: Alignment.center, decoration: BoxDecoration(gradient: RadialGradient(center: Alignment(-0.40, -0.60), radius: 1.20, colors: [Color.lerp(skin.raised2, theme.a, 0.120)!, skin.sunken], stops: [0.0, 1.0]), border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(10)), child: FractionallySizedBox(widthFactor: 0.380, child: FittedBox(fit: BoxFit.contain, child: SizedBox(width: 24, height: 24, child: Opacity(opacity: 0.8, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.faint, false, 1.8), _Op.circle(8.5, 9, 1.6, skin.faint, false, 1.8), _Op.path("M4 18l5-5 3.5 3.5L16 13l4 4", skin.faint, false, 1.8)], 24, 24)))))))))))])), child));
    return body;
  }
}
