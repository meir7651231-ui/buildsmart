...
/// GalleryMosaic — seam:collection
class ForgeGalleryMosaic extends StatelessWidget {
  const ForgeGalleryMosaic({super.key});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final theme = DsSeam.of(context);       // אקצנט (מורף)
    return Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, spacing: 6, children: [Container(decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 4 h 18 v 16 h -18 Z M 6.9 9 a 1.6 1.6 0 1 0 3.2 0 a 1.6 1.6 0 1 0 -3.2 0 M4 18l5-5 3.5 3.5L16 13l4 4", skin.mut, 1.8, false, 24))), Container(decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M10 8l6 4-6 4z M 3 4 h 18 v 16 h -18 Z", skin.mut, 1.8, false, 24))), Container(decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 4 h 18 v 16 h -18 Z M 6.9 9 a 1.6 1.6 0 1 0 3.2 0 a 1.6 1.6 0 1 0 -3.2 0 M4 18l5-5 3.5 3.5L16 13l4 4", skin.mut, 1.8, false, 24))), Container(decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 4 h 18 v 16 h -18 Z M 6.9 9 a 1.6 1.6 0 1 0 3.2 0 a 1.6 1.6 0 1 0 -3.2 0 M4 18l5-5 3.5 3.5L16 13l4 4", skin.mut, 1.8, false, 24))), Container(decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M 3 4 h 18 v 16 h -18 Z M 6.9 9 a 1.6 1.6 0 1 0 3.2 0 a 1.6 1.6 0 1 0 -3.2 0 M4 18l5-5 3.5 3.5L16 13l4 4", skin.mut, 1.8, false, 24)))]);
  }
}
