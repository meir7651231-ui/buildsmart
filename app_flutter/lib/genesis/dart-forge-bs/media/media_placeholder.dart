...
/// MediaPlaceholder — seam:fields · 1 חריצים
class ForgeMediaPlaceholder extends StatelessWidget {
  ...
  static const List<String> fieldDemo = <String>["empty"];   // תוכן-העיצוב פר-חריץ — מלמד את המחולל את צורת-החריץ (מספר/טקסט), לא ערך
