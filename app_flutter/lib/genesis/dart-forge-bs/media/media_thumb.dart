...
class ForgeMediaThumb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(color: theme.a, border: Border.all(color: skin.hair), borderRadius: BorderRadius.circular(12)), child: CustomPaint(size: const Size(16, 16), painter: _SvgPaint("M10 8l6 4-6 4z M 3 4 h 18 v 16 h -18 Z", skin.mut, 1.8, false, 24)));
  }
}
