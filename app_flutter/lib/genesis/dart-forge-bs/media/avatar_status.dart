...
class ForgeAvatarStatus extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget body = Container(height: 88, alignment: Alignment.centerRight, child: _withChild(Wrap(spacing: 14, runSpacing: 14, crossAxisAlignment: WrapCrossAlignment.center, children: [...(items == null ? <Widget>[_hide(_f(0, "L"), Stack(clipBehavior: Clip.none, children: [_hide(_f(0, "L"), Container(width: 44, height: 44, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(999)), child: Text(_f(0, "L"), style: TextStyle(color: skin.onA, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 17.6, fontWeight: FontWeight.w700, height: 1, leadingDistribution: TextLeadingDistribution.even)))), Positioned(bottom: -2, left: -2, width: 14, child: Container(width: 14, height: 14, decoration: BoxDecoration(color: skin.ok, border: Border.all(color: skin.canvas, width: 2.5), borderRadius: BorderRadius.circular(999))))])), _hide(_f(1, "L"), Stack(clipBehavior: Clip.none, children: [_hide(_f(1, "L"), Container(width: 44, height: 44, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(999)), child: Text(_f(1, "L"), style: TextStyle(color: skin.onA, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 17.6, fontWeight: FontWeight.w700, height: 1, leadingDistribution: TextLeadingDistribution.even)))), Positioned(bottom: -2, left: -2, width: 14, child: Container(width: 14, height: 14, decoration: BoxDecoration(color: skin.warn, border: Border.all(color: skin.canvas, width: 2.5), borderRadius: BorderRadius.circular(999))))])), _hide(_f(2, "L"), Stack(clipBehavior: Clip.none, children: [_hide(_f(2, "L"), Container(width: 44, height: 44, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(999)), child: Text(_f(2, "L"), style: TextStyle(color: skin.onA, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 17.6, fontWeight: FontWeight.w700, height: 1, leadingDistribution: TextLeadingDistribution.even)))), Positioned(bottom: -2, left: -2, width: 14, child: Container(width: 14, height: 14, decoration: BoxDecoration(color: skin.faint, border: Border.all(color: skin.canvas, width: 2.5), borderRadius: BorderRadius.circular(999))))]))] : List<Widget>.generate(items!.length, (i) => _hide(_it(items![i], 0, "L"), Stack(clipBehavior: Clip.none, children: [_hide(_it(items![i], 0, "L"), Container(width: 44, height: 44, alignment: Alignment.center, decoration: BoxDecoration(gradient: LinearGradient(colors: [theme.aHi, theme.a], begin: Alignment.topCenter, end: Alignment.bottomCenter), borderRadius: BorderRadius.circular(999)), child: Text(_it(items![i], 0, "L"), style: TextStyle(color: skin.onA, fontFamily: fonts.grotesk, fontFamilyFallback: [fonts.he], fontSize: 17.6, fontWeight: FontWeight.w700, height: 1, leadingDistribution: TextLeadingDistribution.even)))), Positioned(bottom: -2, left: -2, width: 14, child: Container(width: 14, height: 14, decoration: BoxDecoration(color: skin.ok, border: Border.all(color: skin.canvas, width: 2.5), borderRadius: BorderRadius.circular(999))))]))))]), child));
    return body;
  }
}
