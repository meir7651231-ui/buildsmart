...
/// ThumbPlaceholder — seam:fields
class ForgeThumbPlaceholder extends StatelessWidget {
  const ForgeThumbPlaceholder({super.key});
  @override
  Widget build(BuildContext context) {
    final skin = DsSeam.skinOf(context);   // מלוא-העיצוב מהחריץ
    final fonts = DsSeam.fontsOf(context);  // פונט
    return Container(alignment: Alignment.center, constraints: const BoxConstraints(minHeight: 120), padding: const EdgeInsets.fromLTRB(22, 22, 22, 22), decoration: BoxDecoration(color: skin.sunken, border: Border.all(color: skin.hair, width: 1.5), borderRadius: BorderRadius.circular(12)), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, spacing: 8, children: [SizedBox(width: 30, height: 30, child: CustomPaint(painter: _SvgScene([_Op.rect(3, 4, 18, 16, 2.5, skin.ink, false, 1.8), _Op.path("M3 16l5-4 4 3 3-2 6 4", skin.ink, false, 1.8), _Op.path("M4 4l16 16", skin.ink, false, 1.8)], 24, 24))), Directionality(textDirection: TextDirection.ltr, child: Text("no media", style: TextStyle(color: skin.faint, fontFamily: fonts.grotesk, fontSize: 10)))]));
  }
}
