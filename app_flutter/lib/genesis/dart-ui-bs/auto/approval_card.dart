...
// מוצא: screens__tasks_screen:_ApprovalCard (בנייה-חכמה main) · צרור-2 · props-שורש: label, fallback, label2
...
class ApprovalCard extends StatelessWidget {
  ApprovalCard({required this.label, required this.fallback, required this.label2, 
    required this.name,
                  ...
                  Expanded(
                    ...
                    child: CfgVisible(
                      ...
                      child: OutlinedButton(
                        ...
                        onPressed: onReject,
                        child: CfgText(
                            'tasks_screen.approval_reject', fallback),
                      ),
                    ),
                  ),
