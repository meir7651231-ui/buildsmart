// אטום-דאטה · run-audit-strings — תאום-Dart שנפלט אוטומטית מהמקור-הקדוש · מהות-המוצא: בדיקת תקינות הנתונים קטגוריות ממצאים
// (מנוע-ההמרה-מחדש · הכרעה 19) המקור: new/atoms/run-audit-strings.mjs — אל תערוך ידנית; שינוי = במקור + פליטה-מחדש.
const Map<String, Object> RUN_AUDIT_T = {
  'k1': 'כפילות',
  'k2': 'שם + שם האם זהים: "',
  'k3': ' רשומות',
  'k4': 'טלפון ',
