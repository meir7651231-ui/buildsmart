import '../dart/lipskey_acc_for.dart';
// 🗄️ דאטה · מילוני-lipskey_acc_for — הורמו מהאטום ע"י purify-dart-native (הכרעת-בעלים "עד
// מאה אחוז": אפס-דאטה במנגנון). מוזרקים לאטום כשקעים-שמיים; שינוי-מילון = עריכה כאן.
// מקור-ערכים: new/dart/lipskey_acc_for.dart (verbatim).
