...
class GenesisGallery extends StatelessWidget {
  ...
  static final List<_GEntry> _screens = [
    _GEntry('ai hub screen', 0, 4, () => const AiHubScreenBoard()),
    _GEntry('budget screen', 0, 8, () => const BudgetScreenBoard()),
    _GEntry('camera sheet', 0, 7, () => const CameraSheetBoard()),
    _GEntry('catalog config · catalog config screen', 0, 2, () => const CatalogConfigCatalogConfigScreenBoard()),
    _GEntry('catalog config · wheel picker', 0, 0, () => const CatalogConfigWheelPickerBoard()),
    _GEntry('catalog screen', 2, 25, () => const CatalogScreenBoard()),
    _GEntry('catalog settings screen', 2, 0, () => const CatalogSettingsScreenBoard()),
    _GEntry('chat settings screen', 0, 3, () => const ChatSettingsScreenBoard()),
    _GEntry('chats screen', 0, 11, () => const ChatsScreenBoard()),
    _GEntry('consent modal', 1, 2, () => const ConsentModalBoard()),
    _GEntry('contractor hr sheet', 0, 9, () => const ContractorHrSheetBoard()),
    _GEntry('contractor material requests sheet', 0, 2, () => const ContractorMaterialRequestsSheetBoard()),
    _GEntry('contractor tools sheets', 1, 0, () => const ContractorToolsSheetsBoard()),
    _GEntry('courier attendance screen', 1, 8, () => const CourierAttendanceScreenBoard()),
    _GEntry('courier certs screen', 0, 1, () => const CourierCertsScreenBoard()),
    _GEntry('courier dashboard screen', 1, 7, () => const CourierDashboardScreenBoard()),
    _GEntry('courier forms screen', 1, 14, () => const CourierFormsScreenBoard()),
    _GEntry('courier portal tab', 0, 3, () => const CourierPortalTabBoard()),
    _GEntry('courier profile screen', 4, 2, () => const CourierProfileScreenBoard()),
    _GEntry('courier reports tab', 0, 5, () => const CourierReportsTabBoard()),
    _GEntry('courier settings screen', 2, 0, () => const CourierSettingsScreenBoard()),
    _GEntry('defects sheet', 0, 3, () => const DefectsSheetBoard()),
    _GEntry('docs readiness gate', 0, 5, () => const DocsReadinessGateBoard()),
    _GEntry('finance hub sheets', 1, 26, () => const FinanceHubSheetsBoard()),
    _GEntry('finder screen', 0, 1, () => const FinderScreenBoard()),
    _GEntry('fittings · intel · build plan screen', 0, 4, () => const FittingsIntelBuildPlanScreenBoard()),
    _GEntry('home shell', 0, 5, () => const HomeShellBoard()),
    _GEntry('install studio screen', 1, 2, () => const InstallStudioScreenBoard()),
    _GEntry('intel · intel tab', 0, 0, () => const IntelIntelTabBoard()),
    _GEntry('legal screen', 0, 0, () => const LegalScreenBoard()),
    _GEntry('lipskey brand screen', 2, 5, () => const LipskeyBrandScreenBoard()),
    _GEntry('lipskey product sheet', 1, 5, () => const LipskeyProductSheetBoard()),
    _GEntry('lipskey products screen', 1, 10, () => const LipskeyProductsScreenBoard()),
    _GEntry('manager copilot screen', 0, 3, () => const ManagerCopilotScreenBoard()),
    _GEntry('manager dashboard screen', 0, 21, () => const ManagerDashboardScreenBoard()),
    _GEntry('manager profile screen', 0, 2, () => const ManagerProfileScreenBoard()),
    _GEntry('manager role assign sheet', 0, 4, () => const ManagerRoleAssignSheetBoard()),
    _GEntry('notif settings screen', 0, 1, () => const NotifSettingsScreenBoard()),
    _GEntry('notifications screen', 1, 2, () => const NotificationsScreenBoard()),
    _GEntry('persona picking sheet', 0, 3, () => const PersonaPickingSheetBoard()),
    _GEntry('persona portal', 0, 1, () => const PersonaPortalBoard()),
    _GEntry('profile screen', 1, 5, () => const ProfileScreenBoard()),
    _GEntry('projects screen', 0, 2, () => const ProjectsScreenBoard()),
    _GEntry('regression panel screen', 0, 11, () => const RegressionPanelScreenBoard()),
    _GEntry('rewards hub screen', 1, 4, () => const RewardsHubScreenBoard()),
    _GEntry('role requests inbox screen', 1, 1, () => const RoleRequestsInboxScreenBoard()),
    _GEntry('site hub screen', 0, 12, () => const SiteHubScreenBoard()),
    _GEntry('smart home screen', 0, 4, () => const SmartHomeScreenBoard()),
    _GEntry('smart project screen', 0, 4, () => const SmartProjectScreenBoard()),
    _GEntry('stock screen', 0, 7, () => const StockScreenBoard()),
    _GEntry('store dashboard screen', 1, 8, () => const StoreDashboardScreenBoard()),
    _GEntry('store profile screen', 0, 1, () => const StoreProfileScreenBoard()),
    _GEntry('store screen', 1, 21, () => const StoreScreenBoard()),
    _GEntry('store settings screen', 0, 17, () => const StoreSettingsScreenBoard()),
    _GEntry('studio · panes · find replace pane', 1, 1, () => const StudioPanesFindReplacePaneBoard()),
    _GEntry('studio · panes · theme pane', 1, 2, () => const StudioPanesThemePaneBoard()),
    _GEntry('studio · studio top bar', 0, 1, () => const StudioStudioTopBarBoard()),
    _GEntry('suppliers screen', 0, 4, () => const SuppliersScreenBoard()),
    _GEntry('tasks screen', 1, 8, () => const TasksScreenBoard()),
    _GEntry('trade builder · accessory rule editor', 0, 10, () => const TradeBuilderAccessoryRuleEditorBoard()),
    _GEntry('trade builder · attribute schema editor', 0, 6, () => const TradeBuilderAttributeSchemaEditorBoard()),
    _GEntry('trade builder · category tree editor', 0, 7, () => const TradeBuilderCategoryTreeEditorBoard()),
    _GEntry('trade builder · connection rule studio', 3, 6, () => const TradeBuilderConnectionRuleStudioBoard()),
    _GEntry('trade builder · product authoring screen', 1, 7, () => const TradeBuilderProductAuthoringScreenBoard()),
    _GEntry('trade builder · trade builder home', 0, 2, () => const TradeBuilderTradeBuilderHomeBoard()),
    _GEntry('trade builder · trade define step', 0, 5, () => const TradeBuilderTradeDefineStepBoard()),
    _GEntry('trade builder · trade publish sheet', 0, 4, () => const TradeBuilderTradePublishSheetBoard()),
    _GEntry('worker app screen', 1, 16, () => const WorkerAppScreenBoard()),
    _GEntry('worker attendance screen', 0, 6, () => const WorkerAttendanceScreenBoard()),
    _GEntry('worker employer stock sheet', 0, 7, () => const WorkerEmployerStockSheetBoard()),
    _GEntry('worker equipment checklist sheet', 1, 2, () => const WorkerEquipmentChecklistSheetBoard()),
    _GEntry('worker forms screen', 1, 14, () => const WorkerFormsScreenBoard()),
    _GEntry('worker notifs sheet', 0, 2, () => const WorkerNotifsSheetBoard()),
    _GEntry('worker profile screen', 0, 4, () => const WorkerProfileScreenBoard()),
    _GEntry('worker report drilldowns', 1, 1, () => const WorkerReportDrilldownsBoard()),
    _GEntry('worker reports tab', 0, 6, () => const WorkerReportsTabBoard()),
    _GEntry('worker safety screen', 1, 2, () => const WorkerSafetyScreenBoard()),
    _GEntry('worker settings screen', 2, 3, () => const WorkerSettingsScreenBoard()),
    _GEntry('worker task detail sheet', 1, 2, () => const WorkerTaskDetailSheetBoard()),
  ];
