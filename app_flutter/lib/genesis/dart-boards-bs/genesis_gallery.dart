...
class GenesisGallery extends StatelessWidget {
  ...
  static final List<_GEntry> _screens = [
    _GEntry('ai hub screen', 0, 1, () => const AiHubScreenBoard()),
    _GEntry('budget screen', 2, 5, () => const BudgetScreenBoard()),
    _GEntry('camera sheet', 1, 6, () => const CameraSheetBoard()),
    _GEntry('catalog config · catalog config screen', 1, 1, () => const CatalogConfigCatalogConfigScreenBoard()),
    _GEntry('catalog config · wheel picker', 0, 0, () => const CatalogConfigWheelPickerBoard()),
    _GEntry('catalog screen', 4, 23, () => const CatalogScreenBoard()),
    ...
    _GEntry('chats screen', 1, 9, () => const ChatsScreenBoard()),
    _GEntry('consent modal', 1, 2, () => const ConsentModalBoard()),
    _GEntry('contractor hr sheet', 1, 7, () => const ContractorHrSheetBoard()),
    _GEntry('contractor material requests sheet', 0, 1, () => const ContractorMaterialRequestsSheetBoard()),
    _GEntry('contractor tools sheets', 1, 0, () => const ContractorToolsSheetsBoard()),
    _GEntry('courier attendance screen', 1, 4, () => const CourierAttendanceScreenBoard()),
    _GEntry('courier certs screen', 0, 1, () => const CourierCertsScreenBoard()),
    _GEntry('courier dashboard screen', 1, 6, () => const CourierDashboardScreenBoard()),
    ...
    _GEntry('courier profile screen', 4, 1, () => const CourierProfileScreenBoard()),
    _GEntry('courier reports tab', 0, 3, () => const CourierReportsTabBoard()),
    _GEntry('courier settings screen', 2, 0, () => const CourierSettingsScreenBoard()),
    _GEntry('defects sheet', 0, 3, () => const DefectsSheetBoard()),
    _GEntry('docs readiness gate', 1, 1, () => const DocsReadinessGateBoard()),
    ...
    _GEntry('home shell', 1, 1, () => const HomeShellBoard()),
    ...
    _GEntry('lipskey product sheet', 2, 3, () => const LipskeyProductSheetBoard()),
    _GEntry('lipskey products screen', 1, 10, () => const LipskeyProductsScreenBoard()),
    _GEntry('manager copilot screen', 2, 1, () => const ManagerCopilotScreenBoard()),
    _GEntry('manager dashboard screen', 3, 13, () => const ManagerDashboardScreenBoard()),
    _GEntry('manager profile screen', 0, 1, () => const ManagerProfileScreenBoard()),
    _GEntry('manager role assign sheet', 1, 3, () => const ManagerRoleAssignSheetBoard()),
    ...
    _GEntry('profile screen', 2, 3, () => const ProfileScreenBoard()),
    _GEntry('projects screen', 1, 0, () => const ProjectsScreenBoard()),
    _GEntry('regression panel screen', 0, 11, () => const RegressionPanelScreenBoard()),
    _GEntry('rewards hub screen', 2, 2, () => const RewardsHubScreenBoard()),
    _GEntry('role requests inbox screen', 1, 0, () => const RoleRequestsInboxScreenBoard()),
    _GEntry('site hub screen', 0, 12, () => const SiteHubScreenBoard()),
    _GEntry('smart home screen', 0, 4, () => const SmartHomeScreenBoard()),
    _GEntry('smart project screen', 3, 1, () => const SmartProjectScreenBoard()),
    _GEntry('stock screen', 3, 3, () => const StockScreenBoard()),
    _GEntry('store dashboard screen', 1, 6, () => const StoreDashboardScreenBoard()),
    _GEntry('store profile screen', 1, 0, () => const StoreProfileScreenBoard()),
    _GEntry('store screen', 2, 18, () => const StoreScreenBoard()),
    _GEntry('store settings screen', 5, 7, () => const StoreSettingsScreenBoard()),
    ...
    _GEntry('suppliers screen', 1, 1, () => const SuppliersScreenBoard()),
    _GEntry('tasks screen', 1, 7, () => const TasksScreenBoard()),
    _GEntry('trade builder · accessory rule editor', 0, 9, () => const TradeBuilderAccessoryRuleEditorBoard()),
    _GEntry('trade builder · attribute schema editor', 1, 3, () => const TradeBuilderAttributeSchemaEditorBoard()),
    _GEntry('trade builder · category tree editor', 1, 5, () => const TradeBuilderCategoryTreeEditorBoard()),
    _GEntry('trade builder · connection rule studio', 4, 4, () => const TradeBuilderConnectionRuleStudioBoard()),
    _GEntry('trade builder · product authoring screen', 1, 6, () => const TradeBuilderProductAuthoringScreenBoard()),
    _GEntry('trade builder · trade builder home', 1, 1, () => const TradeBuilderTradeBuilderHomeBoard()),
    _GEntry('trade builder · trade define step', 1, 4, () => const TradeBuilderTradeDefineStepBoard()),
    _GEntry('trade builder · trade publish sheet', 0, 3, () => const TradeBuilderTradePublishSheetBoard()),
    _GEntry('worker app screen', 2, 15, () => const WorkerAppScreenBoard()),
    _GEntry('worker attendance screen', 0, 6, () => const WorkerAttendanceScreenBoard()),
    _GEntry('worker employer stock sheet', 5, 2, () => const WorkerEmployerStockSheetBoard()),
    _GEntry('worker equipment checklist sheet', 2, 1, () => const WorkerEquipmentChecklistSheetBoard()),
    ...
    _GEntry('worker reports tab', 0, 4, () => const WorkerReportsTabBoard()),
    _GEntry('worker safety screen', 1, 1, () => const WorkerSafetyScreenBoard()),
    _GEntry('worker settings screen', 2, 3, () => const WorkerSettingsScreenBoard()),
    _GEntry('worker task detail sheet', 1, 1, () => const WorkerTaskDetailSheetBoard()),
  ];
