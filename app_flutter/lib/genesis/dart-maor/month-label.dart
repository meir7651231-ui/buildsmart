...
dynamic monthLabel(dynamic key) {
  ...
  final dynamic y = parts.isNotEmpty ? parts[0] : null; // JS split תמיד ≥1 איבר; שימור-פירוק ליתר-ביטחון
  final dynamic m = parts.length > 1 ? parts[1] : null; // אין '-' ⇒ undefined בפירוק-JS
