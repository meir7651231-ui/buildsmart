...
>
> **🔒 נאכף ע"י שער 112:** 3 ה-stubs (`TESTING`/`CHECKLISTS`/`BUG_INVESTIGATION`)
> חייבים להתחיל ב-⛔ DEPRECATED, להצביע לכאן, ולהישאר ≤20 שורות. אי-אפשר להחזיר
> אליהם תוכן-בדיקה ולברוא פרוטוקול-מקביל — ה-commit ייחסם. אין "בדקתי לפי הישן".
