...
**מטריקת-כיסוי (מתעדפת את העבודה):** `catalog:hard-ppr` כולל בדיקת-SOFT שמדפיסה
avgDims לכל קטגוריית-PPR. נכון לעכשיו (774 מוצרים): מיזוג 11.0 · פייזר 9.4 · מסעפים 8.0
· אספקה/מתאמים/ברזים 7.0 · צווארונים 5.7 · ברכיים 4.8 · רוכבים 4.5 · אומגה 4.2 ·
פקקים 3.9 · מצמדים 3.7 · **אלקטרופיוז׳ן 1.1 (77 מוצרים — הכי דליל)** · כלים 1.0.
ה-spec עצמו=100% בכל קטגוריה (המעטפת מוזרקת גם בלי dims). להעלות קצב = להעשיר את
הקווים הדלילים (אלקטרופיוז׳ן קודם) מטבלאות ה-PDF — קו שלם בכל פעם.
