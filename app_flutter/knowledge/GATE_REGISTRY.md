...
> **שמור-מראש ל-Studio (Red-Team R1):** 118=config ids⊆registry (ע1) · 119=AI-grounded-config (ע4) · 120=analytics-PII (ע3). מיושמים בזמן-הבנייה; שמורים כאן כדי שלא יתנגשו (ראה `studio-plan/RED-TEAM-R1.md`).
