...
- Adjust altitude on feedback — if asked to go deeper, go deeper once and hold that level. Adjust proactively too: if the task proves significantly more complex than framed, say so and shift depth without waiting to be asked.
