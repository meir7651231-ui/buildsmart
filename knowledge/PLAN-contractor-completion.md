...
T0 ✅ · T1 ✅ · T2 ✅ · **T3 ✅** · T4 ✅(QA) · T5 ✅ · T6 ✅ · T7 ✅(כבר) · T8 ⏸️ stub-מכוון · T9 🔄 (עובד ✅ · חנות+שליח 🔲)
→ **שלב-א — כפתורים גמורים** (T0–T8 ✅ · T8 stub-מכוון; כל כפתורי-הקטלוג ⋮ פעילים) · **T9 פרסונות 🔄** (עובד ✅ · חנות+שליח 🔲 — בעבודה ע״י בנצי, ר׳ שורה 187). שלב-ב (T10–T22) 🔲 נעול. SHAs בלוג-התפיסות למטה.
