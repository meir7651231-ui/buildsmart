...
| QA/launch | **1,539+ בדיקות** (אומת `b4e2198`; גדל) **· 47-helper-gate · 116 שערים** · LAUNCH_PACKAGE מוכן (aab חתום) · חוסמים = קונפיג-חנות (iOS-perms · keystore · Huliot-R2-crops 🔄 **בטיפול:** סקריפט-העלאה + 159 תמונות 06-08) |
