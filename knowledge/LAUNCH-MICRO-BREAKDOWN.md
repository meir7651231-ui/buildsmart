...
| B5 | 🟢 ירוקים‑לחיווט‑v1 (החלטה 14/6): גודל‑טקסט · יחידות · מטבע(תצוגה) · ניגודיות · הפחתת‑תנועה · ניתוק‑אוטומטי → לחווט לאפקט אמיתי + להציג (app_settings:51‑85 + app_theme). השאר נשאר מוסתר/inert. | `app_settings.dart`·`app_theme.dart` | ירוקים משפיעים באמת | agent | M |
