...
- `IMPLEMENTATION_PROTOCOL` = **deprecated** (בוטל 2026-05-21; הנחה לבנות Store/Courier/Worker כ-views מלאים). הציע ארכיטקטורת `*-role.ts` + תיקיות-קומפוננטות + LS-keys `bs.orders.v1`/`bs.stock.v1` — **נדחתה**; 3 ניסיונות נרברטו (INSP-0016/0017/0022/0023/0024) והוחלפו ב-BS-dial drill (INSP-0025+). נשמר immutable להיסטוריה.
...
- ⭐ **3 ריברטים:** INSP-0016/0017 (SitesView/ProfileView כ-`<main>` swap) + Phase-0 dashboards כ-views → **כולם reverted**; הוחלפו ב-dial-drill.
...
---
**הקשר:** זו ההיסטוריה-המוסדית של תרגום-אב-הטיפוס→Preact. ה-ADRs + הכללים הם ה-WHY מאחורי ה-dial pattern שתועד בדלתאות (01/02). מקור-משני — אינדקס, לא תעתוק.
