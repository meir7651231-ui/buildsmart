...
## 📱 Flutter — דלתא
🔧 **תיקון:** ⭐ **`kFinanceHub`** (`menu_trees.dart`) — מרכז-פיננסים 10-אריחים כ-**menu-dial toast-stubs** (יותר מ-Preact). **ניהול-אתר (C)** — 10 כלי-האתר (גאנט/ליקויים/נוכחות/יומן/בטיחות/תלויות/צילום/ביקורות/ארכיון) קיימים כ-**`kHomeTree` → 📋 משימות → toast-stubs**. שניהם = שמות-בתפריט, לא flows.
