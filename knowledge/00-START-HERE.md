...
- 🔲 **נותר:** אימות-עומק (verbatim/math מול §`[L#]`) · gate v2 ירוק · ליטוש P-1/P-2/P-5 · server-ready מלא (T6.2/3) · אימות-deploy חי · ~43 סטאבים-היקפיים (מצטמק).
...
| **T6** server-ready | `data/repositories/` | — | 🔲 T6.2/3 |
...
- **קבצי-ניווט-חמים** (חיווט-מרכזי בלבד): `home_shell.dart` · `data/menu_trees.dart` · `role_picker_sheet.dart` · `bs_dial_widget.dart`. (`menu_dial_widget.dart` — **נמחק.**)
...
4. **ליטוש** — P-1 (1,115 צבעים→`BsTokens`) · P-2 (a11y/Semantics) · P-5 (ניקוי-knowledge).
