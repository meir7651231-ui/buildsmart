...
- **Flutter:** `pubspec.yaml` (sdk ^3.7.2; deps: flutter_riverpod ^2.6 · intl ^0.19 · flutter_localizations · mobile_scanner ^5.2 · speech_to_text ^7.0 · **permission_handler ^11.3** · shared_preferences ^2.3 · cupertino_icons; **`go_router` הוסר — P-4 07-06**; dev: very_good_analysis ^7.0)(+lock) · `analysis_options.yaml` (very_good preset) · platform-scaffold (android/ios/web/macos/linux/windows).
