...
🔧 **מול פרוטוטייפ/Preact:** **לא** port של 5-הפרסונות — אפליקציית-אינסטלציה אמיתית. install-studio/chats/notifications = **חדשים לגמרי**. ~92%+ roadmap · **1,539+ בדיקות** (אומת `b4e2198`; גדל) · checkout בסיסי (mock).
