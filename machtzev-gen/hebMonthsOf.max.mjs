// 🤖 AUTO-EMITTED by gen-max — hebMonthsOf (transform) מועשר. default ביט-זהה. TARGET_fromSource=פייפליין.
...
export function hebMonthsOf_ORIG(hebYear) {
...
export function hebMonthsOf(hebYear) { return hebMonthsOf_ORIG(hebYear); }
export function hebMonthsOf_fromSource() { return hebMonthsOf_ORIG(hebYearNow()); }
