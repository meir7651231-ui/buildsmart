// 🤖 AUTO-EMITTED by gen-max — newSupporterFromRow (transform) מועשר. default ביט-זהה. TARGET_fromSource=פייפליין.
function fixPhone(p) {
...
export function newSupporterFromRow_ORIG(id, row) {
    return {
        id,
        name: row.name.trim(),
...
function newSupporterFromRow(id, row) { return newSupporterFromRow_ORIG(id, row); }
export function newSupporterFromRow_fromSource(sup, row) { return newSupporterFromRow_ORIG(supporterPurposes(sup), row); }
