// 🤖 AUTO-EMITTED by gen-max — hasPublicSite משודרג. default ביט-זהה למקורי (אפס-אובדן). אל תערוך ביד.
...
export function hasPublicSite_ORIG(config) {
    return !!config.site && config.site.enabled !== false;
}
export function hasPublicSite(config, __opt = {}) {
    const base = hasPublicSite_ORIG(config);
