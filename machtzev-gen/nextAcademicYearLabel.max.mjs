// 🤖 AUTO-EMITTED by gen-max — nextAcademicYearLabel (transform) מועשר. default ביט-זהה. TARGET_fromSource=פייפליין.
function atNoon(iso) {
    return new Date(`${iso}T12:00:00`);
}
export function nextAcademicYearLabel_ORIG(startIso) {
    if (!startIso)
        return '';
...
export function nextAcademicYearLabel(startIso) { return nextAcademicYearLabel_ORIG(startIso); }
export function nextAcademicYearLabel_fromSource(startIso) { return nextAcademicYearLabel_ORIG(academicYearLabel(startIso)); }
