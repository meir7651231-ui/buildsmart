// 🤖 AUTO-EMITTED by gen-max — siteDonateUrl משודרג. default ביט-זהה למקורי (אפס-אובדן). אל תערוך ביד.
...
export function siteDonateUrl_ORIG(config) {
...
export function siteDonateUrl(config, __opt = {}) {
    const base = siteDonateUrl_ORIG(config);
