// 🤖 AUTO-EMITTED by gen-max — parseSupporterCsv (transform) מועשר. default ביט-זהה. TARGET_fromSource=פייפליין.
...
export function parseSupporterCsv_ORIG(text) {
    return parseSupporterGrid(parseCsv(text));
}
function parseSupporterCsv(text) { return parseSupporterCsv_ORIG(text); }
export function parseSupporterCsv_fromSource(sup) { return parseSupporterCsv_ORIG(supporterPurposes(sup)); }
